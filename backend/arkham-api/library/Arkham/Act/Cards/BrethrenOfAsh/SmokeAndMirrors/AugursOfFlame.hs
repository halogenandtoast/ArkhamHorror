module Arkham.Act.Cards.BrethrenOfAsh.SmokeAndMirrors.AugursOfFlame (augursOfFlame) where

import Arkham.Ability
import Arkham.Act.CardDefs.BrethrenOfAsh.SmokeAndMirrors qualified as Cards
