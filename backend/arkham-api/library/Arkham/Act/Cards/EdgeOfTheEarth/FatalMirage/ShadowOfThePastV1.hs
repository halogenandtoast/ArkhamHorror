module Arkham.Act.Cards.EdgeOfTheEarth.FatalMirage.ShadowOfThePastV1 (shadowOfThePastV1) where

import Arkham.Act.CardDefs.EdgeOfTheEarth.FatalMirage qualified as Cards
