module Arkham.Act.Cards.EnthrallingEncore.BreakFreeFromThePast (breakFreeFromThePast) where

import Arkham.Ability
import Arkham.Act.CardDefs.EnthrallingEncore qualified as Cards
