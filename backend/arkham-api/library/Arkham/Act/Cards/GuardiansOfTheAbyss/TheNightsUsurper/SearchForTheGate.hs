module Arkham.Act.Cards.GuardiansOfTheAbyss.TheNightsUsurper.SearchForTheGate (searchForTheGate) where

import Arkham.Ability
import Arkham.Act.CardDefs.GuardiansOfTheAbyss.TheNightsUsurper qualified as Cards
