module Arkham.Act.Cards.NightOfTheZealot.TheMidnightMasks.UncoveringTheConspiracy (uncoveringTheConspiracy) where

import Arkham.Ability
import Arkham.Act.CardDefs.NightOfTheZealot.TheMidnightMasks qualified as Cards
