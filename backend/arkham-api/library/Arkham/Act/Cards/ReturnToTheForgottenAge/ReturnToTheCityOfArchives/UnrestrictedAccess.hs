module Arkham.Act.Cards.ReturnToTheForgottenAge.ReturnToTheCityOfArchives.UnrestrictedAccess (unrestrictedAccess) where

import Arkham.Ability
import Arkham.Act.CardDefs.ReturnToTheForgottenAge.ReturnToTheCityOfArchives qualified as Cards
