module Arkham.Act.Cards.ReturnToThePathToCarcosa.ReturnToCurtainCall.TheStrangerHereIsMyReply (theStrangerHereIsMyReply, theStrangerHereIsMyReplyEffect) where
