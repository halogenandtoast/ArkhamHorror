module Arkham.Act.Cards.ReturnToThePathToCarcosa.ReturnToCurtainCall.TheStrangerUnderTheCity (theStrangerUnderTheCity, theStrangerUnderTheCityEffect) where
