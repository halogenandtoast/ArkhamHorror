module Arkham.Act.Cards.ReturnToThePathToCarcosa.ReturnToTheUnspeakableOath.TheReallyBadOnesV4 (theReallyBadOnesV4) where

import Arkham.Act.CardDefs.ReturnToThePathToCarcosa.ReturnToTheUnspeakableOath qualified as Cards
