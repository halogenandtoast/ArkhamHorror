module Arkham.Act.Cards.TheCircleUndone.BeforeTheBlackThrone.InAzathothsDomain (inAzathothsDomain) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheCircleUndone.BeforeTheBlackThrone qualified as Cards
