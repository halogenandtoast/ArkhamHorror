module Arkham.Act.Cards.TheCircleUndone.DisappearanceAtTheTwilightEstate.TheDisappearance (theDisappearance) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheCircleUndone.DisappearanceAtTheTwilightEstate qualified as Cards
