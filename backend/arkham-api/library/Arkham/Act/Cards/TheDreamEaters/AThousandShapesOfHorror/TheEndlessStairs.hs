module Arkham.Act.Cards.TheDreamEaters.AThousandShapesOfHorror.TheEndlessStairs (TheEndlessStairs (..), theEndlessStairs) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheDreamEaters.AThousandShapesOfHorror qualified as Cards
