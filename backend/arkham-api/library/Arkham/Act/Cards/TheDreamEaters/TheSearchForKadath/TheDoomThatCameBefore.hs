module Arkham.Act.Cards.TheDreamEaters.TheSearchForKadath.TheDoomThatCameBefore (theDoomThatCameBefore) where
      ...
      if null availableRegions
        then push R1
          ...
          chooseOrRunOneM lead
            $ scenarioI18n
            $ scope "theDoomThatCameBefore"
            $ traverse toOption availableRegions
