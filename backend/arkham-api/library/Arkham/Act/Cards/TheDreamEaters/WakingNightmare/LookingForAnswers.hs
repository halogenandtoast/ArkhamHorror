module Arkham.Act.Cards.TheDreamEaters.WakingNightmare.LookingForAnswers (LookingForAnswers (..), lookingForAnswers) where

import Arkham.Act.CardDefs.TheDreamEaters.WakingNightmare qualified as Cards
