module Arkham.Act.Cards.TheDrownedCity.CourtOfTheAncients.EscapeTheTowerV2 (escapeTheTowerV2) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheDrownedCity.CourtOfTheAncients qualified as Cards
