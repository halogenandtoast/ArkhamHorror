module Arkham.Act.Cards.TheDrownedCity.TheDrownedQuarter.ReactivateTheCore (reactivateTheCore) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheDrownedCity.TheDrownedQuarter qualified as Cards
