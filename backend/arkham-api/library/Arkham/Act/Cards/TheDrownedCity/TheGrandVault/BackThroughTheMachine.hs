module Arkham.Act.Cards.TheDrownedCity.TheGrandVault.BackThroughTheMachine (backThroughTheMachine) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheDrownedCity.TheGrandVault qualified as Cards
