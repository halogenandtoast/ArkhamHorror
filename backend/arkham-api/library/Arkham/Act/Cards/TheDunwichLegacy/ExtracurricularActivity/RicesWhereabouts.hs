module Arkham.Act.Cards.TheDunwichLegacy.ExtracurricularActivity.RicesWhereabouts (ricesWhereabouts) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheDunwichLegacy.ExtracurricularActivity qualified as Cards
