module Arkham.Act.Cards.TheDunwichLegacy.TheHouseAlwaysWins.BeginnersLuck (beginnersLuck) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheDunwichLegacy.TheHouseAlwaysWins qualified as Cards
import Arkham.Act.Import.Lifted hiding (RevealChaosToken)
