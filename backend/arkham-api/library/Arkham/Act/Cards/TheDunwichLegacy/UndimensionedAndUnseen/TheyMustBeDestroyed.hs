module Arkham.Act.Cards.TheDunwichLegacy.UndimensionedAndUnseen.TheyMustBeDestroyed (theyMustBeDestroyed) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheDunwichLegacy.UndimensionedAndUnseen qualified as Cards
