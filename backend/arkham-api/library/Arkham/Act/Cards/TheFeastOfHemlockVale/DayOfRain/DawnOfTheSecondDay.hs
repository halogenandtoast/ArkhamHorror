module Arkham.Act.Cards.TheFeastOfHemlockVale.DayOfRain.DawnOfTheSecondDay (dawnOfTheSecondDay) where

import Arkham.Act.CardDefs.TheFeastOfHemlockVale.DayOfRain qualified as Cards
