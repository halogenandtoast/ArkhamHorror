module Arkham.Act.Cards.TheFeastOfHemlockVale.DayOfRest.DawnOfTheFirstDay (dawnOfTheFirstDay) where

import Arkham.Act.CardDefs.TheFeastOfHemlockVale.DayOfRest qualified as Cards
