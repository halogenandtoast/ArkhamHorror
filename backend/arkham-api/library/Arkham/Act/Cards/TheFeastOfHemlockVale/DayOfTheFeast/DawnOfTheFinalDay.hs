module Arkham.Act.Cards.TheFeastOfHemlockVale.DayOfTheFeast.DawnOfTheFinalDay (dawnOfTheFinalDay) where

import Arkham.Act.CardDefs.TheFeastOfHemlockVale.DayOfTheFeast qualified as Cards
