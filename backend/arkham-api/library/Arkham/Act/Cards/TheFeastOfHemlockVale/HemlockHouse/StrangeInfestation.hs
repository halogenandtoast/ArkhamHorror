module Arkham.Act.Cards.TheFeastOfHemlockVale.HemlockHouse.StrangeInfestation (strangeInfestation) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheFeastOfHemlockVale.HemlockHouse qualified as Cards
