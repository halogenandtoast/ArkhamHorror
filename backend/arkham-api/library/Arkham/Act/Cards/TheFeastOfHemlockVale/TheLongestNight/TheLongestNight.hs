module Arkham.Act.Cards.TheFeastOfHemlockVale.TheLongestNight.TheLongestNight (theLongestNight) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheFeastOfHemlockVale.TheLongestNight qualified as Cards
