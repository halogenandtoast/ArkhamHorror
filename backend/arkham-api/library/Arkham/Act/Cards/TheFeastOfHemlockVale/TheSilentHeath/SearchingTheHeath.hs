module Arkham.Act.Cards.TheFeastOfHemlockVale.TheSilentHeath.SearchingTheHeath (searchingTheHeath) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheFeastOfHemlockVale.TheSilentHeath qualified as Cards
