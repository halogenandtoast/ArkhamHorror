module Arkham.Act.Cards.TheFeastOfHemlockVale.TheTwistedHollow.DesperateSearch (desperateSearch) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheFeastOfHemlockVale.TheTwistedHollow qualified as Cards
