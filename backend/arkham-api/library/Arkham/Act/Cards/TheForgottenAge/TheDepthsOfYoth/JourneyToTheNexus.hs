module Arkham.Act.Cards.TheForgottenAge.TheDepthsOfYoth.JourneyToTheNexus (journeyToTheNexus) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheForgottenAge.TheDepthsOfYoth qualified as Cards
