...
module Arkham.Act.Cards.TheForgottenAge.TheDoomOfEztli.MagicAndScience (magicAndScience) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheForgottenAge.TheDoomOfEztli qualified as Cards
