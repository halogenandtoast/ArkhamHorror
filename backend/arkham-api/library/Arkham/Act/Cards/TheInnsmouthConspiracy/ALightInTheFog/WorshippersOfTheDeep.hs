module Arkham.Act.Cards.TheInnsmouthConspiracy.ALightInTheFog.WorshippersOfTheDeep (WorshippersOfTheDeep (..), worshippersOfTheDeep) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheInnsmouthConspiracy.ALightInTheFog qualified as Cards
