module Arkham.Act.Cards.TheInnsmouthConspiracy.DevilReef.ReefOfMysteries (ReefOfMysteries (..), reefOfMysteries) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheInnsmouthConspiracy.DevilReef qualified as Cards
