module Arkham.Act.Cards.TheInnsmouthConspiracy.HorrorInHighGear.PedalToTheMetal (pedalToTheMetal) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheInnsmouthConspiracy.HorrorInHighGear qualified as Cards
