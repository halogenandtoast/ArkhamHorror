module Arkham.Act.Cards.TheInnsmouthConspiracy.InTooDeep.ThroughTheLabyrinth (throughTheLabyrinth) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheInnsmouthConspiracy.InTooDeep qualified as Cards
