module Arkham.Act.Cards.ThePathToCarcosa.APhantomOfTruth.TheParisianConspiracyV2 (theParisianConspiracyV2) where

import Arkham.Ability
import Arkham.Act.CardDefs.ThePathToCarcosa.APhantomOfTruth qualified as Cards
