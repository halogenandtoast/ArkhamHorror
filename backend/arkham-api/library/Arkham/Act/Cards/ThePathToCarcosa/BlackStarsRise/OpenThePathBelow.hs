module Arkham.Act.Cards.ThePathToCarcosa.BlackStarsRise.OpenThePathBelow (openThePathBelow) where

import Arkham.Ability
import Arkham.Act.CardDefs.ThePathToCarcosa.BlackStarsRise qualified as Cards
