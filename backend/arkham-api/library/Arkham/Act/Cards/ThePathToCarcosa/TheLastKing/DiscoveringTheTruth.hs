module Arkham.Act.Cards.ThePathToCarcosa.TheLastKing.DiscoveringTheTruth (discoveringTheTruth) where

import Arkham.Ability
import Arkham.Act.CardDefs.ThePathToCarcosa.TheLastKing qualified as Cards
