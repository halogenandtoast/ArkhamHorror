module Arkham.Act.Cards.ThePathToCarcosa.TheUnspeakableOath.TheReallyBadOnesV1 (theReallyBadOnesV1) where

import Arkham.Act.CardDefs.ThePathToCarcosa.TheUnspeakableOath qualified as Cards
