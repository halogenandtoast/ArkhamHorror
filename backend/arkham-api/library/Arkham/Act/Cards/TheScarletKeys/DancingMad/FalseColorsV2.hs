module Arkham.Act.Cards.TheScarletKeys.DancingMad.FalseColorsV2 (falseColorsV2) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheScarletKeys.DancingMad qualified as Cards
