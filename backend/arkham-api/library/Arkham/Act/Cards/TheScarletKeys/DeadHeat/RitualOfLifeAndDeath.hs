module Arkham.Act.Cards.TheScarletKeys.DeadHeat.RitualOfLifeAndDeath (ritualOfLifeAndDeath) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheScarletKeys.DeadHeat qualified as Cards
