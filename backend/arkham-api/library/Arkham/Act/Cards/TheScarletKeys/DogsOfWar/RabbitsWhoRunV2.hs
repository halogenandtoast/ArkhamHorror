module Arkham.Act.Cards.TheScarletKeys.DogsOfWar.RabbitsWhoRunV2 (rabbitsWhoRunV2) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheScarletKeys.DogsOfWar qualified as Cards
