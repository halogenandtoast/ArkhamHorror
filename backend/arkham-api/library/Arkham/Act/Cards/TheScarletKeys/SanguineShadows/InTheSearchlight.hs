module Arkham.Act.Cards.TheScarletKeys.SanguineShadows.InTheSearchlight (inTheSearchlight) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheScarletKeys.SanguineShadows qualified as Cards
