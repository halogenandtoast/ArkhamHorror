module Arkham.Act.Cards.TheScarletKeys.ShadesOfSuffering.TheLadyWithTheRedParasol (theLadyWithTheRedParasol) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheScarletKeys.ShadesOfSuffering qualified as Cards
