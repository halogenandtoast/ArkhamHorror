module Arkham.Agenda.Cards.CurseOfTheRougarou.ACreatureOfTheBayou (aCreatureOfTheBayou) where

import Arkham.Agenda.CardDefs.CurseOfTheRougarou qualified as Cards
