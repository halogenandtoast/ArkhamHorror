module Arkham.Agenda.Cards.GuardiansOfTheAbyss.TheNightsUsurper.TheBrotherhoodBidesTheirTime (theBrotherhoodBidesTheirTime) where

import Arkham.Agenda.CardDefs.GuardiansOfTheAbyss.TheNightsUsurper qualified as Cards
