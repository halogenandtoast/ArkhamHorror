module Arkham.Agenda.Cards.MurderAtTheExcelsiorHotel.TheTrueCulpritV7 (theTrueCulpritV7) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.MurderAtTheExcelsiorHotel qualified as Cards
import Arkham.Agenda.Import.Lifted
import Arkham.Asset.Cards qualified as Cards
import Arkham.Enemy.CardDefs.DarkRituals qualified as Cards
