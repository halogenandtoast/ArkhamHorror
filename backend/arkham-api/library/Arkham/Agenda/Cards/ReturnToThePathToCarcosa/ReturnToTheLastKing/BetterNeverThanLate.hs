module Arkham.Agenda.Cards.ReturnToThePathToCarcosa.ReturnToTheLastKing.BetterNeverThanLate (betterNeverThanLate) where

import Arkham.Agenda.CardDefs.ReturnToThePathToCarcosa.ReturnToTheLastKing qualified as Cards
