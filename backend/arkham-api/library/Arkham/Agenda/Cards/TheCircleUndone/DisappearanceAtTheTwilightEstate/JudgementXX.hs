module Arkham.Agenda.Cards.TheCircleUndone.DisappearanceAtTheTwilightEstate.JudgementXX (judgementXX) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheCircleUndone.DisappearanceAtTheTwilightEstate qualified as Cards
