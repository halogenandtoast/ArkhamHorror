module Arkham.Agenda.Cards.TheCircleUndone.UnionAndDisillusion.TheLoversVI (theLoversVI, theLoversVIEffect) where

import Arkham.Agenda.CardDefs.TheCircleUndone.UnionAndDisillusion qualified as Cards
