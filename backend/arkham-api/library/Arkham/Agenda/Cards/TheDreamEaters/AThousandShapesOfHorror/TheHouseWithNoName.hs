module Arkham.Agenda.Cards.TheDreamEaters.AThousandShapesOfHorror.TheHouseWithNoName (TheHouseWithNoName (..), theHouseWithNoName) where

import Arkham.Agenda.CardDefs.TheDreamEaters.AThousandShapesOfHorror qualified as Cards
