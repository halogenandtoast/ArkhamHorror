module Arkham.Agenda.Cards.TheDreamEaters.TheSearchForKadath.JourneyAcrossTheDreamlands (journeyAcrossTheDreamlands) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheDreamEaters.TheSearchForKadath qualified as Cards
