module Arkham.Agenda.Cards.TheDreamEaters.WeaverOfTheCosmos.RealitiesInterwoven (realitiesInterwoven) where

import Arkham.Agenda.CardDefs.TheDreamEaters.WeaverOfTheCosmos qualified as Cards
