module Arkham.Agenda.Cards.TheDrownedCity.ObsidianCanyons.OtherworldlyStorms (otherworldlyStorms) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheDrownedCity.ObsidianCanyons qualified as Cards
