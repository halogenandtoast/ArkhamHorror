module Arkham.Agenda.Cards.TheDrownedCity.OneLastJob.ArkhamNightlife (arkhamNightlife) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheDrownedCity.OneLastJob qualified as Cards
