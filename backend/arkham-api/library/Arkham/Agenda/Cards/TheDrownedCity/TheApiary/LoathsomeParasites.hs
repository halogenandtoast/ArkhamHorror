module Arkham.Agenda.Cards.TheDrownedCity.TheApiary.LoathsomeParasites (loathsomeParasites) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheDrownedCity.TheApiary qualified as Cards
