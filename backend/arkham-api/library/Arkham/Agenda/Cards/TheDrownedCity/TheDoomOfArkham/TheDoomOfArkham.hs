module Arkham.Agenda.Cards.TheDrownedCity.TheDoomOfArkham.TheDoomOfArkham (theDoomOfArkham) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheDrownedCity.TheDoomOfArkham qualified as Cards
