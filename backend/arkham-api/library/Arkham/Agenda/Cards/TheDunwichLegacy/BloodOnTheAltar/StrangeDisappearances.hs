module Arkham.Agenda.Cards.TheDunwichLegacy.BloodOnTheAltar.StrangeDisappearances (strangeDisappearances) where

import Arkham.Agenda.CardDefs.TheDunwichLegacy.BloodOnTheAltar qualified as Cards
