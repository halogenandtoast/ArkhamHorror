module Arkham.Agenda.Cards.TheDunwichLegacy.TheHouseAlwaysWins.ChaosInTheCloverClub (chaosInTheCloverClub) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheDunwichLegacy.TheHouseAlwaysWins qualified as Cards
