module Arkham.Agenda.Cards.TheDunwichLegacy.UndimensionedAndUnseen.RampagingCreatures (rampagingCreatures) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheDunwichLegacy.UndimensionedAndUnseen qualified as Cards
