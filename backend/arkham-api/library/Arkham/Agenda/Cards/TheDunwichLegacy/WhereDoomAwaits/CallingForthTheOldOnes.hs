module Arkham.Agenda.Cards.TheDunwichLegacy.WhereDoomAwaits.CallingForthTheOldOnes (callingForthTheOldOnes) where

import Arkham.Agenda.CardDefs.TheDunwichLegacy.WhereDoomAwaits qualified as Cards
