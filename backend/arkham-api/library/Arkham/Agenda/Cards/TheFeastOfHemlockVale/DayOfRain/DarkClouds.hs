module Arkham.Agenda.Cards.TheFeastOfHemlockVale.DayOfRain.DarkClouds (darkClouds) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheFeastOfHemlockVale.DayOfRain qualified as Cards
