module Arkham.Agenda.Cards.TheFeastOfHemlockVale.DayOfRest.WelcomeToHemlockVale (welcomeToHemlockVale) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheFeastOfHemlockVale.DayOfRest qualified as Cards
