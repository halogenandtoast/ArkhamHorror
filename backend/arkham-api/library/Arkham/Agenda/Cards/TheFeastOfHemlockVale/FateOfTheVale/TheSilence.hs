module Arkham.Agenda.Cards.TheFeastOfHemlockVale.FateOfTheVale.TheSilence (theSilence) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheFeastOfHemlockVale.FateOfTheVale qualified as Cards
