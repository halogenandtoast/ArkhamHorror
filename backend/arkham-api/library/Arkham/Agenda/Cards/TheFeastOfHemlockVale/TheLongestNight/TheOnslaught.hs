module Arkham.Agenda.Cards.TheFeastOfHemlockVale.TheLongestNight.TheOnslaught (theOnslaught) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheFeastOfHemlockVale.TheLongestNight qualified as Cards
