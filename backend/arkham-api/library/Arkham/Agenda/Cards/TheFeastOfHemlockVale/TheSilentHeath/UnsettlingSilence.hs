module Arkham.Agenda.Cards.TheFeastOfHemlockVale.TheSilentHeath.UnsettlingSilence (unsettlingSilence) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheFeastOfHemlockVale.TheSilentHeath qualified as Cards
