module Arkham.Agenda.Cards.TheFeastOfHemlockVale.WrittenInRock.UndergroundSurvey (undergroundSurvey) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheFeastOfHemlockVale.WrittenInRock qualified as Cards
