module Arkham.Agenda.Cards.TheForgottenAge.HeartOfTheElders.TheLonelyCaverns (theLonelyCaverns) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheForgottenAge.HeartOfTheElders qualified as Cards
