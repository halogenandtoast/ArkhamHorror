module Arkham.Agenda.Cards.TheInnsmouthConspiracy.DevilReef.SecretsOfTheSeaV1 (
  SecretsOfTheSeaV1 (..),
  secretsOfTheSeaV1,
) where

import Arkham.Agenda.CardDefs.TheInnsmouthConspiracy.DevilReef qualified as Cards
import Arkham.Agenda.Import.Lifted
import Arkham.Asset.Cards qualified as Assets
import Arkham.Campaigns.TheInnsmouthConspiracy.Helpers
import Arkham.Card
import Arkham.Cost
import Arkham.Enemy.CardDefs.TheInnsmouthConspiracy.DevilReef qualified as Enemies
