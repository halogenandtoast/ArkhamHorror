module Arkham.Agenda.Cards.TheInnsmouthConspiracy.TheLairOfDagon.WhatLurksBelowV2 (WhatLurksBelowV2 (..), whatLurksBelowV2) where

import Arkham.Agenda.CardDefs.TheInnsmouthConspiracy.TheLairOfDagon qualified as Cards
