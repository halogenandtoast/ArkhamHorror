module Arkham.Agenda.Cards.TheInnsmouthConspiracy.ThePitOfDespair.TheWaterRises (TheWaterRises (..), theWaterRises, theWaterRisesEffect) where

import Arkham.Agenda.CardDefs.TheInnsmouthConspiracy.ThePitOfDespair qualified as Cards
