module Arkham.Agenda.Cards.ThePathToCarcosa.DimCarcosa.MadnessCoils (madnessCoils) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.ThePathToCarcosa.DimCarcosa qualified as Cards
    ...
    AdvanceAgenda (isSide B attrs -> True) -> do
      ...
      chooseOneM lead $ scenarioI18n do
        for_ (setToList skills) \sk -> do
          (unscoped $ countVar 4 $ skillVar sk $ labeled "anyInvestigatorTests") do
