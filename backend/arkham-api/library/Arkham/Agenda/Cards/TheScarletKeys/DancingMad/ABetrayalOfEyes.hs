module Arkham.Agenda.Cards.TheScarletKeys.DancingMad.ABetrayalOfEyes (aBetrayalOfEyes) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheScarletKeys.DancingMad qualified as Cards
