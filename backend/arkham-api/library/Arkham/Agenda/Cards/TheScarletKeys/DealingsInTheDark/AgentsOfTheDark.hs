module Arkham.Agenda.Cards.TheScarletKeys.DealingsInTheDark.AgentsOfTheDark (agentsOfTheDark) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheScarletKeys.DealingsInTheDark qualified as Cards
