module Arkham.Agenda.Cards.TheScarletKeys.DogsOfWar.BrewingCatastropheV3 (brewingCatastropheV3) where

import Arkham.Agenda.CardDefs.TheScarletKeys.DogsOfWar qualified as Cards
