module Arkham.Agenda.Cards.TheScarletKeys.SanguineShadows.WhereIsShe (whereIsShe) where

import Arkham.Ability
import Arkham.Agenda.CardDefs.TheScarletKeys.SanguineShadows qualified as Cards
