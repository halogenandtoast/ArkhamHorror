module Arkham.Agenda.Cards.TheScarletKeys.ShadesOfSuffering.PainfulHistory (painfulHistory) where

import Arkham.Agenda.CardDefs.TheScarletKeys.ShadesOfSuffering qualified as Cards
