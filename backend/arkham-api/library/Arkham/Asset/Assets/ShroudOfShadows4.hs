module Arkham.Asset.Assets.ShroudOfShadows4 (shroudOfShadows4, shroudOfShadows4Effect) where
              ...
              when (token.face == #curse) do
                ...
                when (stillInPlay || notNull locations) do
                  chooseOrRunOneM iid do
                    when stillInPlay do
                      (cardI18n $ labeled' "shroudOfShadows4.place1ChargeOnShroudOfShadows4") do
