module Arkham.Asset.Assets.ThirtyTwoColt2 (thirtyTwoColt2) where
...
instance HasAbilities ThirtyTwoColt2 where
  getAbilities (ThirtyTwoColt2 a) =
    ...
    , restricted a 2 ControlsThis $ FastAbility $ ResourceCost 1
    ]

instance RunMessage ThirtyTwoColt2 where
  runMessage msg a@(ThirtyTwoColt2 attrs) = runQueueT $ case msg of
    ...
    UseThisAbility iid (isSource attrs -> True) 2 -> do
      ...
      pure a
    _ -> ThirtyTwoColt2 <$> liftRunMessage msg attrs
