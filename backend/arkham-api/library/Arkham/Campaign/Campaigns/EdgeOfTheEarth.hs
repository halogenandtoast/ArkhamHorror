...
import Arkham.Campaign.Campaigns.EdgeOfTheEarth.Achievements (runEdgeOfTheEarthAchievements)
...
instance RunMessage EdgeOfTheEarth where
  runMessage msg c@(EdgeOfTheEarth attrs) =
    runQueueT $ campaignI18n $ lift (runEdgeOfTheEarthAchievements msg) *> case msg of
      StartCampaign -> do
