module Arkham.Campaigns.ChildrenOfBlood.ChaosBag where
...
chaosBagContents = \case
  ...
  Hard ->
    ...
    , Skull, Skull, Tablet, ElderThing, AutoFail, ElderSign, BloodToken
    ]
  Expert ->
    [ Zero, MinusOne, MinusOne, MinusTwo, MinusTwo, MinusThree, MinusThree, MinusFour, MinusFour, MinusFive, MinusSix, MinusEight
    , Skull, Skull, Tablet, ElderThing, AutoFail, ElderSign, BloodToken, BloodToken
    ]
{- FOURMOLU_ENABLE -}
