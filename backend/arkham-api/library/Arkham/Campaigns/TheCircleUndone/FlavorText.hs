...
prologue =
  FlavorText
    (Just "Prologue")
    [ BasicEntry "Sunday, November 22nd, 1925. Arkham, Massachusetts."
    , BasicEntry "Though All Hallows’ Eve is nearly a month past, a grim melancholy lingers\
...
intro =
  FlavorText
    (Just "Intro")
    [ BasicEntry "“Ladies and gentlemen,” Josef Meiger announces, raising a glass of champagne in\
    ...
    , BasicEntry "Josef ’s assistant, Jerome, blends into the wall behind Josef, discreetly\
    ...
    , BasicEntry "“I’m afraid not,” Jerome replies, flipping through the last pages of the\
      \ estate’s guest book. “But he should be here any minute, Mr. Meiger.”"
    , BasicEntry "“Good. I want there to be no problems whatsoever when he arrives; am I\
    ...
    , BasicEntry "“Not even for Mr. Rivas, sir?” Jerome asks, glancing at Josef over the rim of\
      \ his thick glasses. Josef pauses for a moment, considering."
    , BasicEntry "“Pour Mr. Rivas another glass of champagne, and I am sure he will not complain.\
    ...
    , BasicEntry "Soon after, the dark mist would appear, and nothing would be the same."
    ]
...
gavriellaIntro =
  FlavorText
    ...
    [ BasicEntry "You stand guard as instructed, waiting for Mr. Sanford to appear. By now, the\
    ...
    , BasicEntry "You step back cautiously, keeping a hand on the grip of your weapon just in\
      ...
      \ blackened finger."
    , BasicEntry "You unholster your firearm and point it at the creature, allowing your training\
    ...
    , BasicEntry "Nothing could have prepared you for combat with such an unnatural enemy. Faced\
...
jeromeIntro =
  FlavorText
    (Just "Jerome Intro")
    [ BasicEntry "You carefully flip through the pages of Mr. Meiger’s ledger, looking for the\
    ...
    , BasicEntry "You adjust your glasses and lean forward as you turn to the page regarding Mr.\
    ...
    , BasicEntry "Strange as that may seem, it is the list of names on the page afterward that\
    ...
    , BasicEntry "You stand next to Josef ’s desk and record the list in your pocket journal\
      ...
      \ desk."
    , BasicEntry "Pressed up against the office window is a host of screaming faces emerging from\
...
pennyIntro =
  FlavorText
    (Just "Penny Intro")
    [ BasicEntry "You sigh as the cool New England air embraces you. It has been a very stressful\
    ...
    , BasicEntry "You can’t remember a night in which your employer was as concerned with every\
    ...
    , BasicEntry "You are torn from your thoughts by the gathering of grey clouds overhead,\
...
valentinoIntro =
  FlavorText
    ...
    [ BasicEntry "“Are you going to break, or are you going to sit there admiring the cue ball\
      \ all night?” you ask with a mocking smile. Your opponent sets the ivory ball\
      \ back on the table with a sigh."
    , BasicEntry "“I can’t help myself around ivory. You know that, Tino,” Adam replies. You\
    ...
    , BasicEntry "“That was one time, my friend, one time.” You roll your eyes. Truth be told,\
      ...
      \ perks."
    , BasicEntry "You lean over the table and clear your mind as you line up your shot. The room\
    ...
    , BasicEntry "It is only then that you realize the silence around you is not just in your\
...
thePriceOfProgress1 =
  FlavorText
    ...
    [ BasicEntry "“Ah, it’s you. I did not expect you to be here, though perhaps I should have,”\
...
thePriceOfProgress2 =
  FlavorText
    ...
    [ BasicEntry "“I regret that we must meet under such... unfortunate circumstances,” Mr.\
...
thePriceOfProgress3 =
  FlavorText
    ...
    [ BasicEntry "You didn’t come here to listen to Mr. Sanford proselytize about sacrifice. You\
    ...
    , BasicEntry "“I hope you understand that our organization only seeks the betterment of\
...
thePriceOfProgress4 =
  FlavorText
    ...
    [ BasicEntry "Before you can reply, one of Sanford’s men emerges from the house behind you.\
      ...
      \ rigidly disciplined."
    , BasicEntry "“I see,” Sanford replies. He closes his eyes and takes a deep breath before\
...
thePriceOfProgress5 =
  FlavorText
    ...
    [ BasicEntry "You consider Mr. Sanford’s words carefully. You believe that he is telling the\
    ...
    , BasicEntry "“Courage is not the same as sacrifice, Josef,” Carl Sanford intones patiently.\
...
thePriceOfProgress6 =
  FlavorText
    ...
    [ BasicEntry "You consider Mr. Sanford’s words carefully. You believe that he is telling the\
      ...
      \ eyes."
    , BasicEntry "“Stay your tongue, Josef,” Sanford interjects. He approaches calmly, extending\
...
thePriceOfProgress7 =
  FlavorText
    ...
    [ BasicEntry "Mr. Sanford scowls, returning his hand to his side and narrowing his gaze. “I\
...
thePriceOfProgress8 =
  FlavorText
    ...
    [ BasicEntry "You shake Mr. Sanford’s hand. His grip is cold, but strong. The other members\
...
theInnerCircle1 =
  FlavorText
    ...
    [ BasicEntry "You have been brought deep into the inner sanctum, where only the\
      ...
      \ affirmation."
    , BasicEntry "“Here is what we know: it was the witches who brought this abomination upon\
...
theInnerCircle2 =
  FlavorText
    ...
    [ BasicEntry "You show Mr. Sanford the evidence you’ve collected. “Hm... Yes, I see. It is as\
...
theInnerCircle3 =
  FlavorText
    ...
    [ BasicEntry "You don’t trust Carl Sanford with these pieces of evidence. Who knows what he\
    ...
    , BasicEntry "Mr. Sanford rises to his feet, and the other members of the Order follow suit.\
...
theInnerCircle4 =
  FlavorText
    ...
    [ BasicEntry "Carl Sanford grins and rises to his feet. “You have proven yourself a loyal\
...
theInnerCircle5 =
  FlavorText
    ...
    [ BasicEntry "Carl Sanford gives the trinkets and strange components to another member of the\
...
whatIsTheCreature =
  FlavorText
    Nothing
    [ BasicEntry "“It is a powerful remnant, left behind from one who perished long ago. The\
...
whatDoYouWantWithTheCreature =
  FlavorText
    Nothing
    [ BasicEntry "“First and foremost, we need to bind it to prevent it from doing further harm.\
...
whatDoTheWitchesWantWithTheCreature =
  FlavorText
    Nothing
    [ BasicEntry "“I am sure they wish to learn its secrets, and draw from its power,” he\
...
didYouKnowAboutTheCreatureBeforeTheCharityGala =
  FlavorText
    Nothing
    [ BasicEntry "“In truth, yes,” Mr. Sanford admits. “But we did not know it would come to us.\
...
whereAreTheFourMissingPeopleFromTheCharityGala =
  FlavorText
    Nothing
    [ BasicEntry "“God only knows,” Mr. Sanford replies with a sigh. “Taken by the revenant,\
...
whyAreYouLookingAtMeLikeThat = FlavorText Nothing [BasicEntry "Mr. Sanford clears his throat. “I... It is nothing,” he lies."]

twistOfFate1 :: FlavorText
twistOfFate1 =
  FlavorText
    (Just "Twist of Fate 1")
    [ BasicEntry "You stand underneath the breach, in awe of its presence. Everything the\
    ...
    , BasicEntry "There is a bitter taste in your mouth. Tears well in your eyes. You close your\
...
twistOfFate2 =
  FlavorText
    ...
    [ BasicEntry "For almost an hour, you stare up into the empty abyss, pondering your options\
...
anette'sAssistance =
  FlavorText
    Nothing
    [ BasicEntry "“Keziah was beseeched to sign a book by the messenger of an ancient being.\
...
sanford'sAssistance =
  FlavorText
    Nothing
    [ BasicEntry "“It is a gateway,” Sanford explains, “ joining our world and the greater\
...
epilogueArrestedAnette =
  FlavorText
    (Just "Epilogue")
    [ BasicEntry "“Gone? What do you mean she’s gone?!” Sheriff Engle demands."
    , BasicEntry "“See for yourself,” the officer replies. He guides the sheriff through a\
...
epilogueAssumedControlOfTheLodge =
  FlavorText
    (Just "Epilogue")
    [ BasicEntry "You nod to the knight as he places the file you had requested onto your\
...
epilogueSurvivedTheWatchersEmbrace =
  FlavorText
    (Just "Epilogue")
    [ BasicEntry "Anna regards you calmly as you enter. As always, her prescience is\
      ...
      \ peace.”"
    , BasicEntry "Peace? No, you cannot be at peace! There is still so much left for you\
      \ to do...!"
    ]
...
epilogueSignedTheBlackBook =
  FlavorText
    (Just "Epilogue")
    [ BasicEntry "In your dream, a tall man approaches. His grin is full of malice. “It is\
...
youAreBeingHunted =
  FlavorText
    ...
    [ BasicEntry "No matter what you do, the creature’s assault on your mind never ceases.\
    ...
    , BasicEntry "When the creature next invades, you have come to a new conclusion. An\
