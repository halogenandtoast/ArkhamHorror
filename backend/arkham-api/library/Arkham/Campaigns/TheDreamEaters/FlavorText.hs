...
theBlackCat1 =
  FlavorText
    ...
    [ BasicEntry "As you travel out of the Enchanted Woods, you pass through rolling green\
    ...
    , BasicEntry "The town of Ulthar is not quite what you had imagined. The border of the\
    ...
    , BasicEntry "Randolph leads you through the town square, which is surrounded by\
    ...
    , BasicEntry "Regardless, you approach the man and introduce yourself, along with\
    ...
    , BasicEntry "You nod your head in agreement and inform Virgil that you intend to find\
    ...
    , BasicEntry "Randolph interjects. “There is a place within the Dreamlands that may\
    ...
    , BasicEntry "“Oh?” Virgil asks, intrigued. “And what is this place?”"
    , BasicEntry "“It is a marvelous city,” he describes, his eyes aglow with wonder,\
    ...
    , BasicEntry "Virgil idly pets the cat on the countertop next to him as he is absorbed\
    ...
    , BasicEntry "You tell Virgil and Randolph that before you commit to such an\
    ...
    , BasicEntry "You and the others spin your heads around, searching for the source of\
      ...
      \ Kadath,” it says."
    , BasicEntry "“You can talk?” Virgil says, nearly toppling over his stool as he jumps in surprise."
    , BasicEntry "“I’m a cat, you dolt. Of course I can talk,” the black cat replies,\
      \ licking its paw out of boredom. “You have met a thousand cats from Ulthar,\
      \ and now you are surprised?”"
    , BasicEntry "“But...I thought...” Virgil wipes his brow with his palm."
    , BasicEntry "“Never mind him,” the black cat says, addressing you directly. “I assure\
...
theBlackCat2 = FlavorText (Just "The Black Cat 2") [BasicEntry "“What shall I tell your friends in the waking world?”"]

theBlackCat3 :: FlavorText
theBlackCat3 =
  FlavorText
    (Just "The Black Cat 3")
    [ BasicEntry "“...You must be their friends,” the enigmatic voice says from above. To\
    ...
    , BasicEntry "“It is one of the cats of Earth’s Dreamlands,” Randolph proclaims, his\
      ...
      \ your kind!”"
    , BasicEntry "The cat’s piercing yellow eyes glare at Randolph for a moment before it\
...
youAreOnYourOwn =
  FlavorText
    Nothing
    [ BasicEntry "“Your friends are not the only ones in trouble,” the black cat explains.\
...
theBlackCatSharedKnowledgeOfTheDreamlands =
  FlavorText
    Nothing
    [ BasicEntry "The black cat tells you all about the Dreamlands and about the quest\
...
theBlackCatDeliveredNewsOfYourPlight =
  FlavorText
    Nothing
    [ BasicEntry "“So, your pals aren’t looking too good. They wanted me to tell you that\
...
theBlackCatWarnedTheOthers =
  FlavorText
    Nothing
    [ BasicEntry "“Your friends told me to tell you that they’re fine. In fact, they told\
...
okayFineHaveItYourWayThen =
  FlavorText
    Nothing
    [ BasicEntry "“Nah, you know what? Forget about it. I’m sure you’ll be fine.” The black\
...
theOneironauts1 =
  FlavorText
    ...
    [ BasicEntry "The black cat awaits you at the bottom of the stairs, watching your long\
...
where'sBlondie =
  FlavorText
    Nothing
    [ BasicEntry "“Where’s blondie?” the black cat asks, peering around. You remain silent,\
...
youAskedForIt =
  FlavorText
    Nothing
    [ BasicEntry "“Well, since you clearly don’t need my help, I’ll be off now. Just wanted\
...
youDidNotAskForIt =
  FlavorText
    Nothing
    [ BasicEntry "You’ve about had it with this cat’s cryptic half-truths and nonanswers.\
...
theOneironauts2 =
  FlavorText
    Nothing
    [ BasicEntry "<b>The Oneironauts 2</b>: You open your eyes to the sound of a cat’s\
...
atLeastOneNotCaptured =
  FlavorText
    Nothing
    [ BasicEntry "“Wait, where is my human?” the cat asks, craning its head to look around\
...
allCaptured =
  FlavorText
    Nothing
    [ BasicEntry "You try to shush the black cat, but it ignores you. “Relax. Your captors\
...
searchingForTheTruth =
  FlavorText
    Nothing
    [ BasicEntry "The black cat sees Randolph at the helm of your ship and glares at him\
...
nowWhereWasI =
  FlavorText
    Nothing
    [ BasicEntry "“Now, where was I? Oh, right. I had a chat with your friends. They’re in\
...
sharedTheKnowledgeStory =
  FlavorText
    Nothing
    [ BasicEntry "The black cat tells you all about the region of the Dreamlands your companions have entered. “The entire surface of the Dreamlands, where you’ve been exploring, covers the Underworld like a beautiful silk dress over decayed skin. You have no reason to go there, which is a good thing, because it is a particularly inhospitable place. You actually might have walked right by one entrance to the Underworld, now that I think about it—back in the Enchanted Woods. There are several other entrances as well: beneath an old monastery in Leng, another in the ruins of Sarkomand...”"
    ]
...
theGreatOnes1 =
  FlavorText
    ...
    [ BasicEntry "You are nudged out of a sleepless reverie by a furry forehead. You look\
...
theGreatOnes1GrowWeaker =
  FlavorText
    Nothing
    [ BasicEntry "“Whoa,” the cat says suddenly, “you’re not looking too good, you know.”\
...
theGreatOnes1Searching =
  FlavorText
    Nothing
    [ BasicEntry "“Where’s what’s-his-name?” the black cat asks, searching for Randolph.\
...
theGreatOnes1YouAskedForIt =
  FlavorText
    Nothing
    [ BasicEntry "“Don’t mind me. I just wanted to see if you’re alive.” You begin to tell\
...
theGreatOnes1Part2 =
  FlavorText
    Nothing
    [ BasicEntry "You ask the black cat if it knows what you’ll find in Kadath. “Sort of,”\
...
theGreatOnes2 =
  FlavorText
    (Just "Interlude III: The Great Ones")
    [ BasicEntry "A cat’s low-pitched wail draws your attention to a nearby web. When you\
...
theGreatOnes2TheSilverKey =
  FlavorText
    Nothing
    [ BasicEntry "“Hey, you still have that key?” the black cat asks. You scrounge through\
...
theGreatOnes2Searching =
  FlavorText
    Nothing
    [ BasicEntry "The black cat stops talking as it spots Randolph for the first time. It\
    ...
    , BasicEntry "“Your mere existence offends me,” the cat replies with a hiss. It\
...
theGreatOnes2Part2 =
  FlavorText
    (Just "Interlude III: The Great Ones")
    [ BasicEntry "“Oh, before I forget: your friends have almost made it to their\
...
theGreatOnes2Nyarlathotep =
  FlavorText
    Nothing
    [ BasicEntry "“...the being they face is one with thousands, perhaps an endless number\
...
theGreatOnes2AtlachNacha =
  FlavorText
    Nothing
    [ BasicEntry "“...that bridge I just mentioned? The creature weaving it is unlike\
