...
displayCostType = \case
  ...
  UseCost _ uType n -> case uType of
    ...
    ScoutingReport -> pluralize n "Scouting Report"
    Scrap -> pluralize n "Scrap"
    Seal -> pluralize n "Seal"
    Secret -> pluralize n "Secret"
    Shell -> pluralize n "Shell"
    Study -> pluralize n "Study"
  ...
  DynamicUseCost _ uType _ -> case uType of
    ...
    ScoutingReport -> "X Scouting Reports"
    Scrap -> "X Scraps"
    Seal -> "X Seals"
    Secret -> "X Secrets"
    Shell -> "X Shells"
  ...
  UseCostUpTo _ uType n m -> case uType of
    ...
    Brilliance -> tshow n <> "-" <> tshow m <> " Brilliance"
