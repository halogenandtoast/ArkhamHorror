module Arkham.Enemy.Cards.BadBlood.ElspethBaudin (elspethBaudin) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.BadBlood qualified as Cards
...
import Arkham.Story.CardDefs.BadBlood qualified as Stories
