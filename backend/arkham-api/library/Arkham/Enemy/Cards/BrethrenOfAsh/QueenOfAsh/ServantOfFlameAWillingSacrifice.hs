module Arkham.Enemy.Cards.BrethrenOfAsh.QueenOfAsh.ServantOfFlameAWillingSacrifice (servantOfFlameAWillingSacrifice) where

import Arkham.Ability
import Arkham.Campaigns.BrethrenOfAsh.Helpers
import Arkham.Enemy.CardDefs.BrethrenOfAsh.QueenOfAsh qualified as Cards
