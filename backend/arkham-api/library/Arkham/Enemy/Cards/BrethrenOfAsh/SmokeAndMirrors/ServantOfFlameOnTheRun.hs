module Arkham.Enemy.Cards.BrethrenOfAsh.SmokeAndMirrors.ServantOfFlameOnTheRun (servantOfFlameOnTheRun) where
...
servantOfFlameOnTheRun = enemy ServantOfFlameOnTheRun Cards.servantOfFlameOnTheRun
