...
bloodCrazedMongrel = enemy BloodCrazedMongrel Cards.bloodCrazedMongrel

instance RunMessage BloodCrazedMongrel where
  runMessage msg (BloodCrazedMongrel attrs) = runQueueT $ case msg of
    _ -> BloodCrazedMongrel <$> liftRunMessage msg attrs
