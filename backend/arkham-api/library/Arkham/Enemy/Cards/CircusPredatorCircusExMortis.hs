module Arkham.Enemy.Cards.CircusPredatorCircusExMortis (circusPredatorCircusExMortis) where
...
circusPredatorCircusExMortis :: EnemyCard CircusPredator
circusPredatorCircusExMortis =
  enemy CircusPredator Cards.circusPredatorCircusExMortis
