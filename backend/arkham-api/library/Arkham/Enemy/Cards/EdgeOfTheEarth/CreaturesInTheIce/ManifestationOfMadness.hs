module Arkham.Enemy.Cards.EdgeOfTheEarth.CreaturesInTheIce.ManifestationOfMadness (manifestationOfMadness) where

import Arkham.Ability
import Arkham.Campaigns.EdgeOfTheEarth.Helpers
import Arkham.Enemy.CardDefs.EdgeOfTheEarth.CreaturesInTheIce qualified as Cards
