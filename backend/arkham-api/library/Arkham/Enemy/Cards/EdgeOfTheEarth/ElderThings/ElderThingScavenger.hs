module Arkham.Enemy.Cards.EdgeOfTheEarth.ElderThings.ElderThingScavenger (elderThingScavenger) where

import Arkham.Ability
import Arkham.Card
import Arkham.Enemy.CardDefs.EdgeOfTheEarth.ElderThings qualified as Cards
