module Arkham.Enemy.Cards.EdgeOfTheEarth.IceAndDeath.JamesCookieFredericksDubiousChoice (jamesCookieFredericksDubiousChoice) where

import Arkham.Ability
import Arkham.Campaigns.EdgeOfTheEarth.Helpers
import Arkham.Enemy.CardDefs.EdgeOfTheEarth.IceAndDeath qualified as Cards
