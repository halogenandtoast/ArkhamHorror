module Arkham.Enemy.Cards.EdgeOfTheEarth.LeftBehind.LostResearcher (lostResearcher) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.EdgeOfTheEarth.LeftBehind qualified as Cards
    ...
    UseThisAbility iid (isSource attrs -> True) 2 -> do
      ...
      chooseOneM iid do
        for_ [#willpower, #intellect] \sType ->
          skillLabeled sType $ parley sid iid (attrs.ability 2) attrs sType (Fixed 3)
      pure e
