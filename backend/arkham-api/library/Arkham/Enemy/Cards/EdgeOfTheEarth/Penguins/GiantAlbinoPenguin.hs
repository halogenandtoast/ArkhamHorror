module Arkham.Enemy.Cards.EdgeOfTheEarth.Penguins.GiantAlbinoPenguin (giantAlbinoPenguin) where

import Arkham.Cost
import Arkham.Enemy.CardDefs.EdgeOfTheEarth.Penguins qualified as Cards
