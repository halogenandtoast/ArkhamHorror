module Arkham.Enemy.Cards.EdgeOfTheEarth.Shoggoths.ForgottenShoggoth (forgottenShoggoth) where

import Arkham.Ability
import Arkham.Campaigns.EdgeOfTheEarth.Helpers
import Arkham.Enemy.CardDefs.EdgeOfTheEarth.Shoggoths qualified as Cards
