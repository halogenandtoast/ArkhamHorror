module Arkham.Enemy.Cards.EdgeOfTheEarth.TheHeartOfMadness.UnsealedPhantasm (unsealedPhantasm) where
...
unsealedPhantasm =
  enemyWith
    ...
    ( spawnAtL
        ?~ SpawnAtFirst
          [ SpawnAt
              (NearestLocationToYou $ "Mist-Pylon" <> LocationWithoutModifier (ScenarioModifier "collapsed"))
