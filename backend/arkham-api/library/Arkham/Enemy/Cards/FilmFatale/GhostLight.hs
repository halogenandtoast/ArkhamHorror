module Arkham.Enemy.Cards.FilmFatale.GhostLight (ghostLight) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.FilmFatale qualified as Cards
...
instance HasAbilities GhostLight where
  getAbilities (GhostLight a) =
    extend1 a
      $ restricted a 1 (thisExists a $ EnemyCanBeDamagedBySource (a.ability 1))
      $ freeReaction
