module Arkham.Enemy.Cards.FortuneAndFolly.AbarranArrigorriagakoaTheManWithTheRubyRing (abarranArrigorriagakoaTheManWithTheRubyRing) where
...
instance HasAbilities AbarranArrigorriagakoaTheManWithTheRubyRing where
  getAbilities (AbarranArrigorriagakoaTheManWithTheRubyRing a) =
    extend
      a
