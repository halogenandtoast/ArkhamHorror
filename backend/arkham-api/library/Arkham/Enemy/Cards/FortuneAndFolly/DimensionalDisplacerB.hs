module Arkham.Enemy.Cards.FortuneAndFolly.DimensionalDisplacerB (dimensionalDisplacerB) where
...
dimensionalDisplacerB =
  enemyWith DimensionalDisplacerB Cards.dimensionalDisplacerB
    $ ( spawnAtL
          ?~ SpawnAt
