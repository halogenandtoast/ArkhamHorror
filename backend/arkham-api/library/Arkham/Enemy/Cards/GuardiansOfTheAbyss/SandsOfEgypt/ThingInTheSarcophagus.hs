module Arkham.Enemy.Cards.GuardiansOfTheAbyss.SandsOfEgypt.ThingInTheSarcophagus (thingInTheSarcophagus) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.GuardiansOfTheAbyss.SandsOfEgypt qualified as Cards
