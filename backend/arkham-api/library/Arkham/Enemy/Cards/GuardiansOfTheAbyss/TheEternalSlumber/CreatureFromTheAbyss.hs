module Arkham.Enemy.Cards.GuardiansOfTheAbyss.TheEternalSlumber.CreatureFromTheAbyss (creatureFromTheAbyss) where

import Arkham.Ability
import Arkham.Campaigns.GuardiansOfTheAbyss.Helpers
import Arkham.Enemy.CardDefs.GuardiansOfTheAbyss.TheEternalSlumber qualified as Cards
