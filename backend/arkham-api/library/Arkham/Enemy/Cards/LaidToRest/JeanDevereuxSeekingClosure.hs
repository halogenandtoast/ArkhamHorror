module Arkham.Enemy.Cards.LaidToRest.JeanDevereuxSeekingClosure (jeanDevereuxSeekingClosure) where

import Arkham.Ability
import Arkham.Card
import Arkham.Enemy.CardDefs.LaidToRest qualified as Cards
