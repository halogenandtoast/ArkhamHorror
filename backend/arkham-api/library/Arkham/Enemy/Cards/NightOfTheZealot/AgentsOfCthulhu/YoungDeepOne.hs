module Arkham.Enemy.Cards.NightOfTheZealot.AgentsOfCthulhu.YoungDeepOne (youngDeepOne) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.NightOfTheZealot.AgentsOfCthulhu qualified as Cards
