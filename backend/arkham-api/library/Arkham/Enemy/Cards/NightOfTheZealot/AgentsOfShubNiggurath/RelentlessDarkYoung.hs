module Arkham.Enemy.Cards.NightOfTheZealot.AgentsOfShubNiggurath.RelentlessDarkYoung (relentlessDarkYoung) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.NightOfTheZealot.AgentsOfShubNiggurath qualified as Cards
