module Arkham.Enemy.Cards.NightOfTheZealot.AgentsOfYogSothoth.YithianObserver (yithianObserver) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.NightOfTheZealot.AgentsOfYogSothoth qualified as Cards
