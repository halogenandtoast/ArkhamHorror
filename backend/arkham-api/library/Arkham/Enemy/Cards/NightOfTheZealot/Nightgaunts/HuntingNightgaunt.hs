module Arkham.Enemy.Cards.NightOfTheZealot.Nightgaunts.HuntingNightgaunt (huntingNightgaunt) where

import Arkham.Enemy.CardDefs.NightOfTheZealot.Nightgaunts qualified as Cards
