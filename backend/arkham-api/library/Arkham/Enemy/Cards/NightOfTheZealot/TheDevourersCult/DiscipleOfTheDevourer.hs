module Arkham.Enemy.Cards.NightOfTheZealot.TheDevourersCult.DiscipleOfTheDevourer (discipleOfTheDevourer) where

import Arkham.Ability
import Arkham.Agenda.Sequence (AgendaStep (..), agendaStep)
import Arkham.Agenda.Types (Field (..))
import Arkham.Campaigns.NightOfTheZealot.Helpers
import Arkham.Enemy.CardDefs.NightOfTheZealot.TheDevourersCult qualified as Cards
