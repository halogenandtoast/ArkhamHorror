module Arkham.Enemy.Cards.ReturnToTheCircleUndone.ReturnToAtDeathsDoorstep.SenatorNathanielRhodesAdeptPolitician (senatorNathanielRhodesAdeptPolitician) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.ReturnToTheCircleUndone.ReturnToAtDeathsDoorstep qualified as Cards
