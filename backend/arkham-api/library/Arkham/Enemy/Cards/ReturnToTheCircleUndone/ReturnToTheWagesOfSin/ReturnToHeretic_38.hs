...
module Arkham.Enemy.Cards.ReturnToTheCircleUndone.ReturnToTheWagesOfSin.ReturnToHeretic_38 (returnToHeretic_38) where
...
returnToHeretic_38 = enemy ReturnToHeretic_38 Cards.returnToHeretic_38
