module Arkham.Enemy.Cards.ReturnToTheDunwichLegacy.ReturnToBloodOnTheAltar.HiredGun (hiredGun) where
...
import Arkham.Treachery.CardDefs.TheDunwichLegacy.NaomisCrew qualified as Treacheries
