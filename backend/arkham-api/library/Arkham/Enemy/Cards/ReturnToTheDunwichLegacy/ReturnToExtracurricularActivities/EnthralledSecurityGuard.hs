module Arkham.Enemy.Cards.ReturnToTheDunwichLegacy.ReturnToExtracurricularActivities.EnthralledSecurityGuard (enthralledSecurityGuard) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.ReturnToTheDunwichLegacy.ReturnToExtracurricularActivities qualified as Cards
