module Arkham.Enemy.Cards.ReturnToTheDunwichLegacy.ReturnToLostInTimeAndSpace.SethBishopThrallOfYogSothoth (sethBishopThrallOfYogSothoth) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.ReturnToTheDunwichLegacy.ReturnToLostInTimeAndSpace qualified as Cards
import Arkham.Enemy.CardDefs.TheDunwichLegacy.LostInTimeAndSpace qualified as Cards
