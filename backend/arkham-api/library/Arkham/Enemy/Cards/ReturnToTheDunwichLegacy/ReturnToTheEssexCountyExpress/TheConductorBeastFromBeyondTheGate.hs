module Arkham.Enemy.Cards.ReturnToTheDunwichLegacy.ReturnToTheEssexCountyExpress.TheConductorBeastFromBeyondTheGate (theConductorBeastFromBeyondTheGate) where

import Arkham.Ability
import Arkham.Direction
import Arkham.Enemy.CardDefs.ReturnToTheDunwichLegacy.ReturnToTheEssexCountyExpress qualified as Cards
