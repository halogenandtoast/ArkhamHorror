module Arkham.Enemy.Cards.ReturnToTheDunwichLegacy.ReturnToUndimensionedAndUnseen.BroodOfYogSothothAmorphousTerror (broodOfYogSothothAmorphousTerror) where
