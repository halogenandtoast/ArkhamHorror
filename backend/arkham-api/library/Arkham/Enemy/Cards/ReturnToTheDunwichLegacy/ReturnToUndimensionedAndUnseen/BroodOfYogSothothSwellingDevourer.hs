module Arkham.Enemy.Cards.ReturnToTheDunwichLegacy.ReturnToUndimensionedAndUnseen.BroodOfYogSothothSwellingDevourer (broodOfYogSothothSwellingDevourer) where

import Arkham.Asset.Cards.TheDunwichLegacy qualified as Assets
import Arkham.Enemy.CardDefs.ReturnToTheDunwichLegacy.ReturnToUndimensionedAndUnseen qualified as Cards
