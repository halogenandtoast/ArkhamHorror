module Arkham.Enemy.Cards.ReturnToTheDunwichLegacy.ReturnToUndimensionedAndUnseen.BroodOfYogSothothThrashingSpawn (broodOfYogSothothThrashingSpawn) where
