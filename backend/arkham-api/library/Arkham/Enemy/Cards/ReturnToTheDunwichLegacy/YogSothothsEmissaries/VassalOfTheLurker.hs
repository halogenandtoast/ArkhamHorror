module Arkham.Enemy.Cards.ReturnToTheDunwichLegacy.YogSothothsEmissaries.VassalOfTheLurker (vassalOfTheLurker) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.ReturnToTheDunwichLegacy.YogSothothsEmissaries qualified as Cards
