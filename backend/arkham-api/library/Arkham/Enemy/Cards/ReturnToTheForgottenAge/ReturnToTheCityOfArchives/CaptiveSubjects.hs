module Arkham.Enemy.Cards.ReturnToTheForgottenAge.ReturnToTheCityOfArchives.CaptiveSubjects (captiveSubjects) where

import Arkham.Enemy.CardDefs.ReturnToTheForgottenAge.ReturnToTheCityOfArchives qualified as Cards
