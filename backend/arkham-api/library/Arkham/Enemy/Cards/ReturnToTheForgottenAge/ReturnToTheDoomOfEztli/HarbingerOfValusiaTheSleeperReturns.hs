module Arkham.Enemy.Cards.ReturnToTheForgottenAge.ReturnToTheDoomOfEztli.HarbingerOfValusiaTheSleeperReturns (harbingerOfValusiaTheSleeperReturns) where

import Arkham.Ability
import Arkham.Card
import Arkham.Enemy.CardDefs.ReturnToTheForgottenAge.ReturnToTheDoomOfEztli qualified as Cards
