module Arkham.Enemy.Cards.ReturnToThePathToCarcosa.ReturnToDimCarcosa.HighPriestOfHastur (highPriestOfHastur) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.ReturnToThePathToCarcosa.ReturnToDimCarcosa qualified as Cards
