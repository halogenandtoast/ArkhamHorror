module Arkham.Enemy.Cards.ReturnToThePathToCarcosa.ReturnToEchoesOfThePast.KeeperOfTheOath (keeperOfTheOath) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.ReturnToThePathToCarcosa.ReturnToEchoesOfThePast qualified as Cards
