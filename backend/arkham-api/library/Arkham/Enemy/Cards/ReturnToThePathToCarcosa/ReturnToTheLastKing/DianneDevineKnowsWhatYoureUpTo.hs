module Arkham.Enemy.Cards.ReturnToThePathToCarcosa.ReturnToTheLastKing.DianneDevineKnowsWhatYoureUpTo (dianneDevineKnowsWhatYoureUpTo) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.ReturnToThePathToCarcosa.ReturnToTheLastKing qualified as Cards
