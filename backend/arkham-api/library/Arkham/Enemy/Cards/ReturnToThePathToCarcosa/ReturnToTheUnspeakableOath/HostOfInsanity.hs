module Arkham.Enemy.Cards.ReturnToThePathToCarcosa.ReturnToTheUnspeakableOath.HostOfInsanity (hostOfInsanity) where

import Arkham.Ability
import Arkham.Asset.Cards qualified as Assets
import Arkham.Enemy.CardDefs.ReturnToThePathToCarcosa.ReturnToTheUnspeakableOath qualified as Cards
