module Arkham.Enemy.Cards.TheCircleUndone.AgentsOfAzathoth.PiperOfAzathoth (piperOfAzathoth) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheCircleUndone.AgentsOfAzathoth qualified as Cards
