module Arkham.Enemy.Cards.TheCircleUndone.AnettesCoven.PriestessOfTheCoven (priestessOfTheCoven) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheCircleUndone.AnettesCoven qualified as Cards
