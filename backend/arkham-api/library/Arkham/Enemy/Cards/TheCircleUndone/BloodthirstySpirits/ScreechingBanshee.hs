module Arkham.Enemy.Cards.TheCircleUndone.BloodthirstySpirits.ScreechingBanshee (screechingBanshee) where

import Arkham.Ability
import Arkham.Campaigns.TheCircleUndone.Helpers
import Arkham.Enemy.CardDefs.TheCircleUndone.BloodthirstySpirits qualified as Cards
