module Arkham.Enemy.Cards.TheCircleUndone.SilverTwilightLodge.KeeperOfSecrets (keeperOfSecrets) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheCircleUndone.SilverTwilightLodge qualified as Cards
