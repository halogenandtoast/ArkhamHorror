module Arkham.Enemy.Cards.TheCircleUndone.SpectralPredators.ShadowHound (shadowHound) where

import Arkham.Ability
import Arkham.Campaigns.TheCircleUndone.Helpers
import Arkham.Enemy.CardDefs.TheCircleUndone.SpectralPredators qualified as Cards
