module Arkham.Enemy.Cards.TheCircleUndone.TheWatcher.TheSpectralWatcher (theSpectralWatcher) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheCircleUndone.TheWatcher qualified as Cards
