module Arkham.Enemy.Cards.TheCircleUndone.TheWitchingHour.AnetteMason (anetteMason) where

import Arkham.Ability
import Arkham.Card
import Arkham.Enemy.CardDefs.TheCircleUndone.TheWitchingHour qualified as Cards
