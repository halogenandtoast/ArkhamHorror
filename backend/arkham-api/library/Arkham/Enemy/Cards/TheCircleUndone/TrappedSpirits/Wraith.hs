module Arkham.Enemy.Cards.TheCircleUndone.TrappedSpirits.Wraith (wraith) where

import Arkham.Ability
import Arkham.Campaigns.TheCircleUndone.Helpers
import Arkham.Card
import Arkham.Classes.HasQueue (HasQueue)
import Arkham.Enemy.CardDefs.TheCircleUndone.TrappedSpirits qualified as Cards
