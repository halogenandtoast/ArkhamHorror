module Arkham.Enemy.Cards.TheCircleUndone.UnionAndDisillusion.GavriellaMizrah (gavriellaMizrah) where
...
gavriellaMizrah = enemy GavriellaMizrah Cards.gavriellaMizrah
