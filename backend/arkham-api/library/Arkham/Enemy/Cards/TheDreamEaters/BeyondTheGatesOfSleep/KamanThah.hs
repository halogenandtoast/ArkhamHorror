module Arkham.Enemy.Cards.TheDreamEaters.BeyondTheGatesOfSleep.KamanThah (kamanThah) where
...
import Arkham.Story.CardDefs.TheDreamEaters.BeyondTheGatesOfSleep qualified as Story
