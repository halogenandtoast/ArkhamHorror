module Arkham.Enemy.Cards.TheDreamEaters.Corsairs.CorsairOfLeng (corsairOfLeng, CorsairOfLeng (..)) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheDreamEaters.Corsairs qualified as Cards
