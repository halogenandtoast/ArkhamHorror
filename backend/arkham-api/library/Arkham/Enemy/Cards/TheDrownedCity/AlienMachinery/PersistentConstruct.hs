module Arkham.Enemy.Cards.TheDrownedCity.AlienMachinery.PersistentConstruct (persistentConstruct) where

import Arkham.Ability
import Arkham.Card
import Arkham.Enemy.CardDefs.TheDrownedCity.AlienMachinery qualified as Cards
