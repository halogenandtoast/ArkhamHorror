module Arkham.Enemy.Cards.TheDrownedCity.CourtOfTheAncients.CourtKeeperWeaverOfNightmares (courtKeeperWeaverOfNightmares) where

import Arkham.Ability
import Arkham.Campaigns.TheDrownedCity.Import
import Arkham.Enemy.CardDefs.TheDrownedCity.CourtOfTheAncients qualified as Cards
