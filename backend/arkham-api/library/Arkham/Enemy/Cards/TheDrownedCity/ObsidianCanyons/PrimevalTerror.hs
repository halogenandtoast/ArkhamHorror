module Arkham.Enemy.Cards.TheDrownedCity.ObsidianCanyons.PrimevalTerror (primevalTerror) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheDrownedCity.ObsidianCanyons qualified as Cards
