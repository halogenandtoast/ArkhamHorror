module Arkham.Enemy.Cards.TheDrownedCity.Pilgrims.PilgrimAcolyte (pilgrimAcolyte) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheDrownedCity.Pilgrims qualified as Cards
