module Arkham.Enemy.Cards.TheDrownedCity.SepulchreOfTheSleeper.CthulhuDeadAndDreaming (cthulhuDeadAndDreaming) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheDrownedCity.SepulchreOfTheSleeper qualified as Cards
