module Arkham.Enemy.Cards.TheDrownedCity.Stowaways.StowawayDrone (stowawayDrone) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheDrownedCity.Stowaways qualified as Cards
