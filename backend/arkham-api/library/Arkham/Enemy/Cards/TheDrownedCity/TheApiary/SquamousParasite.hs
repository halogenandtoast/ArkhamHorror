module Arkham.Enemy.Cards.TheDrownedCity.TheApiary.SquamousParasite (squamousParasite) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheDrownedCity.TheApiary qualified as Cards
import Arkham.Enemy.Import.Lifted
import Arkham.Helpers.Story (readStoryWithPlacement)
import Arkham.Matcher
import Arkham.Message.Lifted.Placement
import Arkham.Story.CardDefs.TheDrownedCity.TheApiary qualified as Stories
