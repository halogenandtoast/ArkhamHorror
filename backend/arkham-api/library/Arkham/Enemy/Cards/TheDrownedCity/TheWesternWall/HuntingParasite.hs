module Arkham.Enemy.Cards.TheDrownedCity.TheWesternWall.HuntingParasite (huntingParasite) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheDrownedCity.TheWesternWall qualified as Cards
