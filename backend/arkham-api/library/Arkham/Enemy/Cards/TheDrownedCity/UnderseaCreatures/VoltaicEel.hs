module Arkham.Enemy.Cards.TheDrownedCity.UnderseaCreatures.VoltaicEel (voltaicEel) where

import Arkham.Enemy.CardDefs.TheDrownedCity.UnderseaCreatures qualified as Cards
