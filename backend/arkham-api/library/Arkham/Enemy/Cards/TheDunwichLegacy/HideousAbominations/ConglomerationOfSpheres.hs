module Arkham.Enemy.Cards.TheDunwichLegacy.HideousAbominations.ConglomerationOfSpheres (conglomerationOfSpheres) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheDunwichLegacy.HideousAbominations qualified as Cards
