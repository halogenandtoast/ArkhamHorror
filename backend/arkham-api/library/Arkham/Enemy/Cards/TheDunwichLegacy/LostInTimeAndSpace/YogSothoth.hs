module Arkham.Enemy.Cards.TheDunwichLegacy.LostInTimeAndSpace.YogSothoth (yogSothoth, yogSothothEffect) where
...
yogSothoth = enemyWith YogSothoth Cards.yogSothoth (evadeL .~ Nothing)
