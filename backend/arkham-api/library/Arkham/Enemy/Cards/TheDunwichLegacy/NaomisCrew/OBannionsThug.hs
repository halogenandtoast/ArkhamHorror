module Arkham.Enemy.Cards.TheDunwichLegacy.NaomisCrew.OBannionsThug (oBannionsThug) where

import Arkham.Enemy.CardDefs.TheDunwichLegacy.NaomisCrew qualified as Cards
