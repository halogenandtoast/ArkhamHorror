module Arkham.Enemy.Cards.TheDunwichLegacy.TheHouseAlwaysWins.CloverClubPitBoss (cloverClubPitBoss) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheDunwichLegacy.TheHouseAlwaysWins qualified as Cards
