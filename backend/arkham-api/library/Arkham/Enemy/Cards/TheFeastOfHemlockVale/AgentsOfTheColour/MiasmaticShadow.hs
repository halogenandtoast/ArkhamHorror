module Arkham.Enemy.Cards.TheFeastOfHemlockVale.AgentsOfTheColour.MiasmaticShadow (miasmaticShadow) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheFeastOfHemlockVale.AgentsOfTheColour qualified as Cards
