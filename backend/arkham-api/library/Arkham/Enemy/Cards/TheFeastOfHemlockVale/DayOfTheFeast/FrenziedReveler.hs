module Arkham.Enemy.Cards.TheFeastOfHemlockVale.DayOfTheFeast.FrenziedReveler (frenziedReveler) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheFeastOfHemlockVale.DayOfTheFeast qualified as Cards
