module Arkham.Enemy.Cards.TheFeastOfHemlockVale.HorrorsInTheRock.CrystalParasite (crystalParasite) where

import Arkham.Ability
import Arkham.Campaigns.TheFeastOfHemlockVale.Helpers
import Arkham.Enemy.CardDefs.TheFeastOfHemlockVale.HorrorsInTheRock qualified as Cards
