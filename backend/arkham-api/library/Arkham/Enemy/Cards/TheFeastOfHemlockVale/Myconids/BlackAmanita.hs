module Arkham.Enemy.Cards.TheFeastOfHemlockVale.Myconids.BlackAmanita (blackAmanita) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheFeastOfHemlockVale.Myconids qualified as Cards
