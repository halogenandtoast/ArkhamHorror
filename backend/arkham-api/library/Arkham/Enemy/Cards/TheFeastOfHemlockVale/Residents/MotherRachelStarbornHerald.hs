module Arkham.Enemy.Cards.TheFeastOfHemlockVale.Residents.MotherRachelStarbornHerald (motherRachelStarbornHerald) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheFeastOfHemlockVale.Residents qualified as Cards
