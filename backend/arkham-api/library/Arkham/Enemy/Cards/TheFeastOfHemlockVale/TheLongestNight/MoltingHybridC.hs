module Arkham.Enemy.Cards.TheFeastOfHemlockVale.TheLongestNight.MoltingHybridC (moltingHybridC) where
...
import Arkham.Scenarios.TheFeastOfHemlockVale.TheLongestNight.Helpers (pattern IgnoreBarriers)
...
moltingHybridC =
  enemy MoltingHybridC Cards.moltingHybridC
