module Arkham.Enemy.Cards.TheFeastOfHemlockVale.TheThingInTheDepths.ThingInTheDepths (thingInTheDepths) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheFeastOfHemlockVale.TheThingInTheDepths qualified as Cards
