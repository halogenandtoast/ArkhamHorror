module Arkham.Enemy.Cards.TheFeastOfHemlockVale.TheTwistedHollow.UrsineHybridGlowingAbomination (ursineHybridGlowingAbomination) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheFeastOfHemlockVale.TheTwistedHollow qualified as Cards
