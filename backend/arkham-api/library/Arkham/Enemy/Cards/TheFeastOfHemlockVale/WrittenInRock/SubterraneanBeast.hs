module Arkham.Enemy.Cards.TheFeastOfHemlockVale.WrittenInRock.SubterraneanBeast (subterraneanBeast) where

import Arkham.Ability
import Arkham.Asset.Cards qualified as Assets
import Arkham.Enemy.CardDefs.TheFeastOfHemlockVale.WrittenInRock qualified as Cards
