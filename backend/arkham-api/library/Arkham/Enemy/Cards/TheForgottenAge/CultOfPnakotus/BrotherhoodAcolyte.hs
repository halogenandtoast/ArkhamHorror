module Arkham.Enemy.Cards.TheForgottenAge.CultOfPnakotus.BrotherhoodAcolyte (brotherhoodAcolyte) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheForgottenAge.CultOfPnakotus qualified as Cards
