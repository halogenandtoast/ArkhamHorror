module Arkham.Enemy.Cards.TheForgottenAge.GuardiansOfTime.EztliGuardian (eztliGuardian) where

import Arkham.Ability
import Arkham.Attack
import Arkham.Enemy.CardDefs.TheForgottenAge.GuardiansOfTime qualified as Cards
