module Arkham.Enemy.Cards.TheForgottenAge.PnakoticBrotherhood.BrotherhoodCultist (brotherhoodCultist) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheForgottenAge.PnakoticBrotherhood qualified as Cards
