module Arkham.Enemy.Cards.TheForgottenAge.Serpents.BoaConstrictor (boaConstrictor) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheForgottenAge.Serpents qualified as Cards
