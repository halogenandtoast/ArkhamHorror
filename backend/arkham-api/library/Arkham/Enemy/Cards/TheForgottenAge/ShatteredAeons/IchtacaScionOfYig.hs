module Arkham.Enemy.Cards.TheForgottenAge.ShatteredAeons.IchtacaScionOfYig (ichtacaScionOfYig, ichtacaScionOfYigEffect) where
...
import Arkham.Story.CardDefs.TheForgottenAge.ShatteredAeons qualified as Story
