module Arkham.Enemy.Cards.TheForgottenAge.TemporalHunters.TindalosAlpha (tindalosAlpha) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheForgottenAge.TemporalHunters qualified as Cards
