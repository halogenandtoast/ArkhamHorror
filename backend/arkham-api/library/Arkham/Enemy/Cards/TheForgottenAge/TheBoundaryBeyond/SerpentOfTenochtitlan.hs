module Arkham.Enemy.Cards.TheForgottenAge.TheBoundaryBeyond.SerpentOfTenochtitlan (serpentOfTenochtitlan) where

import Arkham.Ability
import Arkham.Campaigns.TheForgottenAge.Helpers
import Arkham.Enemy.CardDefs.TheForgottenAge.TheBoundaryBeyond qualified as Cards
