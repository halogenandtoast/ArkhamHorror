module Arkham.Enemy.Cards.TheForgottenAge.TheDoomOfEztli.HarbingerOfValusia (harbingerOfValusia) where

import Arkham.Ability
import Arkham.Card
import Arkham.Enemy.CardDefs.TheForgottenAge.TheDoomOfEztli qualified as Cards
