module Arkham.Enemy.Cards.TheForgottenAge.TheUntamedWilds.Ichtaca (ichtaca) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheForgottenAge.TheUntamedWilds qualified as Cards
