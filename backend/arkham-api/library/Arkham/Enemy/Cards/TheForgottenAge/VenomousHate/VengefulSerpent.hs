module Arkham.Enemy.Cards.TheForgottenAge.VenomousHate.VengefulSerpent (vengefulSerpent) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.TheForgottenAge.VenomousHate qualified as Cards
