module Arkham.Enemy.Cards.TheInnsmouthConspiracy.ALightInTheFog.DeepOneNursemaid (deepOneNursemaid) where
...
deepOneNursemaid = enemy DeepOneNursemaid Cards.deepOneNursemaid
