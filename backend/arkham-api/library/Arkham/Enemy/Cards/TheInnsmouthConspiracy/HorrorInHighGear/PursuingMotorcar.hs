module Arkham.Enemy.Cards.TheInnsmouthConspiracy.HorrorInHighGear.PursuingMotorcar (pursuingMotorcar, PursuingMotorcar (..)) where

import Arkham.Ability
import Arkham.Attack.Types
import Arkham.Enemy.CardDefs.TheInnsmouthConspiracy.HorrorInHighGear qualified as Cards
