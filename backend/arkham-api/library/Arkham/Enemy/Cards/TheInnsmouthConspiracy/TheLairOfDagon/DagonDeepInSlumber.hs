module Arkham.Enemy.Cards.TheInnsmouthConspiracy.TheLairOfDagon.DagonDeepInSlumber (dagonDeepInSlumber, DagonDeepInSlumber (..)) where

import Arkham.Ability
import Arkham.Card
import Arkham.Enemy.CardDefs.TheInnsmouthConspiracy.TheLairOfDagon qualified as Cards
