module Arkham.Enemy.Cards.TheInnsmouthConspiracy.ThePitOfDespair.TheAmalgam (theAmalgam) where

import Arkham.Ability
import Arkham.Classes.HasQueue (withQueue_)
import Arkham.Enemy.CardDefs.TheInnsmouthConspiracy.ThePitOfDespair qualified as Cards
