module Arkham.Enemy.Cards.TheInnsmouthConspiracy.TheVanishingOfElinaHarper.BarnabasMarshTheChangeIsUponHim (barnabasMarshTheChangeIsUponHim) where
...
instance RunMessage BarnabasMarshTheChangeIsUponHim where
  runMessage msg e@(BarnabasMarshTheChangeIsUponHim attrs) = runQueueT $ case msg of
    Revelation _ (isSource attrs -> True) -> do
      ...
      pure $ updateAttrs e (spawnAtL ?~ "Marsh Refinery")
