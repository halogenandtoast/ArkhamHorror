module Arkham.Enemy.Cards.TheInnsmouthConspiracy.TheVanishingOfElinaHarper.RobertFriendlyDisgruntledDockworker (robertFriendlyDisgruntledDockworker) where
