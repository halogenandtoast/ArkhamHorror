module Arkham.Enemy.Cards.ThePathToCarcosa.CultOfTheYellowSign.AgentOfTheKing (agentOfTheKing) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.ThePathToCarcosa.CultOfTheYellowSign qualified as Cards
