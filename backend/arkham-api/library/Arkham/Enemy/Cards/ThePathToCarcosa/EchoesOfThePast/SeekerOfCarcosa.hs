module Arkham.Enemy.Cards.ThePathToCarcosa.EchoesOfThePast.SeekerOfCarcosa (seekerOfCarcosa) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.ThePathToCarcosa.EchoesOfThePast qualified as Cards
...
seekerOfCarcosa =
  enemy SeekerOfCarcosa Cards.seekerOfCarcosa
