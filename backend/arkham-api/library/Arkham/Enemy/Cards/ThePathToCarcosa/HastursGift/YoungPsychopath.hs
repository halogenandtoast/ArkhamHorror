module Arkham.Enemy.Cards.ThePathToCarcosa.HastursGift.YoungPsychopath (youngPsychopath) where

import Arkham.Ability
import Arkham.Campaigns.ThePathToCarcosa.Helpers
import Arkham.Enemy.CardDefs.ThePathToCarcosa.HastursGift qualified as Cards
