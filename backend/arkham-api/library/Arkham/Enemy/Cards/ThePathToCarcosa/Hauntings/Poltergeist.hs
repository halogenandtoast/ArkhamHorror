module Arkham.Enemy.Cards.ThePathToCarcosa.Hauntings.Poltergeist (poltergeist) where

import Arkham.Ability
import Arkham.Enemy.CardDefs.ThePathToCarcosa.Hauntings qualified as Cards
