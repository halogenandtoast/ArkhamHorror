module Arkham.Enemy.Cards.ThePathToCarcosa.ThePallidMask.CatacombsDocent (catacombsDocent) where

import Arkham.Ability
import Arkham.Classes
import Arkham.Enemy.CardDefs.ThePathToCarcosa.ThePallidMask qualified as Cards
