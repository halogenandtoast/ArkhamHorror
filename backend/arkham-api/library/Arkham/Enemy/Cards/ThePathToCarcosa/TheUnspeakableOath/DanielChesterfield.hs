module Arkham.Enemy.Cards.ThePathToCarcosa.TheUnspeakableOath.DanielChesterfield (danielChesterfield) where

import Arkham.Ability
import Arkham.Asset.Cards qualified as Assets
import Arkham.Enemy.CardDefs.ThePathToCarcosa.TheUnspeakableOath qualified as Cards
