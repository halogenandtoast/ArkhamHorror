module Arkham.Enemy.Cards.TheScarletKeys.AgentsOfTheOutside.ParadigmEfficer (paradigmEfficer) where

import Arkham.Ability
import Arkham.Campaigns.TheScarletKeys.Helpers
import Arkham.Card
import Arkham.Enemy.CardDefs.TheScarletKeys.AgentsOfTheOutside qualified as Cards
