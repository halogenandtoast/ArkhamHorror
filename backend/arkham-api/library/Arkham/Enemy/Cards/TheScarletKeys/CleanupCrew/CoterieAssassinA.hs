module Arkham.Enemy.Cards.TheScarletKeys.CleanupCrew.CoterieAssassinA (coterieAssassinA) where
...
coterieAssassinA = enemy CoterieAssassinA Cards.coterieAssassinA
