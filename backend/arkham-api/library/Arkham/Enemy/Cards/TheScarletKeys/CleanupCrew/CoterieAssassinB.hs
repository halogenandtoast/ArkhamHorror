module Arkham.Enemy.Cards.TheScarletKeys.CleanupCrew.CoterieAssassinB (coterieAssassinB) where
...
coterieAssassinB = enemy CoterieAssassinB Cards.coterieAssassinB
