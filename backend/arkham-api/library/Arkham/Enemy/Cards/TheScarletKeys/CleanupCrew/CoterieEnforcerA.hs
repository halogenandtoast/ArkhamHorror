module Arkham.Enemy.Cards.TheScarletKeys.CleanupCrew.CoterieEnforcerA (coterieEnforcerA) where
...
coterieEnforcerA = enemy CoterieEnforcerA Cards.coterieEnforcerA
