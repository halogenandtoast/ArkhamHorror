module Arkham.Enemy.Cards.TheScarletKeys.CleanupCrew.CoterieEnforcerB (coterieEnforcerB) where
...
coterieEnforcerB = enemy CoterieEnforcerB Cards.coterieEnforcerB
