module Arkham.Enemy.Cards.TheScarletKeys.DeadHeat.AmaranthCorruptionRevealed (amaranthCorruptionRevealed) where
...
amaranthCorruptionRevealed = enemy AmaranthCorruptionRevealed Cards.amaranthCorruptionRevealed
