module Arkham.Enemy.Cards.TheScarletKeys.DealingsInTheDark.SinisterAspirantB (sinisterAspirantB) where
...
sinisterAspirantB = enemy SinisterAspirantB Cards.sinisterAspirantB
