module Arkham.Enemy.Cards.TheScarletKeys.DealingsInTheDark.SinisterAspirantC (sinisterAspirantC) where
...
sinisterAspirantC = enemy SinisterAspirantC Cards.sinisterAspirantC
