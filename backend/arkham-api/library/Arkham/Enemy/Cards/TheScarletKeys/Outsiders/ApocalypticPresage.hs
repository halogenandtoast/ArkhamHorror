module Arkham.Enemy.Cards.TheScarletKeys.Outsiders.ApocalypticPresage (apocalypticPresage) where

import Arkham.Ability
import Arkham.Asset.Cards qualified as Assets
import Arkham.Campaigns.TheScarletKeys.Helpers (hollow)
import Arkham.Card
import Arkham.Enemy.CardDefs.TheScarletKeys.Outsiders qualified as Cards
