module Arkham.Enemy.Cards.TheScarletKeys.ShadesOfSuffering.UncannyShadowPlayfulShadows (uncannyShadowPlayfulShadows) where
...
uncannyShadowPlayfulShadows = enemy UncannyShadowPlayfulShadows Cards.uncannyShadowPlayfulShadows
