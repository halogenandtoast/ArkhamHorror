module Arkham.Enemy.Cards.TheScarletKeys.WithoutATrace.MimeticNemesisOtherworldlySubjugator (mimeticNemesisOtherworldlySubjugator) where

import Arkham.Ability
import Arkham.Asset.Cards qualified as Assets
import Arkham.Campaigns.TheScarletKeys.Helpers
import Arkham.Enemy.CardDefs.TheScarletKeys.WithoutATrace qualified as Cards
