module Arkham.Enemy.Cards.UrsineBruteCircusExMortis (ursineBruteCircusExMortis) where
...
ursineBruteCircusExMortis :: EnemyCard UrsineBrute
ursineBruteCircusExMortis =
  enemy UrsineBrute Cards.ursineBruteCircusExMortis
