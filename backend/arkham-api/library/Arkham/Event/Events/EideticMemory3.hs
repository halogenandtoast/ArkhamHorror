...
eideticMemory3 = eventWith EideticMemory3 Cards.eideticMemory3 $ afterPlayL .~ RemoveThisFromGame

instance RunMessage EideticMemory3 where
  runMessage msg e@(EideticMemory3 attrs) = runQueueT $ case msg of
    InvestigatorPlayEvent iid eid _ windows' _ | eid == toId attrs -> do
      ...
      enabled <- Msg.createCardEffect Cards.eideticMemory3 Nothing (toCardId attrs) (toCardId attrs)
      ...
      push
        $ InitiatePlayCardAsChoose
          ...
          True
      pure e
    _ -> EideticMemory3 <$> liftRunMessage msg attrs
