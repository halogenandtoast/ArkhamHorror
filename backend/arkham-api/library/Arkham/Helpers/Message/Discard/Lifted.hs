...
chooseAndDiscardCardEdit
  :: (ReverseQueue m, Sourceable source)
  => InvestigatorId -> source -> (HandDiscard Message -> HandDiscard Message) -> m ()
chooseAndDiscardCardEdit iid source f = push . toMessage . f $ Msg.chooseAndDiscardCard iid source
