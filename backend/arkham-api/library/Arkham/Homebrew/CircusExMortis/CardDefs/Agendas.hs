...
theTrueFace :: CardDef
theTrueFace =
  agenda ":circus-ex-mortis:002" "The True Face" 1 Set.OneNightOnly

houseOfHorrors :: CardDef
houseOfHorrors =
  agenda ":circus-ex-mortis:003" "House of Horrors" 2 Set.OneNightOnly

mesmericMagic :: CardDef
mesmericMagic =
  agenda ":circus-ex-mortis:004" "Mesmeric Magic" 3 Set.OneNightOnly

-- the_primrose_path
savageNature :: CardDef
savageNature =
  agenda ":circus-ex-mortis:018" "Savage Nature" 1 Set.ThePrimrosePath

bloodMoon :: CardDef
bloodMoon =
  agenda ":circus-ex-mortis:019" "Blood Moon" 2 Set.ThePrimrosePath
