...
-- Back of agenda :dark-matter:016 ("The Ghost Ship"); spawned when that agenda
-- advances (see the scenario/agenda modules).
uplA21Demhe :: CardDef
uplA21Demhe =
  doubleSided ":dark-matter:016"
    $ (enemy ":dark-matter:016b" ("UPL-A21 'Demhe'" <:> "Unmanned Power Loader") Set.TheTatterdemalion 1)
...
manifestedWhispers =
  (enemy ":dark-matter:082" "Manifested Whispers" Set.ElectricNightmare 2)
    { cdHealthDamage = healthDamage 1
    , cdFight = fight 3
    , cdEvade = evade 3
    , cdHealth = health 1
...
virtualByakhee =
  (enemy ":dark-matter:084" "Virtual Byakhee" Set.ElectricNightmare 2)
    { cdHealthDamage = healthDamage 1
    , cdSanityDamage = sanityDamage 1
    , cdFight = fight 3
    , cdEvade = evade 4
...
houndOfTindalos =
  (enemy ":dark-matter:105" "Hound of Tindalos" Set.LostQuantum 3)
    { cdHealthDamage = healthDamage 1
    , cdSanityDamage = sanityDamage 1
    , cdFight = fight 4
    , cdEvade = evade 4
...
miGoStabilizer =
  (enemy ":dark-matter:107" "Mi-Go Stabilizer" Set.LostQuantum 2)
    { cdHealthDamage = healthDamage 1
    , cdFight = fight 3
    , cdEvade = evade 1
    , cdHealth = health 2
...
quantumPhantom =
  (enemy ":dark-matter:110" "Quantum Phantom" Set.LostQuantum 2)
    { cdHealthDamage = healthDamage 1
    , cdSanityDamage = sanityDamage 1
    , cdFight = fight 2
    , cdEvade = evade 3
...
theEntity :: CardDef
theEntity =
  (enemy ":dark-matter:121" "The Entity" Set.InTheShadowOfEarth 1)
    { cdHealthDamage = healthDamage 3
    , cdSanityDamage = sanityDamage 2
    , cdFight = fight 4
    , cdEvade = evade 3
...
corruptedMachine =
  (enemy ":dark-matter:144" "Corrupted Machine" Set.InTheShadowOfEarth 2)
    { cdHealthDamage = healthDamage 1
    , cdSanityDamage = sanityDamage 1
    , cdFight = fight 4
    , cdEvade = evade 2
...
mimic :: CardDef
mimic =
  (enemy ":dark-matter:148" "Mimic" Set.InTheShadowOfEarth 3)
    { cdHealthDamage = healthDamage 2
    , cdFight = fight 3
    , cdEvade = evade 3
    , cdHealth = health 4
...
rats :: CardDef
rats =
  (enemy ":dark-matter:151" "Rats?" Set.InTheShadowOfEarth 3)
    { cdHealthDamage = healthDamage 1
    , cdFight = fight 1
    , cdEvade = evade 3
    , cdHealth = health 1
...
theGreys =
  doubleSided ":dark-matter:163b"
    $ (enemy ":dark-matter:163" "The Greys" Set.StrangeMoons 1)
      { cdSanityDamage = sanityDamage 1
      , cdFight = fight 4
      , cdEvade = evade 4
      , cdHealth = health 1
...
parasite :: CardDef
parasite =
  (enemy ":dark-matter:184" "Parasite" Set.StrangeMoons 3)
    { cdHealthDamage = healthDamage 1
    , cdSanityDamage = sanityDamage 1
    , cdFight = fight 2
    , cdEvade = evade 3
...
stalkingByakhee =
  (enemy ":dark-matter:188" "Stalking Byakhee" Set.InterstellarPredators 3)
    { cdHealthDamage = healthDamage 1
    , cdSanityDamage = sanityDamage 1
    , cdFight = fight 2
    , cdEvade = evade 4
...
viciousByakhee =
  (enemy ":dark-matter:189" "Vicious Byakhee" Set.InterstellarPredators 3)
    { cdHealthDamage = healthDamage 2
    , cdFight = fight 4
    , cdEvade = evade 2
    , cdHealth = health 4
...
daemonOfNis :: CardDef
daemonOfNis =
  (enemy ":dark-matter:198" ("Daemon of Nis" <:> "Devourer of Memories") Set.TheMachineInYellow 1)
    { cdHealthDamage = healthDamage 1
    , cdFight = fight 3
    , cdEvade = evade 2
    , cdHealth = healthPerInvestigator 2
...
spiritOfThan =
  (enemy ":dark-matter:208" ("Spirit of Than" <:> "The One that Got Away") Set.TheMachineInYellow 1)
    { cdHealthDamage = healthDamage 1
    , cdFight = fight 2
    , cdEvade = evade 3
    , cdHealth = healthPerInvestigator 2
...
caveDweller :: CardDef
caveDweller =
  (enemy ":dark-matter:230" ("Cave Dweller" <:> "Suspiciously Familiar") Set.FragmentOfCarcosa 1)
    { cdHealthDamage = healthDamage 3
    , cdFight = fight 4
    , cdEvade = evade 6
...
sophisticSpires =
  (enemy ":dark-matter:239" "Sophistic Spires" Set.FragmentOfCarcosa 2)
    { cdSanityDamage = sanityDamage 2
    , cdFight = fight 2
    , cdEvade = evade 5
    , cdHealth = health 5
...
tatteredCurtains =
  (enemy ":dark-matter:240" "Tattered Curtains" Set.FragmentOfCarcosa 2)
    { cdHealthDamage = healthDamage 1
    , cdSanityDamage = sanityDamage 1
    , cdFight = fight 4
    , cdEvade = evade 2
...
yellowMists :: CardDef
yellowMists =
  (enemy ":dark-matter:242" "Yellow Mists" Set.FragmentOfCarcosa 1)
    { cdHealthDamage = healthDamage 1
    , cdSanityDamage = sanityDamage 1
    , cdFight = fight 4
    , cdEvade = evade 1
...
tassilda :: CardDef
tassilda =
  (enemy ":dark-matter:254" ("Tassilda" <:> "Royal Princess of Carcosa") Set.Starfall 1)
    { cdHealthDamage = healthDamage 3
...
yithianGuard =
  (enemy ":dark-matter:256" "Yithian Guard" Set.Starfall 1)
    { cdHealthDamage = healthDamage 1
    , cdSanityDamage = sanityDamage 2
    , cdFight = fight 3
    , cdEvade = evade 4
...
miGoSentinel =
  (enemy ":dark-matter:257" "Mi-Go Sentinel" Set.Starfall 1)
    { cdHealthDamage = healthDamage 2
    , cdSanityDamage = sanityDamage 1
    , cdFight = fight 4
    , cdEvade = evade 3
...
domaagTeel :: CardDef
domaagTeel =
  (enemy ":dark-matter:258" ("Domaag T’eel" <:> "The Mistake that Ended the World") Set.Starfall 1)
    { cdHealthDamage = healthDamage 2
    , cdSanityDamage = sanityDamage 2
    , cdFight = fight 5
    , cdEvade = evade 5
...
cyberCultist =
  (enemy ":dark-matter:283" "Cyber-Cultist" Set.Starfall 2)
    { cdSanityDamage = sanityDamage 1
    , cdFight = fight 3
    , cdEvade = evade 1
    , cdHealth = health 1
...
spacePirates =
  (enemy ":dark-matter:286" "Space Pirates" Set.Starfall 2)
    { cdHealthDamage = healthDamage 1
    , cdFight = fight 3
    , cdEvade = evade 3
    , cdHealth = health 4
...
voidByakhee :: CardDef
voidByakhee =
  (enemy ":dark-matter:288" "Void Byakhee" Set.Starfall 2)
    { cdHealthDamage = healthDamage 1
    , cdSanityDamage = sanityDamage 1
    , cdFight = fight 3
    , cdEvade = evade 4
