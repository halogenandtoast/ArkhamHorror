...
anachronism :: CardDef
anachronism =
  (treachery ":dark-matter:001" "Anachronism" Set.Anachronism 2)
...
micrometeoroid =
  (treachery ":dark-matter:010" "Micrometeoroid" Set.DeepSpace 2)
    { cdCardTraits = setFromList [Hazard]
    }

theColorsOfSpace :: CardDef
theColorsOfSpace =
  (treachery ":dark-matter:011" "The Colors of Space" Set.DeepSpace 2)
    { cdCardTraits = setFromList [Hazard]
    }
...
futureEvils :: CardDef
futureEvils =
  (treachery ":dark-matter:013" "Future Evils" Set.Endtimes 3)
...
artificialGravityMalfunction =
  (treachery ":dark-matter:044" "Artificial Gravity Malfunction" Set.TheTatterdemalion 2)
    { cdCardTraits = setFromList [Hazard]
    }
...
coolantLeak :: CardDef
coolantLeak =
  (treachery ":dark-matter:046" "Coolant Leak" Set.TheTatterdemalion 2)
    { cdCardTraits = setFromList [Hazard]
    }

decompression :: CardDef
decompression =
  (treachery ":dark-matter:047" "Decompression" Set.TheTatterdemalion 2)
    { cdCardTraits = setFromList [Hazard]
    }

highRadiationLevels :: CardDef
highRadiationLevels =
  (treachery ":dark-matter:048" "High Radiation Levels" Set.TheTatterdemalion 2)
    { cdCardTraits = setFromList [Hazard]
    }
...
allSeeingEye =
  (treachery ":dark-matter:049" "All-Seeing Eye" Set.ArtificialIntelligence 3)
    { cdCardTraits = setFromList [AI]
    }

electricSurge :: CardDef
electricSurge =
  (treachery ":dark-matter:050" "Electric Surge" Set.ArtificialIntelligence 2)
    { cdCardTraits = setFromList [Hazard]
    }
...
predictiveAlgorithm =
  (treachery ":dark-matter:052" "Predictive Algorithm" Set.ArtificialIntelligence 2)
    { cdCardTraits = setFromList [AI, Scheme]
    }
...
digitalCorrosion =
  (treachery ":dark-matter:076" "Digital Corrosion" Set.ElectricNightmare 2)
    { cdCardTraits = setFromList [Virtual, Hazard]
    }

decoherence :: CardDef
decoherence =
  (treachery ":dark-matter:078" "Decoherence" Set.ElectricNightmare 2)
    { cdCardTraits = setFromList [Virtual, Terror]
    }

duplication :: CardDef
duplication =
  (treachery ":dark-matter:079" "Duplication" Set.ElectricNightmare 2)
    { cdCardTraits = setFromList [Scheme]
    }

nonEuclideanGeometry :: CardDef
nonEuclideanGeometry =
  (treachery ":dark-matter:083" "Non-Euclidean Geometry" Set.ElectricNightmare 2)
    { cdCardTraits = setFromList [Hazard]
    }
...
comeCLOSER :: CardDef
comeCLOSER =
  (treachery ":dark-matter:086" "COME CLOSER" Set.TheBoogeyman 2)
...
incomprehensible =
  (treachery ":dark-matter:106" "Incomprehensible" Set.LostQuantum 2)
...
quantumCollapse =
  (treachery ":dark-matter:109" "Quantum Collapse" Set.LostQuantum 3)
    { cdCardTraits = setFromList [Quantum]
    }

radioactiveDecay :: CardDef
radioactiveDecay =
  (treachery ":dark-matter:111" "Radioactive Decay" Set.LostQuantum 2)
    { cdCardTraits = setFromList [Hazard]
    }
...
anothersWoe :: CardDef
anothersWoe =
  (treachery ":dark-matter:142" "Another's Woe" Set.InTheShadowOfEarth 2)
    { cdCardTraits = setFromList [Omen]
    }

contamination :: CardDef
contamination =
  (treachery ":dark-matter:143" "Contamination" Set.InTheShadowOfEarth 2)
    { cdCardTraits = setFromList [Injury, Madness]
    }

fromTheDark :: CardDef
fromTheDark =
  (treachery ":dark-matter:145" "From the Dark" Set.InTheShadowOfEarth 2)
    { cdCardTraits = setFromList [Tactic]
    }

hopeless :: CardDef
hopeless =
  (treachery ":dark-matter:146" "Hopeless" Set.InTheShadowOfEarth 2)
    { cdCardTraits = setFromList [Terror]
    }

infection :: CardDef
infection =
  (treachery ":dark-matter:147" "Infection" Set.InTheShadowOfEarth 2)
    { cdCardTraits = setFromList [Injury, Curse]
    }

paleBlueDot :: CardDef
paleBlueDot =
  (treachery ":dark-matter:149" "Pale Blue Dot" Set.InTheShadowOfEarth 2)
    { cdCardTraits = setFromList [Terror]
    }

perfectImitation :: CardDef
perfectImitation =
  (treachery ":dark-matter:150" "Perfect Imitation" Set.InTheShadowOfEarth 2)
...
alienAid :: CardDef
alienAid =
  (treachery ":dark-matter:179" "Alien Aid" Set.StrangeMoons 2)
    { cdCardTraits = setFromList [MiGo, Pact]
    }

closeEncounters :: CardDef
closeEncounters =
  (treachery ":dark-matter:180" "Close Encounters" Set.StrangeMoons 2)
    { cdCardTraits = setFromList [Hazard]
    }
...
lostInTranslation =
  (treachery ":dark-matter:182" "Lost in Translation" Set.StrangeMoons 2)
    { cdCardTraits = setFromList [Blunder]
    }

miGoExperiments :: CardDef
miGoExperiments =
  (treachery ":dark-matter:183" "Mi-Go Experiments" Set.StrangeMoons 2)
    { cdCardTraits = setFromList [MiGo, Terror]
    }

simulationDiscrepancy :: CardDef
simulationDiscrepancy =
  (treachery ":dark-matter:185" "Simulation Discrepancy" Set.StrangeMoons 2)
    { cdCardTraits = setFromList [Blunder, Obstacle]
    }
...
extraterrestrialAssault =
  (treachery ":dark-matter:187" "Extraterrestrial Assault" Set.InterstellarPredators 2)
    { cdCardTraits = setFromList [Pact]
    }
...
fathomlessRegrets =
  (treachery ":dark-matter:204" "Fathomless Regrets" Set.TheMachineInYellow 2)
    { cdCardTraits = setFromList [Terror]
    }

forbiddingPromises :: CardDef
forbiddingPromises =
  (treachery ":dark-matter:205" "Forbidding Promises" Set.TheMachineInYellow 2)
    { cdCardTraits = setFromList [Terror]
    }
...
brokenReality =
  (treachery ":dark-matter:228" "Broken Reality" Set.FragmentOfCarcosa 3)
    { cdCardTraits = setFromList [Hazard]
    }

caveCollapse :: CardDef
caveCollapse =
  (treachery ":dark-matter:229" "Cave Collapse" Set.FragmentOfCarcosa 2)
    { cdCardTraits = setFromList [Hazard]
    }

chosenByHim :: CardDef
chosenByHim =
  (treachery ":dark-matter:231" "Chosen by Him" Set.FragmentOfCarcosa 2)
...
hastursDomain =
  (treachery ":dark-matter:234" "Hastur's Domain" Set.FragmentOfCarcosa 2)
    { cdCardTraits = setFromList [Terror]
    }

irresistibleTruths :: CardDef
irresistibleTruths =
  (treachery ":dark-matter:235" "Irresistible Truths" Set.FragmentOfCarcosa 2)
    { cdCardTraits = setFromList [Hex]
    }
...
songOfYourSoul =
  (treachery ":dark-matter:238" "Song of Your Soul" Set.FragmentOfCarcosa 2)
    { cdCardTraits = setFromList [Hex]
    }

unstableDimension :: CardDef
unstableDimension =
  (treachery ":dark-matter:241" "Unstable Dimension" Set.FragmentOfCarcosa 2)
    { cdCardTraits = setFromList [Hazard]
    }
...
theDarkForest =
  (treachery ":dark-matter:285" "The Dark Forest" Set.Starfall 2)
    { cdCardTraits = setFromList [Omen, Endtimes]
    }

theStarsWereRight :: CardDef
theStarsWereRight =
  (treachery ":dark-matter:287" "The Stars Were Right" Set.Starfall 2)
    { cdCardTraits = setFromList [Endtimes, Power]
    }
