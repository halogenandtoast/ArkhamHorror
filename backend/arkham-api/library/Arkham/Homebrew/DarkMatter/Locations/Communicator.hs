...
import Arkham.Homebrew.DarkMatter.Helpers (brainsAttachedTo, printedIcons, scan, scanAction_)
...
communicator = location Communicator Cards.communicator 2 (Static 0)
...
instance HasAbilities Communicator where
  getAbilities (Communicator a) = extendRevealed1 a $ restricted a 1 Here scanAction_
