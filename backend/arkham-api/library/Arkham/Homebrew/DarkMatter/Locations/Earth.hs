...
instance RunMessage Earth where
  runMessage msg l@(Earth attrs) = runQueueT $ case msg of
    ...
    Corruption is recorded per investigator by In the Shadow of Earth's agenda
    2b, and for the whole group by its resolution 5; either entry counts. -}
    UseThisAbility _ (isSource attrs -> True) 2 -> do
      ...
      eachInvestigator \iid -> do
        ...
        when (allCorrupted || corrupted) $ assignDamage iid (attrs.ability 2) 2
      pure l
