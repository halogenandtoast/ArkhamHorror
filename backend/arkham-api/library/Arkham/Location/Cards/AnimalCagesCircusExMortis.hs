module Arkham.Location.Cards.AnimalCagesCircusExMortis (animalCagesCircusExMortis) where
...
newtype AnimalCagesCircusExMortis = AnimalCagesCircusExMortis LocationAttrs
  deriving anyclass IsLocation
  deriving newtype (Show, Eq, ToJSON, FromJSON, Entity, HasAbilities)

animalCagesCircusExMortis :: LocationCard AnimalCagesCircusExMortis
animalCagesCircusExMortis =
  location AnimalCagesCircusExMortis Cards.animalCagesCircusExMortis 5 (PerPlayer 2)

instance HasModifiersFor AnimalCagesCircusExMortis where
  getModifiersFor (AnimalCagesCircusExMortis a) = do
...
instance RunMessage AnimalCagesCircusExMortis where
  runMessage msg (AnimalCagesCircusExMortis attrs) = runQueueT $ case msg of
    _ -> AnimalCagesCircusExMortis <$> liftRunMessage msg attrs
