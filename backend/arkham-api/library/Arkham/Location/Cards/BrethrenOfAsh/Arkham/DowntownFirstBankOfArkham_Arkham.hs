...
module Arkham.Location.Cards.BrethrenOfAsh.Arkham.DowntownFirstBankOfArkham_Arkham (downtownFirstBankOfArkham_Arkham) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Location.CardDefs.BrethrenOfAsh.Arkham qualified as Cards (
