module Arkham.Location.Cards.BrethrenOfAsh.Arkham.UptownYeOldeMagickShoppe (uptownYeOldeMagickShoppe) where

import Arkham.Ability
import Arkham.Capability
import Arkham.GameValue
import Arkham.Location.CardDefs.BrethrenOfAsh.Arkham qualified as Cards (uptownYeOldeMagickShoppe)
