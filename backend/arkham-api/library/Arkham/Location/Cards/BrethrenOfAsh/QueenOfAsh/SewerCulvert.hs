module Arkham.Location.Cards.BrethrenOfAsh.QueenOfAsh.SewerCulvert (sewerCulvert) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Helpers.Modifiers
import Arkham.I18n
import Arkham.Location.CardDefs.BrethrenOfAsh.QueenOfAsh qualified as Cards (sewerCulvert)
...
instance HasAbilities SewerCulvert where
  getAbilities (SewerCulvert a) =
    extendRevealed1 a
      $ withI18n
      $ scope "core2"
      $ withI18nTooltip "sewerCulvert.resign"
