module Arkham.Location.Cards.ByTheBook.ArkhamPoliceStationByTheBook (arkhamPoliceStationByTheBook) where
...
import Arkham.Location.CardDefs.ByTheBook qualified as Cards
