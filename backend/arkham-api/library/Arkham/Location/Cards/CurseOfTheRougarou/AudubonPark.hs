module Arkham.Location.Cards.CurseOfTheRougarou.AudubonPark (audubonPark) where

import Arkham.Ability
import Arkham.Classes
import Arkham.GameValue
import Arkham.Location.CardDefs.CurseOfTheRougarou qualified as Cards (audubonPark)
