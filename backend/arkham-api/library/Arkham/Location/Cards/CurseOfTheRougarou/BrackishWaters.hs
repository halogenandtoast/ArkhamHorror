module Arkham.Location.Cards.CurseOfTheRougarou.BrackishWaters (brackishWaters) where

import Arkham.Ability
import Arkham.Asset.Cards qualified as Assets
import Arkham.GameValue
import Arkham.Helpers.Modifiers
import Arkham.Location.CardDefs.CurseOfTheRougarou qualified as Cards
