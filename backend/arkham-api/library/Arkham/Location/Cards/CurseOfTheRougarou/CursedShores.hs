module Arkham.Location.Cards.CurseOfTheRougarou.CursedShores (cursedShores, cursedShoresEffect) where
...
import Arkham.Location.CardDefs.CurseOfTheRougarou qualified as Cards (cursedShores)
