module Arkham.Location.Cards.CurseOfTheRougarou.FaubourgMarigny (faubourgMarigny) where

import Arkham.GameValue
import Arkham.Helpers.Modifiers
import Arkham.Location.CardDefs.CurseOfTheRougarou qualified as Cards (faubourgMarigny)
