module Arkham.Location.Cards.CurseOfTheRougarou.FoulSwamp (foulSwamp) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Helpers.Modifiers hiding (skillTestModifier)
import Arkham.Location.CardDefs.CurseOfTheRougarou qualified as Cards (foulSwamp)
