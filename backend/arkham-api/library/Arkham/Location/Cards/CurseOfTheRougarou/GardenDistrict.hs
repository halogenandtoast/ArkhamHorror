module Arkham.Location.Cards.CurseOfTheRougarou.GardenDistrict (gardenDistrict) where

import Arkham.Ability
import Arkham.Classes
import Arkham.GameValue
import Arkham.Location.CardDefs.CurseOfTheRougarou qualified as Cards (gardenDistrict)
...
instance HasAbilities GardenDistrict where
  getAbilities (GardenDistrict attrs) =
    withBaseAbilities attrs
      $ [ skillTestAbility $ restrictedAbility attrs 1 Here $ ActionAbility mempty Nothing $ ActionCost 1
