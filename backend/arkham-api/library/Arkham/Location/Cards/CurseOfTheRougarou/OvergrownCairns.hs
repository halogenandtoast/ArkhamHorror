module Arkham.Location.Cards.CurseOfTheRougarou.OvergrownCairns (overgrownCairns) where
...
import Arkham.Location.CardDefs.CurseOfTheRougarou qualified as Cards (overgrownCairns)
