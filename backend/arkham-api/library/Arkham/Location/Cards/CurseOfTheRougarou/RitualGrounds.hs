module Arkham.Location.Cards.CurseOfTheRougarou.RitualGrounds where

import Arkham.Ability
import Arkham.Classes
import Arkham.GameValue
import Arkham.Location.CardDefs.CurseOfTheRougarou qualified as Cards (ritualGrounds)
