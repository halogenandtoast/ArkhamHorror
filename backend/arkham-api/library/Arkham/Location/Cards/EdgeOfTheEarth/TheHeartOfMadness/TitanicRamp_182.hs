module Arkham.Location.Cards.EdgeOfTheEarth.TheHeartOfMadness.TitanicRamp_182 (titanicRamp_182) where
...
instance HasModifiersFor TitanicRamp_182 where
  getModifiersFor (TitanicRamp_182 a) =
    modifySelf
      a
      [AdditionalCostToLeave $ SkillTestCost (IndexedSource 1 (LocationSource a.id)) #agility (Fixed 4)]
