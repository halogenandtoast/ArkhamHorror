module Arkham.Location.Cards.EdgeOfTheEarth.TheHeartOfMadness.TitanicRamp_183 (titanicRamp_183) where
...
instance HasModifiersFor TitanicRamp_183 where
  getModifiersFor (TitanicRamp_183 a) =
    modifySelf
      a
      [AdditionalCostToLeave $ SkillTestCost (IndexedSource 1 (LocationSource a.id)) #agility (Fixed 3)]
