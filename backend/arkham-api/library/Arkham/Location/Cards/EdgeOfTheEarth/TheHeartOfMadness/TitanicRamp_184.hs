module Arkham.Location.Cards.EdgeOfTheEarth.TheHeartOfMadness.TitanicRamp_184 (titanicRamp_184) where
...
instance HasModifiersFor TitanicRamp_184 where
  getModifiersFor (TitanicRamp_184 a) =
    modifySelf
      a
      [AdditionalCostToLeave $ SkillTestCost (IndexedSource 1 (LocationSource a.id)) #agility (Fixed 2)]
