module Arkham.Location.Cards.FilmFatale.ThroneOfBloodRedAsBloodBlackAsNight (throneOfBloodRedAsBloodBlackAsNight) where
  ...
  getAbilities (ThroneOfBloodRedAsBloodBlackAsNight a) =
    extendRevealed
      ...
      , fastAbility
          ...
          2
          (clueCost 1)
          (Here <> exists (at_ (be a) <> EnemyCanBeDamagedBySource (a.ability 2)))
      ]
