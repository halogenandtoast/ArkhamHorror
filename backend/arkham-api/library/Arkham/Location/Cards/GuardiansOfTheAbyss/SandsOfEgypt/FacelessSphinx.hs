module Arkham.Location.Cards.GuardiansOfTheAbyss.SandsOfEgypt.FacelessSphinx (facelessSphinx) where
...
facelessSphinx = withXShroud $ symbolLabel $ location FacelessSphinx Cards.facelessSphinx 0 (PerPlayer 1)
