module Arkham.Location.Cards.GuardiansOfTheAbyss.TheEternalSlumber.MuseumOfEgyptianAntiquities (museumOfEgyptianAntiquities) where

import Arkham.Ability
import Arkham.Location.CardDefs.GuardiansOfTheAbyss.TheEternalSlumber qualified as Cards
