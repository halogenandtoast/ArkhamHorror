module Arkham.Location.Cards.MachinationsThroughTime.RiverDocksFuture (riverDocksFuture) where
...
riverDocksFuture = locationWith RiverDocksFuture Cards.riverDocksFuture 1 (PerPlayer 1) (shroudL ?~ PerPlayer 1)
