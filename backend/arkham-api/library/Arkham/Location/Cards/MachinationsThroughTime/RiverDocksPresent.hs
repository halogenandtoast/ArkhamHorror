module Arkham.Location.Cards.MachinationsThroughTime.RiverDocksPresent (riverDocksPresent) where

import Arkham.Ability
import Arkham.I18n
import Arkham.Location.CardDefs.MachinationsThroughTime qualified as Cards
...
riverDocksPresent = locationWith RiverDocksPresent Cards.riverDocksPresent 1 (PerPlayer 1) (shroudL ?~ PerPlayer 1)
