module Arkham.Location.Cards.NightOfTheZealot.TheDevourerBelow.RitualSite (ritualSite) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Helpers.GameValue (perPlayer)
import Arkham.Location.CardDefs.NightOfTheZealot.TheDevourerBelow qualified as Cards (ritualSite)
