module Arkham.Location.Cards.NightOfTheZealot.TheGathering.Cellar (cellar) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Location.CardDefs.NightOfTheZealot.TheGathering qualified as Cards (cellar)
