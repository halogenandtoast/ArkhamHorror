module Arkham.Location.Cards.NightOfTheZealot.TheMidnightMasks.Easttown (easttown) where

import Arkham.GameValue
import Arkham.Helpers.Modifiers
import Arkham.Location.CardDefs.NightOfTheZealot.TheMidnightMasks qualified as Cards (easttown)
