module Arkham.Location.Cards.NightOfTheZealot.TheMidnightMasks.Graveyard (graveyard) where
...
import Arkham.I18n
import Arkham.Location.CardDefs.NightOfTheZealot.TheMidnightMasks qualified as Cards (graveyard)
