module Arkham.Location.Cards.NightOfTheZealot.TheMidnightMasks.Northside (northside) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Location.CardDefs.NightOfTheZealot.TheMidnightMasks qualified as Cards (northside)
