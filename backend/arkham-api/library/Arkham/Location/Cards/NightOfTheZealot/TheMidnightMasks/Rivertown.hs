module Arkham.Location.Cards.NightOfTheZealot.TheMidnightMasks.Rivertown (rivertown) where

import Arkham.Location.CardDefs.NightOfTheZealot.TheMidnightMasks qualified as Cards (rivertown)
