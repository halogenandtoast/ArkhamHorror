module Arkham.Location.Cards.RelicsOfThePast.SecretPassageRelicsOfThePast (secretPassageRelicsOfThePast) where

import Arkham.Ability
import Arkham.Campaigns.TheForgottenAge.Supply
import Arkham.Direction
import Arkham.GameValue
import Arkham.Location.CardDefs.RelicsOfThePast qualified as Cards
