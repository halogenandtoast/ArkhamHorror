module Arkham.Location.Cards.ReturnToNightOfTheZealot.ReturnToTheDevourerBelow.ArkhamWoodsCorpseRiddenClearing (arkhamWoodsCorpseRiddenClearing) where

import Arkham.GameValue
import Arkham.Helpers.Modifiers
import Arkham.Location.CardDefs.ReturnToNightOfTheZealot.ReturnToTheDevourerBelow qualified as Cards (
