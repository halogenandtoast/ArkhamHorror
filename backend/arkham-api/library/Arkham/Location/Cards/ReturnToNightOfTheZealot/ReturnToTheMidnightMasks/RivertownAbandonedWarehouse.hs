module Arkham.Location.Cards.ReturnToNightOfTheZealot.ReturnToTheMidnightMasks.RivertownAbandonedWarehouse (rivertownAbandonedWarehouse) where

import Arkham.Ability
import Arkham.Card
import Arkham.GameValue
import Arkham.Location.CardDefs.ReturnToNightOfTheZealot.ReturnToTheMidnightMasks qualified as Cards (
