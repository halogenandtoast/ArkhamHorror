module Arkham.Location.Cards.ReturnToTheCircleUndone.ReturnToAtDeathsDoorstep.WineCellarSpectral (wineCellarSpectral) where

import Arkham.Ability
import Arkham.Helpers.Modifiers (ModifierType (..), modifySelect)
import Arkham.Helpers.SkillTest (withSkillTest)
import Arkham.I18n
import Arkham.Location.CardDefs.ReturnToTheCircleUndone.ReturnToAtDeathsDoorstep qualified as Cards
