module Arkham.Location.Cards.ReturnToTheCircleUndone.ReturnToBeforeTheBlackThrone.InterstellarAbyss (interstellarAbyss) where

import Arkham.Ability
import Arkham.Helpers.Modifiers
import Arkham.Location.CardDefs.ReturnToTheCircleUndone.ReturnToBeforeTheBlackThrone qualified as Cards
