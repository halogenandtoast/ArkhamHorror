module Arkham.Location.Cards.ReturnToTheCircleUndone.ReturnToForTheGreaterGood.ShroudedArchive (shroudedArchive) where

import Arkham.Ability
import Arkham.Helpers.SkillTest.Target
import Arkham.Location.CardDefs.ReturnToTheCircleUndone.ReturnToForTheGreaterGood qualified as Cards
