module Arkham.Location.Cards.ReturnToTheCircleUndone.ReturnToTheSecretName.TempleOfRlyeh (templeOfRlyeh) where

import Arkham.Ability
import Arkham.Draw.Types
import Arkham.Keyword
import Arkham.Location.CardDefs.ReturnToTheCircleUndone.ReturnToTheSecretName qualified as Cards
