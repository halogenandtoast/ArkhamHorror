module Arkham.Location.Cards.ReturnToTheDunwichLegacy.ReturnToBloodOnTheAltar.ReturnToCongregationalChurch (returnToCongregationalChurch) where

import Arkham.Ability
import Arkham.Location.CardDefs.ReturnToTheDunwichLegacy.ReturnToBloodOnTheAltar qualified as Cards
import Arkham.Location.Import.Lifted
import Arkham.Matcher
import Arkham.Treachery.CardDefs.TheDunwichLegacy.BloodOnTheAltar qualified as Treacheries
