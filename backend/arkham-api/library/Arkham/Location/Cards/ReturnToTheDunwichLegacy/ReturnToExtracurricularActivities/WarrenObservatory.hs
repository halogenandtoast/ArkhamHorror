module Arkham.Location.Cards.ReturnToTheDunwichLegacy.ReturnToExtracurricularActivities.WarrenObservatory (warrenObservatory) where

import Arkham.Ability
import Arkham.Helpers.Window (discoveredClues)
import Arkham.Location.CardDefs.ReturnToTheDunwichLegacy.ReturnToExtracurricularActivities qualified as Cards
