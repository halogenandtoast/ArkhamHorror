module Arkham.Location.Cards.ReturnToTheDunwichLegacy.ReturnToTheEssexCountyExpress.ReturnToEngineCar (returnToEngineCar) where

import Arkham.Ability
import Arkham.Asset.Cards qualified as Assets
import Arkham.Direction
import Arkham.Helpers.Modifiers
import Arkham.Location.CardDefs.ReturnToTheDunwichLegacy.ReturnToTheEssexCountyExpress qualified as Cards
