module Arkham.Location.Cards.ReturnToTheDunwichLegacy.ReturnToTheHouseAlwaysWins.ReturnToCloverClubLounge (returnToCloverClubLounge) where

import Arkham.Ability
import Arkham.Capability
import Arkham.Card
import Arkham.I18n
import Arkham.Location.CardDefs.ReturnToTheDunwichLegacy.ReturnToTheHouseAlwaysWins qualified as Cards
  ...
  getAbilities (ReturnToCloverClubLounge a) =
    extendRevealed
      ...
      , playerLimit PerRound
          $ restricted a 2 (Here <> OnAct 1 <> youExist can.manipulate.deck) actionAbility
      ]
