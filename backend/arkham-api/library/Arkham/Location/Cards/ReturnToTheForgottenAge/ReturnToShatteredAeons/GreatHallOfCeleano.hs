module Arkham.Location.Cards.ReturnToTheForgottenAge.ReturnToShatteredAeons.GreatHallOfCeleano (greatHallOfCeleano) where

import Arkham.Ability
import Arkham.Helpers.Query
import Arkham.I18n
import Arkham.Location.CardDefs.ReturnToTheForgottenAge.ReturnToShatteredAeons qualified as Cards
