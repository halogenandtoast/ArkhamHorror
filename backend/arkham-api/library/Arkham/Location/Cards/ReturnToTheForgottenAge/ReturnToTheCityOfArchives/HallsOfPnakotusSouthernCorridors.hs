module Arkham.Location.Cards.ReturnToTheForgottenAge.ReturnToTheCityOfArchives.HallsOfPnakotusSouthernCorridors (hallsOfPnakotusSouthernCorridors) where

import Arkham.Ability
import Arkham.Helpers.Modifiers (ModifierType (..), modifySelect)
import Arkham.Location.CardDefs.ReturnToTheForgottenAge.ReturnToTheCityOfArchives qualified as Cards
import Arkham.Location.CardDefs.TheForgottenAge.TheCityOfArchives qualified as Cards
