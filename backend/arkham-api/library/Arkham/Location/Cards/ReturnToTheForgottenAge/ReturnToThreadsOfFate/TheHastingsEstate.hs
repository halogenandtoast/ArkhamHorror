module Arkham.Location.Cards.ReturnToTheForgottenAge.ReturnToThreadsOfFate.TheHastingsEstate (theHastingsEstate) where

import Arkham.Ability
import Arkham.Campaigns.TheForgottenAge.Supply
import Arkham.Location.CardDefs.ReturnToTheForgottenAge.ReturnToThreadsOfFate qualified as Cards
