module Arkham.Location.Cards.ReturnToThePathToCarcosa.ReturnToAPhantomOfTruth.ReturnToPereLachaiseCemetery (returnToPereLachaiseCemetery) where

import Arkham.Ability
import Arkham.Helpers.Window
import Arkham.Location.CardDefs.ReturnToThePathToCarcosa.ReturnToAPhantomOfTruth qualified as Cards
