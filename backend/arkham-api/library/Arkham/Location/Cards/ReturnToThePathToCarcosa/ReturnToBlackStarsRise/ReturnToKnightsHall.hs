module Arkham.Location.Cards.ReturnToThePathToCarcosa.ReturnToBlackStarsRise.ReturnToKnightsHall (returnToKnightsHall) where

import Arkham.Ability
import Arkham.Helpers.SkillTest.Lifted
import Arkham.Location.CardDefs.ReturnToThePathToCarcosa.ReturnToBlackStarsRise qualified as Cards
