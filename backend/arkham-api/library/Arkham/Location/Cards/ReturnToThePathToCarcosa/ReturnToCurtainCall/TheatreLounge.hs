module Arkham.Location.Cards.ReturnToThePathToCarcosa.ReturnToCurtainCall.TheatreLounge (theatreLounge) where

import Arkham.Ability
import Arkham.Card
import Arkham.Keyword qualified as Keyword
import Arkham.Location.CardDefs.ReturnToThePathToCarcosa.ReturnToCurtainCall qualified as Cards
