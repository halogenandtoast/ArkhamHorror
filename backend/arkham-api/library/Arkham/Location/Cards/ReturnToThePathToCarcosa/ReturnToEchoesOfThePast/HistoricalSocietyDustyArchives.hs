module Arkham.Location.Cards.ReturnToThePathToCarcosa.ReturnToEchoesOfThePast.HistoricalSocietyDustyArchives (historicalSocietyDustyArchives) where

import Arkham.Ability
import Arkham.Helpers.Modifiers (ModifierType (..), modifySelect)
import Arkham.Location.CardDefs.ReturnToThePathToCarcosa.ReturnToEchoesOfThePast qualified as Cards
