module Arkham.Location.Cards.ReturnToThePathToCarcosa.ReturnToThePallidMask.MoundOfBones (moundOfBones) where

import Arkham.Ability
import Arkham.Direction
import Arkham.Draw.Types
import Arkham.Enemy.CardDefs.ReturnToThePathToCarcosa.ReturnToThePallidMask qualified as Enemies
import Arkham.Location.CardDefs.ReturnToThePathToCarcosa.ReturnToThePallidMask qualified as Cards
