module Arkham.Location.Cards.TheCircleUndone.UnionAndDisillusion.ForbiddingShore (forbiddingShore) where
    ...
    UseThisAbility iid (isSource attrs -> True) 1 -> do
      ...
      chooseOneM iid do
        for_ [#willpower, #intellect] \sType -> do
          skillLabeled sType $ circleTest sid iid (attrs.ability 1) attrs [sType] (Fixed 3)
      pure l
