module Arkham.Location.Cards.TheCircleUndone.UnionAndDisillusion.UnvisitedIsleMistyClearing (unvisitedIsleMistyClearing) where
...
instance HasAbilities UnvisitedIsleMistyClearing where
  getAbilities (UnvisitedIsleMistyClearing attrs) =
    extendRevealed
      attrs
      [ skillTestAbility $ restricted attrs 1 Here $ ActionAbility #circle Nothing $ ActionCost 1
