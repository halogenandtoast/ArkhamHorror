module Arkham.Location.Cards.TheDreamEaters.AThousandShapesOfHorror.MysteriousStairs_186 (mysteriousStairs_186) where
...
instance HasModifiersFor MysteriousStairs_186 where
  getModifiersFor (MysteriousStairs_186 attrs) = do
    ...
    modifySelectWhen
      ...
      [CannotMove, CannotPerformAction #resign]
