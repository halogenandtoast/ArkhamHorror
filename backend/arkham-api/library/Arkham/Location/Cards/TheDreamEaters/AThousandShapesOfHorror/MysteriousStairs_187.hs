module Arkham.Location.Cards.TheDreamEaters.AThousandShapesOfHorror.MysteriousStairs_187 (mysteriousStairs_187) where
...
instance HasModifiersFor MysteriousStairs_187 where
  getModifiersFor (MysteriousStairs_187 a) = modifySelectMaybe a (investigatorAt a) \_ -> do
    ...
    pure [CannotMove, CannotPerformAction #resign]
