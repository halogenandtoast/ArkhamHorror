module Arkham.Location.Cards.TheDreamEaters.BeyondTheGatesOfSleep.TheEnchantedPath (theEnchantedPath, TheEnchantedPath (..)) where
...
instance HasAbilities TheEnchantedPath where
  getAbilities (TheEnchantedPath a) =
    extendRevealed1 a $ restricted a 1 Here $ ActionAbility mempty Nothing (ActionCost 3)
