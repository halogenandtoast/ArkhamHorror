module Arkham.Location.Cards.TheDreamEaters.DarkSideOfTheMoon.MoonBeastGalley (moonBeastGalley, MoonBeastGalley (..)) where
...
import Arkham.Story.CardDefs.TheDreamEaters.DarkSideOfTheMoon qualified as Story
