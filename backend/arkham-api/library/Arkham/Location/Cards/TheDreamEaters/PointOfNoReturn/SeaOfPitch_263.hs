module Arkham.Location.Cards.TheDreamEaters.PointOfNoReturn.SeaOfPitch_263 (seaOfPitch_263) where
...
seaOfPitch_263 = withXShroud $ location SeaOfPitch_263 Cards.seaOfPitch_263 0 (PerPlayer 1)
