module Arkham.Location.Cards.TheDreamEaters.PointOfNoReturn.SeaOfPitch_265 (seaOfPitch_265) where
...
seaOfPitch_265 = withXShroud $ location SeaOfPitch_265 Cards.seaOfPitch_265 0 (PerPlayer 1)
