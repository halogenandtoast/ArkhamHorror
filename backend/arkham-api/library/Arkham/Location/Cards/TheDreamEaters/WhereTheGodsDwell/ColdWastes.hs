module Arkham.Location.Cards.TheDreamEaters.WhereTheGodsDwell.ColdWastes (coldWastes, ColdWastes (..)) where
  ...
  runMessage msg l@(ColdWastes attrs) = runQueueT $ case msg of
    UseThisAbility iid (isSource attrs -> True) 1 -> do
      ...
      chooseOrRunOne iid
        ...
        <> [ Label "$label.loseActions count=i:1" [LoseActions iid (attrs.ability 1) 1]
