module Arkham.Location.Cards.TheDrownedCity.CourtOfTheAncients.EastAntechamber (eastAntechamber) where
...
eastAntechamber = location EastAntechamber Cards.eastAntechamber 3 (PerPlayer 1)
