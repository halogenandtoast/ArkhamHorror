module Arkham.Location.Cards.TheDrownedCity.SepulchreOfTheSleeper.SigilCarvedAlcoveStoryOfResilience (sigilCarvedAlcoveStoryOfResilience) where
...
sigilCarvedAlcoveStoryOfResilience =
  location SigilCarvedAlcoveStoryOfResilience Cards.sigilCarvedAlcoveStoryOfResilience 4 (PerPlayer 1)
