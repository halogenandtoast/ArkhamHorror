module Arkham.Location.Cards.TheDrownedCity.TheGrandVault.ChamberOfRecordsEarth (chamberOfRecordsEarth) where
...
chamberOfRecordsEarth = location ChamberOfRecordsEarth Cards.chamberOfRecordsEarth 4 (PerPlayer 1)
