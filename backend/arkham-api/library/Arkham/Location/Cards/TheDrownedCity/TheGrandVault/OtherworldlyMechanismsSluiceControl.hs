module Arkham.Location.Cards.TheDrownedCity.TheGrandVault.OtherworldlyMechanismsSluiceControl (otherworldlyMechanismsSluiceControl) where
...
otherworldlyMechanismsSluiceControl =
  location
    OtherworldlyMechanismsSluiceControl
    Cards.otherworldlyMechanismsSluiceControl
    1
    (PerPlayer 3)
