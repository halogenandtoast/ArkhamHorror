module Arkham.Location.Cards.TheDunwichLegacy.TheEssexCountyExpress.EngineCar_176 (engineCar_176) where

import Arkham.Ability
import Arkham.Direction
import Arkham.Enemy.CardDefs.TheDunwichLegacy.TheEssexCountyExpress qualified as Enemies
import Arkham.GameValue
import Arkham.Location.CardDefs.TheDunwichLegacy.TheEssexCountyExpress qualified as Cards (
  engineCar_176,
 )
