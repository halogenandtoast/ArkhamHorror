module Arkham.Location.Cards.TheDunwichLegacy.TheEssexCountyExpress.PassengerCar_170 (passengerCar_170) where
    ...
    UseThisAbility iid (isSource attrs -> True) 1 -> do
      ...
      if hasSkills
        then chooseOneM iid $ withI18n do
          ...
          countVar 2 $ skillIconVar #intellect $ labeled "discardCardsWithMatchingIcons" do
