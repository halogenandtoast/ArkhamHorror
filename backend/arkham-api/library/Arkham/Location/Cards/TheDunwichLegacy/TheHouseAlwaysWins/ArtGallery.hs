module Arkham.Location.Cards.TheDunwichLegacy.TheHouseAlwaysWins.ArtGallery (artGallery) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Location.CardDefs.TheDunwichLegacy.TheHouseAlwaysWins qualified as Cards (artGallery)
