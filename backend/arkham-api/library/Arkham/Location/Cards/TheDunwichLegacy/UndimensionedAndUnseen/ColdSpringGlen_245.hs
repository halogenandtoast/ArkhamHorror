module Arkham.Location.Cards.TheDunwichLegacy.UndimensionedAndUnseen.ColdSpringGlen_245 (coldSpringGlen_245) where

import Arkham.Ability
import Arkham.Classes.HasQueue (replaceMessageMatching)
import Arkham.GameValue
import Arkham.Helpers.Modifiers
import Arkham.Location.CardDefs.TheDunwichLegacy.UndimensionedAndUnseen qualified as Cards (
  coldSpringGlen_245,
 )
