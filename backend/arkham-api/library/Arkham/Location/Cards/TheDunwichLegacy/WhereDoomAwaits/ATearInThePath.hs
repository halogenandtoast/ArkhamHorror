module Arkham.Location.Cards.TheDunwichLegacy.WhereDoomAwaits.ATearInThePath (aTearInThePath) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Location.CardDefs.TheDunwichLegacy.WhereDoomAwaits qualified as Cards (aTearInThePath)
