module Arkham.Location.Cards.TheDunwichLegacy.WhereDoomAwaits.DimensionalGap (dimensionalGap) where

import Arkham.Ability
import Arkham.Deck qualified as Deck
import Arkham.GameValue
import Arkham.Location.CardDefs.TheDunwichLegacy.WhereDoomAwaits qualified as Cards (dimensionalGap)
