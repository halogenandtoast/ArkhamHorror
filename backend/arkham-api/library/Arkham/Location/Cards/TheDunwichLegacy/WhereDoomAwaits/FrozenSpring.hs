module Arkham.Location.Cards.TheDunwichLegacy.WhereDoomAwaits.FrozenSpring (frozenSpring) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Location.CardDefs.TheDunwichLegacy.WhereDoomAwaits qualified as Cards (frozenSpring)
