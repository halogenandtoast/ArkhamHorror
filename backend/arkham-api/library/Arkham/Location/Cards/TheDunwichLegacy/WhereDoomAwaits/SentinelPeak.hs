module Arkham.Location.Cards.TheDunwichLegacy.WhereDoomAwaits.SentinelPeak (sentinelPeak) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Location.CardDefs.TheDunwichLegacy.WhereDoomAwaits qualified as Cards (sentinelPeak)
