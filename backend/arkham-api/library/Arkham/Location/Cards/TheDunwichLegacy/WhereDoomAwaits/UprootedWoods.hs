module Arkham.Location.Cards.TheDunwichLegacy.WhereDoomAwaits.UprootedWoods (uprootedWoods) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Location.CardDefs.TheDunwichLegacy.WhereDoomAwaits qualified as Cards (uprootedWoods)
