module Arkham.Location.Cards.TheFeastOfHemlockVale.DayOfTheFeast.TheCrossroadsMorning (theCrossroadsMorning) where

import Arkham.Ability
import Arkham.Campaigns.TheFeastOfHemlockVale.Helpers
import Arkham.Helpers.Location (getAccessibleLocations)
import Arkham.Location.CardDefs.TheFeastOfHemlockVale.DayOfTheFeast qualified as Cards
