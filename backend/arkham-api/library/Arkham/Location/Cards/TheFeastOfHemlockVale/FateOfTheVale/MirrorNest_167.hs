module Arkham.Location.Cards.TheFeastOfHemlockVale.FateOfTheVale.MirrorNest_167 (mirrorNest_167) where
...
instance HasAbilities MirrorNest_167 where
  getAbilities (MirrorNest_167 a) =
    extendRevealed1 a
      $ restricted a 1 Here
      $ forced
      $ TurnEnds #when (You <> not_ SuccessfullyEvadedThisRound)
