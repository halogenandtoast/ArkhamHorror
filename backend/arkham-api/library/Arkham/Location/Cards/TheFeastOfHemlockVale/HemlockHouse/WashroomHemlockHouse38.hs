module Arkham.Location.Cards.TheFeastOfHemlockVale.HemlockHouse.WashroomHemlockHouse38 (washroomHemlockHouse38) where
...
washroomHemlockHouse38 =
  locationWith WashroomHemlockHouse38 Cards.washroomHemlockHouse38 4 (PerPlayer 1)
    $ connectsToAdjacent
    . (canBeFlippedL .~ True)
