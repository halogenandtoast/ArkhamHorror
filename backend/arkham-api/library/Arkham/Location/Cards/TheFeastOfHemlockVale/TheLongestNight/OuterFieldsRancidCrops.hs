module Arkham.Location.Cards.TheFeastOfHemlockVale.TheLongestNight.OuterFieldsRancidCrops (outerFieldsRancidCrops) where
...
outerFieldsRancidCrops =
  symbolLabel
    $ locationWith OuterFieldsRancidCrops Cards.outerFieldsRancidCrops 3 (PerPlayer 2) connectsToAdjacent
