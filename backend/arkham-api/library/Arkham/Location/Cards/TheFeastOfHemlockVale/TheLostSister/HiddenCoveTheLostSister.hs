module Arkham.Location.Cards.TheFeastOfHemlockVale.TheLostSister.HiddenCoveTheLostSister (hiddenCoveTheLostSister) where

import Arkham.Ability
import Arkham.Location.CardDefs.TheFeastOfHemlockVale.TheLostSister qualified as Cards
