module Arkham.Location.Cards.TheFeastOfHemlockVale.TheThingInTheDepths.OpenWater10593b (openWater10593b) where
...
instance RunMessage OpenWater10593b where
  runMessage msg l@(OpenWater10593b attrs) = runQueueT $ case msg of
    ...
    FlipThis (isTarget attrs -> True) -> do
      swapLocation attrs =<< genCard Locations.muddyFen
      pure l
