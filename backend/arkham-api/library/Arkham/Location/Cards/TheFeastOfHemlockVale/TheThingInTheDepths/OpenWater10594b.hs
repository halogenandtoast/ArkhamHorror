module Arkham.Location.Cards.TheFeastOfHemlockVale.TheThingInTheDepths.OpenWater10594b (openWater10594b) where
...
instance RunMessage OpenWater10594b where
  runMessage msg l@(OpenWater10594b attrs) = runQueueT $ case msg of
    ...
    FlipThis (isTarget attrs -> True) -> do
      swapLocation attrs =<< genCard Locations.tangledThicket
      pure l
