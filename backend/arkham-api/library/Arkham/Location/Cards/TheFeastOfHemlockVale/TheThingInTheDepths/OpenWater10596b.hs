module Arkham.Location.Cards.TheFeastOfHemlockVale.TheThingInTheDepths.OpenWater10596b (openWater10596b) where
...
instance RunMessage OpenWater10596b where
  runMessage msg l@(OpenWater10596b attrs) = runQueueT $ case msg of
    ...
    FlipThis (isTarget attrs -> True) -> do
      swapLocation attrs =<< genCard Locations.floodedPath
      pure l
