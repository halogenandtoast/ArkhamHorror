module Arkham.Location.Cards.TheFeastOfHemlockVale.TheThingInTheDepths.OpenWater10599b (openWater10599b) where
...
instance RunMessage OpenWater10599b where
  runMessage msg l@(OpenWater10599b attrs) = runQueueT $ case msg of
    ...
    FlipThis (isTarget attrs -> True) -> do
      swapLocation attrs =<< genCard Locations.coveredBridge
      pure l
