module Arkham.Location.Cards.TheFeastOfHemlockVale.TheTwistedHollow.CrookedPath (crookedPath) where
...
crookedPath = withXShroud $ locationWith CrookedPath Cards.crookedPath 0 (Static 1) connectsToAdjacent
