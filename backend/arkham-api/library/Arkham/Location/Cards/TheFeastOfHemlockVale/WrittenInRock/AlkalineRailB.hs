module Arkham.Location.Cards.TheFeastOfHemlockVale.WrittenInRock.AlkalineRailB (alkalineRailB) where
...
instance RunMessage AlkalineRailB where
  runMessage msg l@(AlkalineRailB attrs) = runQueueT $ case msg of
    UseThisAbility _ (isSource attrs -> True) 1 -> do
      selectEach (investigatorAt attrs) (assignHorrorTo (attrs.ability 1) 1)
      selectEach (assetAt attrs <> withTrait Resident) \a -> dealAssetDirectHorror a (attrs.ability 1) 1
      pure l
