module Arkham.Location.Cards.TheFeastOfHemlockVale.WrittenInRock.RailBridge (railBridge) where
...
railBridge = withXShroud $ location RailBridge Cards.railBridge 0 (PerPlayer 2)
