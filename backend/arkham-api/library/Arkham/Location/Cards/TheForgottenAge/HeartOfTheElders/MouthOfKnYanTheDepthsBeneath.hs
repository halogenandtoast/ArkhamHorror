module Arkham.Location.Cards.TheForgottenAge.HeartOfTheElders.MouthOfKnYanTheDepthsBeneath (mouthOfKnYanTheDepthsBeneath) where
...
import Arkham.Location.CardDefs.TheForgottenAge.HeartOfTheElders qualified as Cards
