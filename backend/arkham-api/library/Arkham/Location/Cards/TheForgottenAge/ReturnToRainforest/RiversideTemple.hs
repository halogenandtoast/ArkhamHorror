module Arkham.Location.Cards.TheForgottenAge.ReturnToRainforest.RiversideTemple (riversideTemple) where
...
import Arkham.Location.CardDefs.TheForgottenAge.ReturnToRainforest qualified as Cards
