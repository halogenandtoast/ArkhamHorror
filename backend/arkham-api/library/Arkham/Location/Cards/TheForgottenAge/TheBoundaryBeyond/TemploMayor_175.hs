module Arkham.Location.Cards.TheForgottenAge.TheBoundaryBeyond.TemploMayor_175 (temploMayor_175) where
...
instance HasAbilities TemploMayor_175 where
  getAbilities (TemploMayor_175 attrs) =
    extendRevealed
      ...
      , groupLimit PerPhase
          $ restricted attrs 2 (Here <> canDiscoverCluesAt (LocationWithId attrs.id))
