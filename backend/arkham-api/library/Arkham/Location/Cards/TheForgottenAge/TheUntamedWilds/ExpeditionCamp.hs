module Arkham.Location.Cards.TheForgottenAge.TheUntamedWilds.ExpeditionCamp (expeditionCamp) where

import Arkham.Ability
import Arkham.Campaigns.TheForgottenAge.Helpers
import Arkham.Campaigns.TheForgottenAge.Supply
import Arkham.GameValue
import Arkham.Location.CardDefs.TheForgottenAge.TheUntamedWilds qualified as Cards
