module Arkham.Location.Cards.TheInnsmouthConspiracy.ALightInTheFog.SunkenGrottoLowerDepths (
...
sunkenGrottoLowerDepths = location SunkenGrottoLowerDepths Cards.sunkenGrottoLowerDepths 3 (Static 0)
