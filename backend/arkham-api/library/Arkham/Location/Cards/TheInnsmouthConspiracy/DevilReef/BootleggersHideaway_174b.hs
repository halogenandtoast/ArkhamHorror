module Arkham.Location.Cards.TheInnsmouthConspiracy.DevilReef.BootleggersHideaway_174b (bootleggersHideaway_174b) where
...
instance HasAbilities BootleggersHideaway_174b where
  getAbilities (BootleggersHideaway_174b a) =
    extendRevealed
      ...
      , groupLimit PerGame
          $ restricted a 2 (Here <> youExist (InvestigatorWithKey BlackKey <> can.gain.resources)) actionAbility
      ]
