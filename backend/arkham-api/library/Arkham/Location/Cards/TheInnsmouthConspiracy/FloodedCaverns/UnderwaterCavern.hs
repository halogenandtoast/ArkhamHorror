module Arkham.Location.Cards.TheInnsmouthConspiracy.FloodedCaverns.UnderwaterCavern (underwaterCavern, UnderwaterCavern (..)) where

import Arkham.Ability
import Arkham.Location.CardDefs.TheInnsmouthConspiracy.FloodedCaverns qualified as Cards
