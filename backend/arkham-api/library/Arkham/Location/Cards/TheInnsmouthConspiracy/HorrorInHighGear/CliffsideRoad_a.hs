...
module Arkham.Location.Cards.TheInnsmouthConspiracy.HorrorInHighGear.CliffsideRoad_a (cliffsideRoad_a, CliffsideRoad_a (..)) where
      ...
      when (n > 0) do
        ...
        chooseOneM driver do
          for_ [#willpower, #agility] \sType -> do
            (withI18n $ countVar n $ skillVar sType $ labeled "test")
