module Arkham.Location.Cards.TheInnsmouthConspiracy.IntoTheMaelstrom.OnyxGuardians (onyxGuardians, OnyxGuardians (..)) where
...
onyxGuardians =
  locationWith OnyxGuardians Cards.onyxGuardians 2 (PerPlayer 1)
    $ connectsToAdjacent
