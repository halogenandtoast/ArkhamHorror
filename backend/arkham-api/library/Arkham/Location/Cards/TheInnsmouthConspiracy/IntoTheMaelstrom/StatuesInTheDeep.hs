module Arkham.Location.Cards.TheInnsmouthConspiracy.IntoTheMaelstrom.StatuesInTheDeep (statuesInTheDeep, StatuesInTheDeep (..)) where
...
statuesInTheDeep =
  locationWith StatuesInTheDeep Cards.statuesInTheDeep 3 (PerPlayer 1)
    $ connectsToAdjacent
