module Arkham.Location.Cards.TheInnsmouthConspiracy.IntoTheMaelstrom.SubmergedTemple (submergedTemple) where
...
submergedTemple =
  locationWith SubmergedTemple Cards.submergedTemple 5 (PerPlayer 1)
    $ connectsToAdjacent
