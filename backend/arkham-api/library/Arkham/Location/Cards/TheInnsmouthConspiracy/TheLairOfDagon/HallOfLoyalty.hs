module Arkham.Location.Cards.TheInnsmouthConspiracy.TheLairOfDagon.HallOfLoyalty (hallOfLoyalty, HallOfLoyalty (..)) where
...
import Arkham.I18n
import Arkham.Key
import Arkham.Location.CardDefs.TheInnsmouthConspiracy.TheLairOfDagon qualified as Cards
