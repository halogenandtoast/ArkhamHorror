module Arkham.Location.Cards.ThePathToCarcosa.APhantomOfTruth.PereLachaiseCemetery (pereLachaiseCemetery) where

import Arkham.Ability
import Arkham.GameValue
import Arkham.Location.CardDefs.ThePathToCarcosa.APhantomOfTruth qualified as Cards
