module Arkham.Location.Cards.ThePathToCarcosa.BlackStarsRise.NorthTower_287 (northTower_287) where
...
instance HasAbilities NorthTower_287 where
  getAbilities (NorthTower_287 a) =
    extendRevealed1 a
      $ restricted a 1 Here
      $ forced
      $ PlacedCounterOnAgenda #after (AgendaWithSide C) AnySource #doom (atLeast 1)
