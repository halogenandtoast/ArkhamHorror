module Arkham.Location.Cards.TheScarletKeys.CongressOfTheKeys.CongressChamberSanctum (congressChamberSanctum) where
...
congressChamberSanctum = location CongressChamberSanctum Cards.congressChamberSanctum 3 (PerPlayer 1)
