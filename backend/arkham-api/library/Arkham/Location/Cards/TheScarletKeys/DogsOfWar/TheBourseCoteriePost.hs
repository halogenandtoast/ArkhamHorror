module Arkham.Location.Cards.TheScarletKeys.DogsOfWar.TheBourseCoteriePost (theBourseCoteriePost) where
...
theBourseCoteriePost = symbolLabel $ location TheBourseCoteriePost Cards.theBourseCoteriePost 3 (PerPlayer 3)

instance HasModifiersFor TheBourseCoteriePost where
  getModifiersFor (TheBourseCoteriePost a) = whenUnrevealed a $ blockedWhen a do
...
instance RunMessage TheBourseCoteriePost where
  runMessage msg l@(TheBourseCoteriePost attrs) = runQueueT $ case msg of
