module Arkham.Location.Cards.TheScarletKeys.SanguineShadows.CasaRosada (casaRosada) where
...
instance RunMessage CasaRosada where
  runMessage msg l@(CasaRosada attrs) = runQueueT $ case msg of
