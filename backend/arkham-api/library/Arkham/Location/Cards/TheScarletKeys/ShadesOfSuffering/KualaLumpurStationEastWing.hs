module Arkham.Location.Cards.TheScarletKeys.ShadesOfSuffering.KualaLumpurStationEastWing (kualaLumpurStationEastWing) where

import Arkham.Ability
import Arkham.Card
import Arkham.ForMovement
import Arkham.Location.CardDefs.TheScarletKeys.ShadesOfSuffering qualified as Cards
