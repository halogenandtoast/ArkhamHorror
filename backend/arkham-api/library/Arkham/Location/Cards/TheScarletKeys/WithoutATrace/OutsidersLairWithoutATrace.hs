module Arkham.Location.Cards.TheScarletKeys.WithoutATrace.OutsidersLairWithoutATrace (outsidersLairWithoutATrace) where
...
import Arkham.Location.CardDefs.TheScarletKeys.WithoutATrace qualified as Cards
