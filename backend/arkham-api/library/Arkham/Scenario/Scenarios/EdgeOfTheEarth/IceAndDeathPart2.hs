module Arkham.Scenario.Scenarios.EdgeOfTheEarth.IceAndDeathPart2 (iceAndDeathPart2) where
...
import Arkham.Story.CardDefs.EdgeOfTheEarth.IceAndDeath qualified as Stories
