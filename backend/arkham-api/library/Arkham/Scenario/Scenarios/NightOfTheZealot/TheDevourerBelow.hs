module Arkham.Scenario.Scenarios.NightOfTheZealot.TheDevourerBelow (setupTheDevourerBelow, theDevourerBelow, TheDevourerBelow (..)) where

import Arkham.Act.CardDefs.NightOfTheZealot.TheDevourerBelow qualified as Acts
