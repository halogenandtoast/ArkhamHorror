module Arkham.Scenario.Scenarios.NightOfTheZealot.TheMidnightMasks (setupTheMidnightMasks, theMidnightMasks, TheMidnightMasks (..)) where

import Arkham.Act.CardDefs.NightOfTheZealot.TheMidnightMasks qualified as Acts
...
import Arkham.Scenarios.NightOfTheZealot.TheMidnightMasks.Helpers
import Arkham.Token
