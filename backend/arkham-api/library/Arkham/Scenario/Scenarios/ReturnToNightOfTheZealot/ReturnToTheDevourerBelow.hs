module Arkham.Scenario.Scenarios.ReturnToNightOfTheZealot.ReturnToTheDevourerBelow (returnToTheDevourerBelow) where

import Arkham.Difficulty
import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.NightOfTheZealot.TheDevourerBelow
