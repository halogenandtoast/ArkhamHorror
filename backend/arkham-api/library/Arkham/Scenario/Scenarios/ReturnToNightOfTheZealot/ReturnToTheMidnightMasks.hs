module Arkham.Scenario.Scenarios.ReturnToNightOfTheZealot.ReturnToTheMidnightMasks where

import Arkham.Scenario.Deck
import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.NightOfTheZealot.TheMidnightMasks
