module Arkham.Scenario.Scenarios.ReturnToTheCircleUndone.ReturnToBeforeTheBlackThrone (returnToBeforeTheBlackThrone) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheCircleUndone.BeforeTheBlackThrone
