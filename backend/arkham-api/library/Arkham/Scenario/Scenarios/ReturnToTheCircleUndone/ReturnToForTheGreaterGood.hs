module Arkham.Scenario.Scenarios.ReturnToTheCircleUndone.ReturnToForTheGreaterGood (returnToForTheGreaterGood) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheCircleUndone.ForTheGreaterGood
