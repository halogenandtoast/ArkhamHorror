module Arkham.Scenario.Scenarios.ReturnToTheCircleUndone.ReturnToInTheClutchesOfChaos (returnToInTheClutchesOfChaos) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheCircleUndone.InTheClutchesOfChaos
