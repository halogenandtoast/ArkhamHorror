module Arkham.Scenario.Scenarios.ReturnToTheCircleUndone.ReturnToTheSecretName (returnToTheSecretName) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheCircleUndone.TheSecretName
