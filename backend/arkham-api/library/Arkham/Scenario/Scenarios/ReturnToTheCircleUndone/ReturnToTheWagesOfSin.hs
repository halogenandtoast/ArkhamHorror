module Arkham.Scenario.Scenarios.ReturnToTheCircleUndone.ReturnToTheWagesOfSin (returnToTheWagesOfSin) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheCircleUndone.TheWagesOfSin
