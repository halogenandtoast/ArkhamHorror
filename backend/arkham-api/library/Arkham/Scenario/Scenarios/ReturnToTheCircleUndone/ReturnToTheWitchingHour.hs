module Arkham.Scenario.Scenarios.ReturnToTheCircleUndone.ReturnToTheWitchingHour (returnToTheWitchingHour) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheCircleUndone.TheWitchingHour
