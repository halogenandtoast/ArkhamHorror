module Arkham.Scenario.Scenarios.ReturnToTheDunwichLegacy.ReturnToBloodOnTheAltar (returnToBloodOnTheAltar) where

import Arkham.Act.CardDefs.TheDunwichLegacy.BloodOnTheAltar qualified as Acts
import Arkham.Agenda.CardDefs.TheDunwichLegacy.BloodOnTheAltar qualified as Agendas
...
import Arkham.Scenario.Scenarios.TheDunwichLegacy.BloodOnTheAltar
