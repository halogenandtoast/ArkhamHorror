module Arkham.Scenario.Scenarios.ReturnToTheDunwichLegacy.ReturnToExtracurricularActivities (returnToExtracurricularActivities) where
...
import Arkham.Scenario.Scenarios.TheDunwichLegacy.ExtracurricularActivity
