module Arkham.Scenario.Scenarios.ReturnToTheDunwichLegacy.ReturnToTheHouseAlwaysWins (returnToTheHouseAlwaysWins) where
...
import Arkham.Scenario.Scenarios.TheDunwichLegacy.TheHouseAlwaysWins
