module Arkham.Scenario.Scenarios.ReturnToTheDunwichLegacy.ReturnToTheMiskatonicMuseum (returnToTheMiskatonicMuseum) where

import Arkham.Act.CardDefs.TheDunwichLegacy.TheMiskatonicMuseum qualified as Acts
...
import Arkham.Scenario.Scenarios.TheDunwichLegacy.TheMiskatonicMuseum
