module Arkham.Scenario.Scenarios.ReturnToTheDunwichLegacy.ReturnToWhereDoomAwaits (returnToWhereDoomAwaits) where
...
import Arkham.Scenario.Scenarios.TheDunwichLegacy.WhereDoomAwaits
