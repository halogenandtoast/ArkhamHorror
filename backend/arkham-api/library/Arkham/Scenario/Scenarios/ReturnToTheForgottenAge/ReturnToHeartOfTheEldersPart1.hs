module Arkham.Scenario.Scenarios.ReturnToTheForgottenAge.ReturnToHeartOfTheEldersPart1 (returnToHeartOfTheEldersPart1) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheForgottenAge.HeartOfTheElders
...
returnToHeartOfTheEldersPart1 difficulty =
  scenarioWith
    ( ReturnToHeartOfTheEldersPart1
        . HeartOfTheElders
        . (`with` HeartOfTheEldersMetadata One False Nothing)
    )
    "53045"
