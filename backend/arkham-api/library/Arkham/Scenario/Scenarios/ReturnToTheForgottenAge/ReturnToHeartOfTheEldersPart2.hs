module Arkham.Scenario.Scenarios.ReturnToTheForgottenAge.ReturnToHeartOfTheEldersPart2 (returnToHeartOfTheEldersPart2) where
...
returnToHeartOfTheEldersPart2 difficulty =
  scenarioWith
    ( ReturnToHeartOfTheEldersPart2
        . HeartOfTheElders
        . (`with` HeartOfTheEldersMetadata Two False Nothing)
    )
    "53048"
