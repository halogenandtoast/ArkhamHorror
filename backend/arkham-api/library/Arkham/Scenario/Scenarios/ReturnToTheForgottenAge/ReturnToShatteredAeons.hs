module Arkham.Scenario.Scenarios.ReturnToTheForgottenAge.ReturnToShatteredAeons (returnToShatteredAeons) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheForgottenAge.ShatteredAeons
