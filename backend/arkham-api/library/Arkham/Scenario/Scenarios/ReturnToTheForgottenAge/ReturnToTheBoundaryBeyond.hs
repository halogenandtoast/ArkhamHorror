module Arkham.Scenario.Scenarios.ReturnToTheForgottenAge.ReturnToTheBoundaryBeyond (returnToTheBoundaryBeyond) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheForgottenAge.TheBoundaryBeyond
import Arkham.Scenarios.TheForgottenAge.TheBoundaryBeyond.Helpers
