module Arkham.Scenario.Scenarios.ReturnToTheForgottenAge.ReturnToTheDepthsOfYoth (returnToTheDepthsOfYoth) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheForgottenAge.TheDepthsOfYoth
