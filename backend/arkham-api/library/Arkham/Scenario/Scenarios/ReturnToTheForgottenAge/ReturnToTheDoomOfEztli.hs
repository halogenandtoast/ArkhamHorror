module Arkham.Scenario.Scenarios.ReturnToTheForgottenAge.ReturnToTheDoomOfEztli (returnToTheDoomOfEztli) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheForgottenAge.TheDoomOfEztli
