module Arkham.Scenario.Scenarios.ReturnToTheForgottenAge.ReturnToThreadsOfFate (returnToThreadsOfFate) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.TheForgottenAge.ThreadsOfFate
