module Arkham.Scenario.Scenarios.ReturnToThePathToCarcosa.ReturnToBlackStarsRise (returnToBlackStarsRise) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.ThePathToCarcosa.BlackStarsRise
