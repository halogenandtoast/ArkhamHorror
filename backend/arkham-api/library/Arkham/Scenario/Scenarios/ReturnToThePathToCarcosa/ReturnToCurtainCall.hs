module Arkham.Scenario.Scenarios.ReturnToThePathToCarcosa.ReturnToCurtainCall (returnToCurtainCall) where

import Arkham.Enemy.CardDefs.ThePathToCarcosa.CurtainCall qualified as Enemies
import Arkham.Helpers.Modifiers (ModifierType (..), modifySelect)
import Arkham.Matcher
import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.ThePathToCarcosa.CurtainCall
