module Arkham.Scenario.Scenarios.ReturnToThePathToCarcosa.ReturnToEchoesOfThePast (returnToEchoesOfThePast) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.ThePathToCarcosa.EchoesOfThePast
