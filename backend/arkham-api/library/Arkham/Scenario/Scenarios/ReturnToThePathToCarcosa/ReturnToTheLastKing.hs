module Arkham.Scenario.Scenarios.ReturnToThePathToCarcosa.ReturnToTheLastKing (returnToTheLastKing) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.ThePathToCarcosa.TheLastKing
