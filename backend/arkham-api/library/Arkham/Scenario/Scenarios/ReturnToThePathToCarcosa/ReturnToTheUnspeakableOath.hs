module Arkham.Scenario.Scenarios.ReturnToThePathToCarcosa.ReturnToTheUnspeakableOath (returnToTheUnspeakableOath) where

import Arkham.Scenario.Import.Lifted
import Arkham.Scenario.Scenarios.ThePathToCarcosa.TheUnspeakableOath
