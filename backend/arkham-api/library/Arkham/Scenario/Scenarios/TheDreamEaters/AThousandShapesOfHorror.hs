module Arkham.Scenario.Scenarios.TheDreamEaters.AThousandShapesOfHorror (aThousandShapesOfHorror) where

import Arkham.Act.CardDefs.TheDreamEaters.AThousandShapesOfHorror qualified as Acts
import Arkham.Agenda.CardDefs.TheDreamEaters.AThousandShapesOfHorror qualified as Agendas
