module Arkham.Scenario.Scenarios.TheDreamEaters.BeyondTheGatesOfSleep (beyondTheGatesOfSleep) where
...
import Arkham.Scenarios.TheDreamEaters.BeyondTheGatesOfSleep.Helpers (scenarioI18n)
