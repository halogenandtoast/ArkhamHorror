module Arkham.Scenario.Scenarios.TheDreamEaters.PointOfNoReturn (pointOfNoReturn) where
...
import Arkham.Scenarios.TheDreamEaters.PointOfNoReturn.Helpers (scenarioI18n)
