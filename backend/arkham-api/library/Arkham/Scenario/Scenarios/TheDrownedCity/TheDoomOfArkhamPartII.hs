module Arkham.Scenario.Scenarios.TheDrownedCity.TheDoomOfArkhamPartII (theDoomOfArkhamPartII) where

import Arkham.Act.CardDefs.TheDrownedCity.TheDoomOfArkham qualified as Acts
