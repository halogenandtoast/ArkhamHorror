module Arkham.Scenario.Scenarios.TheDrownedCity.TheWesternWall (theWesternWall) where

import Arkham.Act.CardDefs.TheDrownedCity.TheWesternWall qualified as Acts
