module Arkham.Scenario.Scenarios.TheFeastOfHemlockVale.HemlockHouse (hemlockHouse) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheFeastOfHemlockVale.HemlockHouse qualified as Acts
