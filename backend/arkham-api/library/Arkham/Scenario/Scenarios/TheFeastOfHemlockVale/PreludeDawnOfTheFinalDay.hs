module Arkham.Scenario.Scenarios.TheFeastOfHemlockVale.PreludeDawnOfTheFinalDay (preludeDawnOfTheFinalDay) where

import Arkham.Act.CardDefs.TheFeastOfHemlockVale.DayOfTheFeast qualified as Acts
