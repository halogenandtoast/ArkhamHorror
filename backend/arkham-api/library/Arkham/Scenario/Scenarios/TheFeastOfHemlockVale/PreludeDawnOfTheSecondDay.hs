module Arkham.Scenario.Scenarios.TheFeastOfHemlockVale.PreludeDawnOfTheSecondDay (preludeDawnOfTheSecondDay) where

import Arkham.Act.CardDefs.TheFeastOfHemlockVale.DayOfRain qualified as Acts
import Arkham.Agenda.CardDefs.TheFeastOfHemlockVale.DayOfRain qualified as Agendas
