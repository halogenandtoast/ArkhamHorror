module Arkham.Scenario.Scenarios.TheFeastOfHemlockVale.TheLongestNight (theLongestNight) where

import Arkham.Act.CardDefs.TheFeastOfHemlockVale.TheLongestNight qualified as Acts
