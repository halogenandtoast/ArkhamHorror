module Arkham.Scenario.Scenarios.TheFeastOfHemlockVale.TheLostSister (theLostSister) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheFeastOfHemlockVale.TheLostSister qualified as Acts
