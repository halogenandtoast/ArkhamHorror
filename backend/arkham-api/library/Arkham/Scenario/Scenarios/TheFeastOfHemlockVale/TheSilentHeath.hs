module Arkham.Scenario.Scenarios.TheFeastOfHemlockVale.TheSilentHeath (theSilentHeath) where

import Arkham.Act.CardDefs.TheFeastOfHemlockVale.TheSilentHeath qualified as Acts
