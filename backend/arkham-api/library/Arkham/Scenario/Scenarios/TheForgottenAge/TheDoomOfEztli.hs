module Arkham.Scenario.Scenarios.TheForgottenAge.TheDoomOfEztli (theDoomOfEztli, TheDoomOfEztli (..), setupTheDoomOfEztli) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheForgottenAge.TheDoomOfEztli qualified as Acts
