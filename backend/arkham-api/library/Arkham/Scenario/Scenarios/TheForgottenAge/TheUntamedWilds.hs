module Arkham.Scenario.Scenarios.TheForgottenAge.TheUntamedWilds (setupTheUntamedWilds, theUntamedWilds, TheUntamedWilds (..)) where

import Arkham.Ability
import Arkham.Act.CardDefs.TheForgottenAge.TheUntamedWilds qualified as Acts
