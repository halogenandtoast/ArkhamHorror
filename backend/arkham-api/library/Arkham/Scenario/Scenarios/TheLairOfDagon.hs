    ...
    Setup -> runScenarioSetup TheLairOfDagon attrs do
      ...
      if aDecisionToStickTogether
        then do
          ...
          leadChooseOneM do
            questionLabeled' "chooseInvestigatorThomasDawson"
      ...
      case r of
        ...
        Resolution 1 -> do
          ...
          storyWithChooseOne
            ...
            [ Label (withI18n $ ikey' "theInnsmouthConspiracy.theLairOfDagon.label.tellOceirosNothing") [R2]
            , Label (withI18n $ ikey' "theInnsmouthConspiracy.theLairOfDagon.label.lieToOceiros") [R3]
            , Label (withI18n $ ikey' "theInnsmouthConspiracy.theLairOfDagon.label.tellOceirosEverything") [R4]
            ]
        Resolution 2 -> do
