module Arkham.Scenario.Scenarios.ThePathToCarcosa.APhantomOfTruth (setupAPhantomOfTruth, aPhantomOfTruth, APhantomOfTruth (..)) where

import Arkham.Act.CardDefs.ThePathToCarcosa.APhantomOfTruth qualified as Acts
