module Arkham.Scenario.Scenarios.ThePathToCarcosa.DimCarcosa (setupDimCarcosa, dimCarcosa, DimCarcosa (..)) where

import Arkham.Act.CardDefs.ThePathToCarcosa.DimCarcosa qualified as Acts
