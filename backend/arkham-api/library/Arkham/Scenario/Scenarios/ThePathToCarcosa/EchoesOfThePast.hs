module Arkham.Scenario.Scenarios.ThePathToCarcosa.EchoesOfThePast (echoesOfThePast, EchoesOfThePast (..), setupEchoesOfThePast) where

import Arkham.Act.CardDefs.ThePathToCarcosa.EchoesOfThePast qualified as Acts
