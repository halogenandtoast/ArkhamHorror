module Arkham.Scenario.Scenarios.TheScarletKeys.ShadesOfSuffering (shadesOfSuffering) where

import Arkham.Act.CardDefs.TheScarletKeys.ShadesOfSuffering qualified as Acts
