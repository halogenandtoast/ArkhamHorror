...
intro =
  FlavorText
    ...
    [ BasicEntry "Dr. Armitage is worried his colleague, Professor Warren Rice, might be\
...
noResolution =
  FlavorText
    (Just "No resolution")
    [ BasicEntry "As you flee from the university,\
...
resolution1 =
  FlavorText
    (Just "Resolution 1")
    [ BasicEntry "You find Professor Rice bound and gagged\
...
resolution2 =
  FlavorText
    (Just "Resolution 2")
    [ BasicEntry "You pull each of the dormitory’s fire alarms\
...
resolution3 =
  FlavorText
    (Just "Resolution 3")
    [ BasicEntry "After defeating the strange and terrifying\
...
resolution4 =
  FlavorText
    (Just "Resolution 4")
    [ BasicEntry "You awaken hours later, exhausted and\
