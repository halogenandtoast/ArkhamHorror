...
intro =
  FlavorText
    ...
    [ BasicEntry "Passing through the gate is unlike anything you’ve\
    ...
    , BasicEntry "Suddenly, all is quiet and the chaos of the\
...
investigatorDefeat =
  FlavorText
    Nothing
    [ BasicEntry "Where did you come from? Why are\
...
resolution1 =
  FlavorText
    (Just "Resolution 1")
    [ BasicEntry "Lying on your back in a patch of wet grass, you\
...
resolution2 =
  FlavorText
    (Just "Resolution 2")
    [ BasicEntry "Several of the villagers from Dunwich heard\
      \ the ruckus on Sentinel Hill and went to investigate. What they\
      \ found there answered none of their questions."
    , BasicEntry "“What d’you think happened?” a frightened Curtis Whateley\
    ...
    , BasicEntry "“Those Arkham fellas ain’t nowhere to be seen,” Curtis adds,\
    ...
    , BasicEntry "“Think we should get ahold of those coppers outta Aylesbury?”"
    , BasicEntry "“Why, so they can laugh at us again?” Curtis spits. “They ain’t\
...
resolution3 =
  FlavorText
    (Just "Resolution 3")
    [ BasicEntry "The creature erupts in a cosmic fury of sound,\
