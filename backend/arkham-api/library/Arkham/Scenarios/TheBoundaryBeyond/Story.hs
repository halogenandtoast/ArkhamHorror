...
introPart1 =
  FlavorText
    ...
    [ BasicEntry "Rays of hot yellow sunlight beat down on you from above as your car speeds down\
...
ichtacasQuest =
  FlavorText
    ...
    [ BasicEntry "“How close are we?” Ichtaca asks for the hundredth time since departing from\
...
silentJourney =
  FlavorText
    (Just "Silent Journey")
    [ BasicEntry "Ichtaca is quiet and pensive for the majority of your journey. Your questions\
...
arcaneThrumming =
  FlavorText
    ...
    [ BasicEntry "Throughout the journey south, the device you recovered from the clutches of the\
...
growingConcern =
  FlavorText
    ...
    [ BasicEntry "The loss of the Eztli relic weighs heavily on your mind. Clearly, its value is\
...
alejandrosThoughts =
  FlavorText
    ...
    [ BasicEntry "Throughout your journey, Alejandro scribbles endlessly in his journal, the\
    ...
    , BasicEntry "Ichtaca’s already-grim expression grows darker, her eyes narrowing. She doesn’t\
    ...
    , BasicEntry "Crossing the border into Mexico is a less stressful endeavor than you imagined\
...
anEmptySeat =
  FlavorText
    (Just "An Empty Seat")
    [ BasicEntry "Somewhere just north of the border, you stop to rest for the night. Your eyes\
...
outOfGas =
  FlavorText
    (Just "Out of Gas")
    [ BasicEntry "Fuel is a constant concern throughout your journey south. You are able to\
...
introPart2 =
  FlavorText
    Nothing
    [ BasicEntry "After arriving in Mexico City, you are disheartened to find very little\
    ...
    , BasicEntry "Padma knows a lot about Alejandro’s research, and even claims to have heard of\
    ...
    , BasicEntry "Once she is out of sight, Ichtaca sits down next to you, and you discuss your\
...
noResolution =
  FlavorText
    (Just "No Resolution")
    [ BasicEntry "When you next open your eyes, you are back in the bed of your hotel room. You\
    ...
    , BasicEntry "Rising to your feet requires a colossal effort. A small voice in the back of\
    ...
    , BasicEntry "Your head pulses with pain as you attempt to remember the events of last night,\
...
resolution1 =
  FlavorText
    (Just "Resolution 1")
    [ BasicEntry "You are assailed by a prismatic assortment of colors and lights as your mind\
    ...
    , BasicEntry "“That woman...She must have realized who I am and followed through the breach I\
    ...
    , BasicEntry "It is difficult for you to recall with precision what happened on the other\
...
resolution2 =
  FlavorText
    (Just "Resolution 2")
    [ BasicEntry "The boundary along the horizon shimmers as your path home closes before your\
      ...
      \ nowhere to be found."
    , BasicEntry "You wander for what seems like hours. Days. Weeks. Your mind cannot take any\
    ...
    , BasicEntry "Suddenly, after an eternity of waiting, the boundary cracks, and the sky is\
