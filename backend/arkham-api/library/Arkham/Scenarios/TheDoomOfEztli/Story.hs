...
intro1 =
  FlavorText
    (Just "Intro 1")
    [ BasicEntry "Wednesday, July 8th, 1925"
    , BasicEntry "Our runners, José and Maria, returned several days later. They were fully\
    ...
    , BasicEntry "We ventured once more into the jungle. This time, we were prepared.  We had\
...
intro2 =
  FlavorText
    (Just "Intro 2")
    [ BasicEntry "Friday, July 3rd, 1925"
    , BasicEntry "We spent most of yesterday moving our camp to the edge of the ruins. With the\
...
defeat =
  FlavorText
    ...
    [ BasicEntry "The temple shakes with the ferocity of an earthquake, causing you to collapse\
...
resolution1 =
  FlavorText
    (Just "Resolution 1")
    [ BasicEntry "(The following is scrawled below the previous journal entry.)"
    , BasicEntry "The outside of the temple ruins appeared Aztec in origin, but once we breached\
    ...
    , BasicEntry "In the central chamber of these underground halls, we found our prize: a steel\
    ...
    , BasicEntry "With the artifact in tow, we fled the ruins. The building had started to\
    ...
    , BasicEntry "Maria was waiting for us with the trucks when we finally reached the northern\
...
resolution2 =
  FlavorText
    (Just "Resolution 2")
    [ BasicEntry "(The following is scrawled below the previous journal entry.)"
    , BasicEntry "It is not in my nature to leave a thing unfinished. For the sake of my fallen\
      \ comrades, I have taken it upon myself to record the remainder of our expedition\
      \ in this journal."
    , BasicEntry "The others never made it out of the temple. I convinced two of the other\
    ...
    , BasicEntry "Thankfully, my gambit was worthwhile. While José and Andrea searched for the\
    ...
    , BasicEntry "In the central chamber of these underground halls, I found the device. The orb\
      ...
      \ that mattered now."
    , BasicEntry "With the artifact in tow, I returned to camp and told the others it was time to\
    ...
    , BasicEntry "It is a shame what happened to the others. Their sacrifice will not be in vain.\
      \ Now, my work can continue."
    , BasicEntry "– Alejandro Vela"
    ]
...
resolution3 =
  FlavorText
    (Just "Resolution 3")
    [ BasicEntry "(The following is scrawled below the previous journal entry.)"
    , BasicEntry "This was a mistake. This was all a terrible mistake. We escaped the temple with\
      ...
      \ Wanted us dead."
    , BasicEntry "We have gathered outside the temple where José is waiting for us. Alejandro,\
...
resolution4 =
  FlavorText
    (Just "Resolution 4")
    [ BasicEntry "(The following is scrawled below the previous journal entry.)"
    , BasicEntry "We’ve made our decision. Alejandro is right: we’ve come too far to back down\
...
resolution5 =
  FlavorText
    (Just "Resolution 5")
    [ BasicEntry "(The following is scrawled below the previous journal entry.)"
    , BasicEntry "We made our decision. There was no way we were going back into that deathtrap.\
    ...
    , BasicEntry "That night, we put on a hell of a fireworks show. The jungle protested. Birds\
    ...
    , BasicEntry "José was the first to notice the blue light peeking out from underneath the\
    ...
    , BasicEntry "With the artifact in tow, we left the smoldering temple behind us. We had\
    ...
    , BasicEntry "To hell with the Eztli and to hell with this forsaken place."
    ]
