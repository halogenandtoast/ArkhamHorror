...
intro =
  FlavorText
    ...
    [ BasicEntry "Recent events in the Museum have forced you to\
    ...
    , BasicEntry "You consider telling the Massachusetts State Police what you know, but\
    ...
    , BasicEntry "You pack everything you think you might need and manage to get\
    ...
    , BasicEntry "Armitage’s notes indicate that the Whateley family is spread across\
    ...
    , BasicEntry "As the train departs from Arkham, you feel the events of the previous\
...
investigatorDefeat =
  FlavorText
    ...
    [ BasicEntry "Your experience beyond the gate is\
...
resolution1 =
  FlavorText
    (Just "Resolution 1")
    [ BasicEntry "You breathe a sigh of relief as the gate behind\
