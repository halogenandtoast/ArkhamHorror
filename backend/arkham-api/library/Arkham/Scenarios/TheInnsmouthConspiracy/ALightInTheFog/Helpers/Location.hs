module Arkham.Scenarios.TheInnsmouthConspiracy.ALightInTheFog.Helpers.Location (module X, module Arkham.Scenarios.TheInnsmouthConspiracy.ALightInTheFog.Helpers.Location) where
...
import Arkham.Scenarios.TheInnsmouthConspiracy.ALightInTheFog.Helpers as X
