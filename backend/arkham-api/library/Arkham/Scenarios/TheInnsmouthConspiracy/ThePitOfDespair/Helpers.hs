module Arkham.Scenarios.TheInnsmouthConspiracy.ThePitOfDespair.Helpers (module X, module Arkham.Scenarios.TheInnsmouthConspiracy.ThePitOfDespair.Helpers) where
