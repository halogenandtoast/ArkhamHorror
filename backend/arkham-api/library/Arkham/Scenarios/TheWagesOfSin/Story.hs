...
intro =
  FlavorText
    ...
    [ BasicEntry "Ever since your encounter with the ghost in the Witch House, you have been\
    ...
    , BasicEntry "The more you delve into Arkham’s history of witchcraft and persecution, the\
      ...
      \ evil."
    , BasicEntry "As you go through your morning routine, your eyes drift across one of the\
    ...
    , BasicEntry "Then the realization dawns on you—if it is witches you seek, the only place you\
...
resolution1 =
  FlavorText
    (Just "Resolution 1")
    [ BasicEntry "Rays of faded sunlight stream through the haze, and the unnatural mist finally\
...
resolution2 =
  FlavorText
    (Just "Resolution 2")
    [ BasicEntry "Resigned to your fate, you fall to your knees. The mist parts. Time slows to a\
      ...
      \ brace yourself."
    , BasicEntry "The moment passes."
    , BasicEntry "When you open your eyes again, the creature is gone, along with the spectral\
      \ mist."
    , BasicEntry "...Have you been spared?"
    ]
