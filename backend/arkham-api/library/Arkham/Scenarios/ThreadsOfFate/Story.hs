...
intro1 =
  FlavorText
    (Just "Intro 1")
    [ BasicEntry "The night passes with Ichtaca resting in your living room. You get no sleep for\
...
intro2 =
  FlavorText
    (Just "Intro 2")
    [ BasicEntry "Setting aside your many questions for the time being, you call your contact at\
    ...
    , BasicEntry "You ask her what the trouble is, and she lets out a long sigh. “The relic is\
    ...
    , BasicEntry "Sure enough, Alejandro is not answering his telephone, and none of his other\
...
intro3 =
  FlavorText
    (Just "Intro 3")
    [ BasicEntry "Setting aside your many questions for the time being, you call Harlan’s office\
...
intro4 =
  FlavorText
    (Just "Intro 4")
    [ BasicEntry "Ichtaca grits her teeth and pauses. You expect her to refuse and leave without\
    ...
    , BasicEntry "“It must return to its rightful place,” she explains. Her gaze is relentless,\
...
intro5 =
  FlavorText
    (Just "Intro 5")
    [ BasicEntry "Ichtaca strings her ornately decorated bow with frightening speed and slams\
...
intro6 =
  FlavorText
    (Just "Intro 6")
    [ BasicEntry "Once Ichtaca has left, you consider her words carefully and recall the events\
...
resolution1 =
  FlavorText
    (Just "Resolution 1")
    [ BasicEntry "You arrive back at your house and take stock of the situation. Your\
      ...
      \ light."
    , BasicEntry "“They seek a place known as the Nexus of N’kai,” Ichtaca claims. A map of\
      ...
      \ lets on."
    , BasicEntry "With no other leads to follow, you are left with no choice. Once more you must\
