...
intro1 =
  FlavorText
    (Just "Intro 1")
    [ BasicEntry "You stand in front of the main temple of the Eztli, sweat pouring down your\
    ...
    , BasicEntry "Your consciousness has been snapped so far back that your mind aches from the\
...
intro2 =
  FlavorText
    (Just "Intro 2")
    [ BasicEntry "You stand near the main temple of the Eztli, sweat pouring down your skin due\
...
noResolution =
  FlavorText
    (Just "No Resolution")
    [ BasicEntry "With your failure, the paradox of clashing timelines catches up to you. Despite\
...
resolution1 =
  FlavorText
    ...
    , BasicEntry "No one else has ever learned of the events that truly occurred during the\
      ...
      \ humanity."
    , BasicEntry "It is difficult to explain how we did what we did. After all that\
