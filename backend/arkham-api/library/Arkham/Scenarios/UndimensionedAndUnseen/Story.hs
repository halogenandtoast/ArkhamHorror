...
intro =
  FlavorText
    ...
    [ BasicEntry "Your search of the village of Dunwich has\
    ...
    , BasicEntry "You don’t doubt that somebody who has seen what Seth has seen would\
    ...
    , BasicEntry "Before you are able to find Seth and confront him, several men and\
...
introPart1 =
  FlavorText
    Nothing
    [ BasicEntry "You aim to calm the townsfolk so they can explain to you what\
      ...
      \ his lip."
    , BasicEntry "“We couldn’t even see that hellish thing until the old professor sprayed\
...
introPart2 =
  FlavorText
    Nothing
    [ BasicEntry "You warn the townsfolk that they are in grave danger, and urge\
...
resolution1 =
  FlavorText
    (Just "Resolution 1")
    [ BasicEntry "You did all you could to stop the rampaging\
...
resolution2 =
  FlavorText
    (Just "Resolution 2")
    [ BasicEntry "After slaying what seems to be the last of\
