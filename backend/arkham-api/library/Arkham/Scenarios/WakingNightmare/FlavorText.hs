...
intro1 =
  FlavorText
    (Just "Intro 1")
    [ BasicEntry "It has been more than twenty-four hours since your companions fell\
    ...
    , BasicEntry "You have no idea what this could mean for your friends. Have they\
    ...
    , BasicEntry "St. Mary’s is the only hospital in the town of Arkham, and it is a\
    ...
    , BasicEntry "Hours pass. You hear nothing about the status of your companions. You\
      ...
      \ into your own hands."
    , BasicEntry "It is late at night, and the receptionist who instructed you to stay in\
      ...
      \ or worry."
    , BasicEntry "Doctor Maheswaran does not seem surprised by your intrusion. “Shivani\
    ...
    , BasicEntry " Without hesitation, you ask if they are dreaming. “Dreaming?” Doctor\
    ...
    , BasicEntry "Just then, you see a large, hairy spider crawling on the chest of one of\
    ...
    , BasicEntry "For just a moment, you think you hear one of your sleeping companions\
...
intro2 =
  FlavorText
    (Just "Intro 2")
    [ BasicEntry "“Yes, I suppose that makes sense. There has been no change in their\
...
intro3 =
  FlavorText
    (Just "Intro 3")
    [ BasicEntry "“Yes, of course. Their safety is paramount. But do come back and tell me\
...
noResolution =
  FlavorText
    (Just "No Resolution")
    [ BasicEntry "With panic overtaking your mind, you run through the main exit of St.\
    ...
    , BasicEntry "The next day, you wake and check the morning papers, expecting to see\
    ...
    , BasicEntry "When you arrive at St. Mary’s, you expect to see the building—or perhaps\
    ...
    , BasicEntry "“Good morning. We should talk.”"
    ]
...
resolution1 =
  FlavorText
    (Just "Resolution 1")
    [ BasicEntry "Before you depart from the hospital, Doctor Maheswaran announces that\
...
resolution2 =
  FlavorText
    (Just "Resolution 2")
    [ BasicEntry "Before you depart from the hospital, you search high and low for Doctor\
...
resolution3 =
  FlavorText
    (Just "Resolution 3")
    [ BasicEntry "Before you depart from the hospital, you go back to the emergency ward\
...
resolution4 =
  FlavorText
    (Just "Resolution 4")
    [ BasicEntry "With panic overtaking your mind and no idea how you can escape, you\
    ...
    , BasicEntry " Once you cross through the webs, you are no longer in the dark, sterile\
    ...
    , BasicEntry "Something is not right. None of this makes any sense. You are about to\
...
resolution5 =
  FlavorText
    (Just "Resolution 5")
    [ BasicEntry "You depart from the hospital with the blond-haired man in tow, and he\
    ...
    , BasicEntry "You ask if there is anything you can do to aid them. Randolph ponders\
      ...
      \ here. However—”"
    , BasicEntry "Before Randolph is able to finish his sentence, he is interrupted by a\
      \ mysterious voice..."
    ]
