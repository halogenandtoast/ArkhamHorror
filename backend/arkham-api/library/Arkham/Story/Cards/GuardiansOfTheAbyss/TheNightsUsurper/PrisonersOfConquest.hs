module Arkham.Story.Cards.GuardiansOfTheAbyss.TheNightsUsurper.PrisonersOfConquest (prisonersOfConquest) where
...
import Arkham.Story.CardDefs.GuardiansOfTheAbyss.TheNightsUsurper qualified as Cards
