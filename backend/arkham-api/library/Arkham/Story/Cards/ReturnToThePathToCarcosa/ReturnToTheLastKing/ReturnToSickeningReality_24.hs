module Arkham.Story.Cards.ReturnToThePathToCarcosa.ReturnToTheLastKing.ReturnToSickeningReality_24 (returnToSickeningReality_24) where
    ...
    ResolveThisStory iid (is attrs -> True) -> do
      ...
      if null partyGuests
        then do
          ...
          placeUnderneath ScenarioTarget [attrs]
