module Arkham.Story.Cards.TheBlobThatAteEverythingELSE.RealityAcid (realityAcid) where

-- Placeholder so appears in cards UI

import Arkham.Story.CardDefs.TheBlobThatAteEverythingELSE qualified as Cards
