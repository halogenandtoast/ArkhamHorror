module Arkham.Story.Cards.TheCircleUndone.AtDeathsDoorstep.JosefsPlan (josefsPlan, josefsPlanEffect) where
...
import Arkham.Story.CardDefs.TheCircleUndone.AtDeathsDoorstep qualified as Cards
