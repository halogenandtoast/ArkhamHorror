...
module Arkham.Story.Cards.TheCircleUndone.TheWagesOfSin.UnfinishedBusiness_B (unfinishedBusiness_B) where
    ...
    InThreatArea _ ->
      ...
      , skillTestAbility
          $ restricted
            ...
            actionAbility
      , restricted x 3 (InThreatAreaOf (IncludeEliminated You))
          $ silent
