module Arkham.Story.Cards.TheCircleUndone.UnionAndDisillusion.GavriellasFate (gavriellasFate, gavriellasFateEffect) where

import Arkham.Asset.Cards qualified as Assets
import Arkham.Campaigns.TheCircleUndone.Key
import Arkham.Card
import Arkham.Effect.Import
import Arkham.Enemy.CardDefs.TheCircleUndone.UnionAndDisillusion qualified as Enemies
...
import Arkham.Story.CardDefs.TheCircleUndone.UnionAndDisillusion qualified as Cards
