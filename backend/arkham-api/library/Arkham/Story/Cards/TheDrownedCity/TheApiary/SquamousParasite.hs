module Arkham.Story.Cards.TheDrownedCity.TheApiary.SquamousParasite (squamousParasite) where

import Arkham.Story.CardDefs.TheDrownedCity.TheApiary qualified as Cards
