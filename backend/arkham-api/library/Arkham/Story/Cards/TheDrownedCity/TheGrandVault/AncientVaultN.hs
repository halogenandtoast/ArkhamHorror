module Arkham.Story.Cards.TheDrownedCity.TheGrandVault.AncientVaultN (ancientVaultN) where

import Arkham.Story.CardDefs.TheDrownedCity.TheGrandVault qualified as Cards
