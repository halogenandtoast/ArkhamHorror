module Arkham.Story.Cards.TheFeastOfHemlockVale.FateOfTheVale.TheAbyss (theAbyss) where

import Arkham.Story.CardDefs.TheFeastOfHemlockVale.FateOfTheVale qualified as Cards
