module Arkham.Story.Cards.TheFeastOfHemlockVale.TheFinalDay.NightThree (nightThree) where

import Arkham.Story.CardDefs.TheFeastOfHemlockVale.TheFinalDay qualified as Cards
