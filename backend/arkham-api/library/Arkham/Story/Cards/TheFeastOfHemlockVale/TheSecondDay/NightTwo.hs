module Arkham.Story.Cards.TheFeastOfHemlockVale.TheSecondDay.NightTwo (nightTwo) where

import Arkham.Story.CardDefs.TheFeastOfHemlockVale.TheSecondDay qualified as Cards
