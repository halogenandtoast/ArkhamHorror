module Arkham.Story.Cards.TheInnsmouthConspiracy.ALightInTheFog.Captured (captured) where

import Arkham.Location.CardDefs.TheInnsmouthConspiracy.ALightInTheFog qualified as Locations
import Arkham.Location.Grid
import Arkham.Matcher
import Arkham.Message.Lifted.Placement
import Arkham.Story.CardDefs.TheInnsmouthConspiracy.ALightInTheFog qualified as Cards
