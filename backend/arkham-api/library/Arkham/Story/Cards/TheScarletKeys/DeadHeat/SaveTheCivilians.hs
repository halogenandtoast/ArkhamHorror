module Arkham.Story.Cards.TheScarletKeys.DeadHeat.SaveTheCivilians (saveTheCivilians) where
...
import Arkham.Scenarios.TheScarletKeys.DeadHeat.Helpers (scenarioI18n)
import Arkham.Story.CardDefs.TheScarletKeys.DeadHeat qualified as Cards
