module Arkham.Story.Cards.TheScarletKeys.DealingsInTheDark.TheUnveiling (theUnveiling) where
...
instance HasAbilities TheUnveiling where
  getAbilities (TheUnveiling a) =
    [ mkAbility a 1 $ forced $ PlacedCounterOnEnemy #after #cultist AnySource #doom (atLeast 1)
