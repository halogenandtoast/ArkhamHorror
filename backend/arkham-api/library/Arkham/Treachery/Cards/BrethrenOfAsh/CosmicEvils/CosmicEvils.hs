module Arkham.Treachery.Cards.BrethrenOfAsh.CosmicEvils.CosmicEvils (cosmicEvils) where

import Arkham.I18n
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.BrethrenOfAsh.CosmicEvils qualified as Cards
