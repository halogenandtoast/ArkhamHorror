module Arkham.Treachery.Cards.BrethrenOfAsh.DeadEnds.RaisingSuspicions (raisingSuspicions) where

import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.BrethrenOfAsh.DeadEnds qualified as Cards
