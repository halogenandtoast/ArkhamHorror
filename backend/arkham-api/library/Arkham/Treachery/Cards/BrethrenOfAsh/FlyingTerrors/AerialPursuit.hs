module Arkham.Treachery.Cards.BrethrenOfAsh.FlyingTerrors.AerialPursuit (aerialPursuit) where

import Arkham.Helpers.Location
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Message.Lifted.Move
import Arkham.Treachery.CardDefs.BrethrenOfAsh.FlyingTerrors qualified as Cards
