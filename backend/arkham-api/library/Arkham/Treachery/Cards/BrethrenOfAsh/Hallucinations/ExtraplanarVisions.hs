module Arkham.Treachery.Cards.BrethrenOfAsh.Hallucinations.ExtraplanarVisions (extraplanarVisions) where

import Arkham.Helpers.Message.Discard.Lifted
import Arkham.Investigator.Types (Field (..))
import Arkham.Message.Lifted.Choose
import Arkham.Projection
import Arkham.Treachery.CardDefs.BrethrenOfAsh.Hallucinations qualified as Cards
