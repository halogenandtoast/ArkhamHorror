module Arkham.Treachery.Cards.BrethrenOfAsh.QueenOfAsh.BlasphemousInvocation (blasphemousInvocation) where

import Arkham.Matcher
import Arkham.Message.Lifted hiding (beginSkillTest)
import Arkham.Message.Lifted.Choose
import Arkham.Trait (Trait (Cultist))
import Arkham.Treachery.CardDefs.BrethrenOfAsh.QueenOfAsh qualified as Cards
