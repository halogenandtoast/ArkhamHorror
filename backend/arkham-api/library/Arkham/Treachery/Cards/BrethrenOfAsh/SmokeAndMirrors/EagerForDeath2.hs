module Arkham.Treachery.Cards.BrethrenOfAsh.SmokeAndMirrors.EagerForDeath2 (eagerForDeath2) where

import Arkham.Investigator.Types (Field (..))
import Arkham.Treachery.CardDefs.BrethrenOfAsh.SmokeAndMirrors qualified as Cards
