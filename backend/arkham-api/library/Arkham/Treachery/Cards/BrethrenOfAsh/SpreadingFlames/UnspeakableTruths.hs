module Arkham.Treachery.Cards.BrethrenOfAsh.SpreadingFlames.UnspeakableTruths (unspeakableTruths) where

import Arkham.Ability
import Arkham.Matcher
import Arkham.Treachery.CardDefs.BrethrenOfAsh.SpreadingFlames qualified as Cards
