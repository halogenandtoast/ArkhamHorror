module Arkham.Treachery.Cards.CarnevaleOfHorrors.MassHysteria (massHysteria, MassHysteria (..)) where
        ...
        then
          push
            $ chooseOne
              ...
              , Label
                  (scenarioI18n $ scope "massHysteria" $ "$" <> ikey "label.shuffleMaskedCarnevaleGoers")
