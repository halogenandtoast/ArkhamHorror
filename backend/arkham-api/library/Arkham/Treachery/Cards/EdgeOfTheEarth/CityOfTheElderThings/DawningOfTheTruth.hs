module Arkham.Treachery.Cards.EdgeOfTheEarth.CityOfTheElderThings.DawningOfTheTruth (dawningOfTheTruth) where

import Arkham.Matcher
import Arkham.Treachery.CardDefs.EdgeOfTheEarth.CityOfTheElderThings qualified as Cards
