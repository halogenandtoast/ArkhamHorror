module Arkham.Treachery.Cards.EdgeOfTheEarth.DeadlyWeather.AntarcticWind (antarcticWind, AntarcticWind (..)) where
...
import Arkham.Treachery.CardDefs.EdgeOfTheEarth.DeadlyWeather qualified as Cards
