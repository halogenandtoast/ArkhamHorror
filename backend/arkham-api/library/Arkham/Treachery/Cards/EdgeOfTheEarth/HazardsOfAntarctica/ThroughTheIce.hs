module Arkham.Treachery.Cards.EdgeOfTheEarth.HazardsOfAntarctica.ThroughTheIce (throughTheIce) where
...
import Arkham.Treachery.CardDefs.EdgeOfTheEarth.HazardsOfAntarctica qualified as Cards
