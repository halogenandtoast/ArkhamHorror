module Arkham.Treachery.Cards.EdgeOfTheEarth.IceAndDeath.Apeirophobia (apeirophobia, Apeirophobia (..)) where
...
import Arkham.Treachery.CardDefs.EdgeOfTheEarth.IceAndDeath qualified as Cards
