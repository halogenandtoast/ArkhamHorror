module Arkham.Treachery.Cards.EdgeOfTheEarth.LeftBehind.AbandonedToMadness (abandonedToMadness) where
...
import Arkham.Treachery.CardDefs.EdgeOfTheEarth.LeftBehind qualified as Cards
