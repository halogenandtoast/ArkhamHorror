module Arkham.Treachery.Cards.EdgeOfTheEarth.Miasma.MiasmaticTorment (miasmaticTorment) where
...
import Arkham.Treachery.CardDefs.EdgeOfTheEarth.Miasma qualified as Cards
