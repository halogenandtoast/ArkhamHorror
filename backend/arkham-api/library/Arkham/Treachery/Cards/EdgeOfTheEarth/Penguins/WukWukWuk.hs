module Arkham.Treachery.Cards.EdgeOfTheEarth.Penguins.WukWukWuk (wukWukWuk) where
...
import Arkham.Treachery.CardDefs.EdgeOfTheEarth.Penguins qualified as Cards
