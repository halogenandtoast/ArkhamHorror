module Arkham.Treachery.Cards.EdgeOfTheEarth.Tekelili.Tekelili_228 (tekelili_228) where

import Arkham.Campaigns.EdgeOfTheEarth.Helpers
import Arkham.Treachery.CardDefs.EdgeOfTheEarth.Tekelili qualified as Cards
...
instance RunMessage Tekelili_228 where
  runMessage msg t@(Tekelili_228 attrs) = runQueueT $ case msg of
    Revelation iid (isSource attrs -> True) -> do
      ...
      repeated (n + 1) $ placeCluesOnLocation iid attrs 1
