module Arkham.Treachery.Cards.FortuneAndFolly.ArcaneSpotlightC (arcaneSpotlightC) where
...
instance HasAbilities ArcaneSpotlightC where
  getAbilities (ArcaneSpotlightC a) = case a.placement of
