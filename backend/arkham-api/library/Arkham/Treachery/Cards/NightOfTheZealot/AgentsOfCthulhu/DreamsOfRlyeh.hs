module Arkham.Treachery.Cards.NightOfTheZealot.AgentsOfCthulhu.DreamsOfRlyeh (dreamsOfRlyeh) where

import Arkham.Ability
import Arkham.Helpers.Modifiers (ModifierType (..), inThreatAreaGets)
import Arkham.Treachery.CardDefs.NightOfTheZealot.AgentsOfCthulhu qualified as Cards
