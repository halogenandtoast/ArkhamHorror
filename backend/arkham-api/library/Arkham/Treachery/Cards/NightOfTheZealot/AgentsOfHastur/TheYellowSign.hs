module Arkham.Treachery.Cards.NightOfTheZealot.AgentsOfHastur.TheYellowSign (theYellowSign) where

import Arkham.Matcher
import Arkham.Source
import Arkham.Strategy
import Arkham.Trait
import Arkham.Treachery.CardDefs.NightOfTheZealot.AgentsOfHastur qualified as Cards
