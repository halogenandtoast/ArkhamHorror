module Arkham.Treachery.Cards.NightOfTheZealot.AgentsOfYogSothoth.OfferOfPower (offerOfPower) where

import Arkham.Campaigns.NightOfTheZealot.Helpers
import Arkham.I18n
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.NightOfTheZealot.AgentsOfYogSothoth qualified as Cards
