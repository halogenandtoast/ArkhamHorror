module Arkham.Treachery.Cards.NightOfTheZealot.ChillingCold.ObscuringFog (obscuringFog) where
...
import Arkham.Treachery.CardDefs.NightOfTheZealot.ChillingCold qualified as Cards
