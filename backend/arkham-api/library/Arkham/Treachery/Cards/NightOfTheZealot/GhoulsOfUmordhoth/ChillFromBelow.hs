module Arkham.Treachery.Cards.NightOfTheZealot.GhoulsOfUmordhoth.ChillFromBelow (chillFromBelow) where

import Arkham.Helpers.Message.Discard.Lifted
import Arkham.Investigator.Types (Field (..))
import Arkham.Projection
import Arkham.Treachery.CardDefs.NightOfTheZealot.GhoulsOfUmordhoth qualified as Cards
