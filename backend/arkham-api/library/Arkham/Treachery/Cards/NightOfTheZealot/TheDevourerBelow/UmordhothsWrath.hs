module Arkham.Treachery.Cards.NightOfTheZealot.TheDevourerBelow.UmordhothsWrath (umordhothsWrath) where
...
import Arkham.Treachery.CardDefs.NightOfTheZealot.TheDevourerBelow qualified as Cards
