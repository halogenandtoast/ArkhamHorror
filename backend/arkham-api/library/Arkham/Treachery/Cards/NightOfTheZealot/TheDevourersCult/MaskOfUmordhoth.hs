module Arkham.Treachery.Cards.NightOfTheZealot.TheDevourersCult.MaskOfUmordhoth (maskOfUmordhoth) where
...
import Arkham.Trait
import Arkham.Treachery.CardDefs.NightOfTheZealot.TheDevourersCult qualified as Cards
