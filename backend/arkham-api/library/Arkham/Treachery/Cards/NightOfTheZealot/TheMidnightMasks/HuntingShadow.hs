module Arkham.Treachery.Cards.NightOfTheZealot.TheMidnightMasks.HuntingShadow (huntingShadow) where

import Arkham.Helpers.Investigator
import Arkham.I18n
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.NightOfTheZealot.TheMidnightMasks qualified as Cards
