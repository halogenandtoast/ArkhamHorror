module Arkham.Treachery.Cards.ReturnToNightOfTheZealot.ReturnToTheDevourerBelow.VaultOfEarthlyDemise (vaultOfEarthlyDemise) where
...
import Arkham.Treachery.CardDefs.ReturnToNightOfTheZealot.ReturnToTheDevourerBelow qualified as Cards
