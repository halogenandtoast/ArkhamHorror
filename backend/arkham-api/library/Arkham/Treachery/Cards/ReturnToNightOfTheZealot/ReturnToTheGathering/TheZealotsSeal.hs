module Arkham.Treachery.Cards.ReturnToNightOfTheZealot.ReturnToTheGathering.TheZealotsSeal (theZealotsSeal) where

import Arkham.Helpers.Investigator (getHandCount)
import Arkham.Helpers.Message.Discard.Lifted
import Arkham.Source
import Arkham.Treachery.CardDefs.ReturnToNightOfTheZealot.ReturnToTheGathering qualified as Cards
