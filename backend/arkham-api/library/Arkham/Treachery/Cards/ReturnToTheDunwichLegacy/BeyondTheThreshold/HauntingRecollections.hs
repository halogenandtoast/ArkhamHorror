module Arkham.Treachery.Cards.ReturnToTheDunwichLegacy.BeyondTheThreshold.HauntingRecollections (hauntingRecollections) where

import Arkham.Investigator.Projection ()
import Arkham.Name (toTitle)
import Arkham.Treachery.CardDefs.ReturnToTheDunwichLegacy.BeyondTheThreshold qualified as Cards
