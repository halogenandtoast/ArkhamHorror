module Arkham.Treachery.Cards.ReturnToTheDunwichLegacy.CreepingCold.InexplicableCold (inexplicableCold, InexplicableCold (..)) where
...
import Arkham.Treachery.CardDefs.ReturnToTheDunwichLegacy.CreepingCold qualified as Cards
