module Arkham.Treachery.Cards.ReturnToTheDunwichLegacy.ErraticFear.ViolentCommands (violentCommands, ViolentCommands (..)) where

import Arkham.Ability
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.ReturnToTheDunwichLegacy.ErraticFear qualified as Cards
