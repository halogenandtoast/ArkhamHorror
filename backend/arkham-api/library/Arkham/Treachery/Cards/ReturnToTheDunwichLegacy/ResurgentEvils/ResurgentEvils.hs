module Arkham.Treachery.Cards.ReturnToTheDunwichLegacy.ResurgentEvils.ResurgentEvils (resurgentEvils) where

import Arkham.I18n
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.ReturnToTheDunwichLegacy.ResurgentEvils qualified as Cards
