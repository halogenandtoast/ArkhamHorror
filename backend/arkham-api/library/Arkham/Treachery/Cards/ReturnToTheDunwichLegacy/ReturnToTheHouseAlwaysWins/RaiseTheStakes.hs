module Arkham.Treachery.Cards.ReturnToTheDunwichLegacy.ReturnToTheHouseAlwaysWins.RaiseTheStakes (raiseTheStakes) where
    ...
    case attrs.placement of
      InThreatArea iid -> do
        ...
        modifySelectWhen
          attrs
          (n >= 2)
          (enemyEngagedWith iid <> withTrait Criminal)
