module Arkham.Treachery.Cards.ReturnToTheDunwichLegacy.SecretDoors.SecretDoor (secretDoor, SecretDoor (..)) where
...
import Arkham.Treachery.CardDefs.ReturnToTheDunwichLegacy.SecretDoors qualified as Cards
import Arkham.Treachery.CardDefs.ReturnToTheDunwichLegacy.SecretDoors qualified as Gala
    ...
    Revelation iid (isSource attrs -> True) -> do
      selectWhenNotNull
        ( LocationWithMostInvestigators
            ...
            $ mapOneOf treacheryIs [Cards.secretDoor, Gala.secretDoor]
        )
