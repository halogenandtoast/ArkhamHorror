module Arkham.Treachery.Cards.ReturnToTheDunwichLegacy.YogSothothsEmissaries.EldritchAccord (eldritchAccord) where

import Arkham.Capability
import Arkham.I18n
import Arkham.Investigator.Projection ()
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.ReturnToTheDunwichLegacy.YogSothothsEmissaries qualified as Cards
