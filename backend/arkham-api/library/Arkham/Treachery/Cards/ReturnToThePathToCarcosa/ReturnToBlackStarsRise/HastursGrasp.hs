module Arkham.Treachery.Cards.ReturnToThePathToCarcosa.ReturnToBlackStarsRise.HastursGrasp (hastursGrasp) where

import Arkham.Ability
import Arkham.Agenda.Sequence
import Arkham.Matcher
import Arkham.Treachery.CardDefs.ReturnToThePathToCarcosa.ReturnToBlackStarsRise qualified as Cards
