module Arkham.Treachery.Cards.ReturnToThePathToCarcosa.ReturnToTheLastKing.ShockingDisplay (shockingDisplay) where

import Arkham.Card
import Arkham.Helpers.Story (readStory)
import Arkham.Matcher
import Arkham.Treachery.CardDefs.ReturnToThePathToCarcosa.ReturnToTheLastKing qualified as Cards
