module Arkham.Treachery.Cards.SinsOfThePast.ChillingPresence (chillingPresence, chillingPresenceEffect) where
...
import Arkham.Treachery.CardDefs.SinsOfThePast qualified as Cards
