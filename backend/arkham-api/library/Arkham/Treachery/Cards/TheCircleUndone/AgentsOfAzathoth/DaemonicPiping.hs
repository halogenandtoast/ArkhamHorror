module Arkham.Treachery.Cards.TheCircleUndone.AgentsOfAzathoth.DaemonicPiping (daemonicPiping) where
...
import Arkham.Treachery.CardDefs.TheCircleUndone.AgentsOfAzathoth qualified as Cards
