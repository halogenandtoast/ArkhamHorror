module Arkham.Treachery.Cards.TheCircleUndone.BloodthirstySpirits.BloodthirstySpirits (bloodthirstySpirits) where

import Arkham.Ability
import Arkham.Helpers.Location
import Arkham.Helpers.Modifiers (ModifierType (..), modifiedWhen_)
import Arkham.Matcher
import Arkham.Treachery.CardDefs.TheCircleUndone.BloodthirstySpirits qualified as Cards
