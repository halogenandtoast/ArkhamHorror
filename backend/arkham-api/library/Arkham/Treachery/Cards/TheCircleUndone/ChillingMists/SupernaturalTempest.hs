module Arkham.Treachery.Cards.TheCircleUndone.ChillingMists.SupernaturalTempest (supernaturalTempest) where
...
import Arkham.Treachery.CardDefs.TheCircleUndone.ChillingMists qualified as Cards
