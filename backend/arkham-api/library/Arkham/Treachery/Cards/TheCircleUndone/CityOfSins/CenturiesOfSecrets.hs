module Arkham.Treachery.Cards.TheCircleUndone.CityOfSins.CenturiesOfSecrets (centuriesOfSecrets) where

import Arkham.Card
import Arkham.Matcher
import Arkham.Trait (Trait (Curse))
import Arkham.Treachery.CardDefs.TheCircleUndone.CityOfSins qualified as Cards
