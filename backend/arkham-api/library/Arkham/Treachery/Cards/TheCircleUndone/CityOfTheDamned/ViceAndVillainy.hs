module Arkham.Treachery.Cards.TheCircleUndone.CityOfTheDamned.ViceAndVillainy (viceAndVillainy) where

import Arkham.Ability
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Placement
import Arkham.Treachery.CardDefs.TheCircleUndone.CityOfTheDamned qualified as Cards
