module Arkham.Treachery.Cards.TheCircleUndone.ForTheGreaterGood.BeneathTheLodge (beneathTheLodge) where
...
import Arkham.Treachery.CardDefs.TheCircleUndone.ForTheGreaterGood qualified as Cards
