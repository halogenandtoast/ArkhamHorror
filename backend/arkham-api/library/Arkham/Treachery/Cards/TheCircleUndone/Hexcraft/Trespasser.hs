module Arkham.Treachery.Cards.TheCircleUndone.Hexcraft.Trespasser (trespasser) where

import Arkham.Calculation
import Arkham.I18n
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheCircleUndone.Hexcraft qualified as Cards
