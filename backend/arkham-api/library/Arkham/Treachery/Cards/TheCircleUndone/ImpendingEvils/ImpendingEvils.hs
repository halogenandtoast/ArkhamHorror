module Arkham.Treachery.Cards.TheCircleUndone.ImpendingEvils.ImpendingEvils (impendingEvils) where
...
import Arkham.Treachery.CardDefs.TheCircleUndone.ImpendingEvils qualified as Cards
