module Arkham.Treachery.Cards.TheCircleUndone.SpectralPredators.WhispersInTheDark (whispersInTheDark) where

import Arkham.Ability
import Arkham.I18n
import Arkham.Matcher
import Arkham.Source
import Arkham.Treachery.CardDefs.TheCircleUndone.SpectralPredators qualified as Cards
