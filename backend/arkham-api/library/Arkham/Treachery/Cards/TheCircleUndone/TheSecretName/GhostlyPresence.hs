module Arkham.Treachery.Cards.TheCircleUndone.TheSecretName.GhostlyPresence (ghostlyPresence) where

import Arkham.Enemy.CardDefs.TheCircleUndone.TheSecretName qualified as Enemies
import Arkham.Helpers.Location (withLocationOf)
import Arkham.Helpers.Query
import Arkham.Location.CardDefs.TheCircleUndone.TheSecretName (siteOfTheSacrifice)
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheCircleUndone.TheSecretName qualified as Cards
