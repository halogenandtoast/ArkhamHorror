module Arkham.Treachery.Cards.TheCircleUndone.TheWatcher.WatchersGrasp (watchersGrasp) where

import Arkham.Enemy.CardDefs.TheCircleUndone.TheWatcher qualified as Enemies
import Arkham.Helpers.Modifiers
import Arkham.Helpers.Scenario
import Arkham.Matcher
import Arkham.Treachery.CardDefs.TheCircleUndone.TheWatcher qualified as Cards
