module Arkham.Treachery.Cards.TheCircleUndone.TrappedSpirits.TrappedSpirits (trappedSpirits) where
...
import Arkham.Treachery.CardDefs.TheCircleUndone.TrappedSpirits qualified as Cards
