module Arkham.Treachery.Cards.TheCircleUndone.Witchcraft.DiabolicVoices (diabolicVoices) where
...
import Arkham.Treachery.CardDefs.TheCircleUndone.Witchcraft qualified as Cards
