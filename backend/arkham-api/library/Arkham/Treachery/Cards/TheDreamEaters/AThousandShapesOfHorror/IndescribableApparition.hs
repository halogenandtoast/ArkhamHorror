module Arkham.Treachery.Cards.TheDreamEaters.AThousandShapesOfHorror.IndescribableApparition (
...
import Arkham.Treachery.CardDefs.TheDreamEaters.AThousandShapesOfHorror qualified as Cards
...
instance HasAbilities IndescribableApparition where
  getAbilities (IndescribableApparition a) = [restrictedAbility a 1 OnSameLocation $ ActionAbility mempty Nothing $ ActionCost 2]
