module Arkham.Treachery.Cards.TheDreamEaters.AgentsOfAtlachNacha.WillOfTheSpiderMother (willOfTheSpiderMother, WillOfTheSpiderMother (..)) where
...
import Arkham.Treachery.CardDefs.TheDreamEaters.AgentsOfAtlachNacha qualified as Cards
