module Arkham.Treachery.Cards.TheDreamEaters.AgentsOfNyarlathotep.LawOfYgirothDiscord (lawOfYgirothDiscord, LawOfYgirothDiscord (..)) where

import Arkham.Ability
import Arkham.Helpers.Modifiers
import Arkham.Matcher
import Arkham.Placement
import Arkham.Treachery.CardDefs.TheDreamEaters.AgentsOfNyarlathotep qualified as Cards
