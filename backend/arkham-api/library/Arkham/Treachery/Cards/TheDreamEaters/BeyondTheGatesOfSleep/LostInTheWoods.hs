module Arkham.Treachery.Cards.TheDreamEaters.BeyondTheGatesOfSleep.LostInTheWoods (lostInTheWoods) where

import Arkham.Matcher
import Arkham.Treachery.CardDefs.TheDreamEaters.BeyondTheGatesOfSleep qualified as Cards
