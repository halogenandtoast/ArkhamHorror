module Arkham.Treachery.Cards.TheDreamEaters.Corsairs.HuntedByCorsairs (huntedByCorsairs) where

import Arkham.Ability
import Arkham.Helpers.Act
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheDreamEaters.Corsairs qualified as Cards
