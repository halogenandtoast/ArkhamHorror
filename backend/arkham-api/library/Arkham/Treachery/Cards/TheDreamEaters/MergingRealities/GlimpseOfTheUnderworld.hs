module Arkham.Treachery.Cards.TheDreamEaters.MergingRealities.GlimpseOfTheUnderworld (glimpseOfTheUnderworld, GlimpseOfTheUnderworld (..)) where

import Arkham.Ability
import Arkham.Damage
import Arkham.Matcher
import Arkham.Message
import Arkham.Treachery.CardDefs.TheDreamEaters.MergingRealities qualified as Cards
