module Arkham.Treachery.Cards.TheDreamEaters.WeaverOfTheCosmos.EndlessWeaving (endlessWeaving) where
...
import Arkham.Treachery.CardDefs.TheDreamEaters.WeaverOfTheCosmos qualified as Cards
