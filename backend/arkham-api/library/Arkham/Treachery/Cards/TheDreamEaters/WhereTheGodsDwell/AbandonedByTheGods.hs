module Arkham.Treachery.Cards.TheDreamEaters.WhereTheGodsDwell.AbandonedByTheGods (
  abandonedByTheGods,
  AbandonedByTheGods (..),
)
where
...
import Arkham.Scenarios.TheDreamEaters.WhereTheGodsDwell.Helpers (scenarioI18n)
