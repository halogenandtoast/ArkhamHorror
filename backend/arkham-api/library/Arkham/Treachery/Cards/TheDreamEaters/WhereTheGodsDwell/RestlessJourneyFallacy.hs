module Arkham.Treachery.Cards.TheDreamEaters.WhereTheGodsDwell.RestlessJourneyFallacy (restlessJourneyFallacy, restlessJourneyFallacyEffect) where
...
instance HasModifiersFor RestlessJourneyFallacy where
  getModifiersFor (RestlessJourneyFallacy attrs) = case attrs.placement of
    HiddenInHand iid -> do
