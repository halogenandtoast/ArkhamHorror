module Arkham.Treachery.Cards.TheDreamEaters.WhispersOfHypnos.WhispersOfHypnos (whispersOfHypnos, whispersOfHypnosEffect) where
...
import Arkham.Treachery.CardDefs.TheDreamEaters.WhispersOfHypnos qualified as Cards
