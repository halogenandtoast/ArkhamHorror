module Arkham.Treachery.Cards.TheDrownedCity.AlienMachinery.InfernalMachinery (infernalMachinery) where
...
import Arkham.Treachery.CardDefs.TheDrownedCity.AlienMachinery qualified as Cards
