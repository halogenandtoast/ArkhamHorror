module Arkham.Treachery.Cards.TheDrownedCity.Domination.OppressiveInfluence (oppressiveInfluence) where

import Arkham.Helpers.GameValue (getGameValue)
import Arkham.Helpers.Investigator (getMaybeLocation)
import Arkham.Location.Types (Field (LocationPrintedShroud))
import Arkham.Projection
import Arkham.Treachery.CardDefs.TheDrownedCity.Domination qualified as Cards
