module Arkham.Treachery.Cards.TheDrownedCity.ElderMist.CorrosiveFog (corrosiveFog) where

import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.SkillTest.Base
import Arkham.Treachery.CardDefs.TheDrownedCity.ElderMist qualified as Cards
