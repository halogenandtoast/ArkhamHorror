module Arkham.Treachery.Cards.TheDrownedCity.Rlyeh.CyclopeanArchitecture (cyclopeanArchitecture) where
...
import Arkham.Treachery.CardDefs.TheDrownedCity.Rlyeh qualified as Cards
