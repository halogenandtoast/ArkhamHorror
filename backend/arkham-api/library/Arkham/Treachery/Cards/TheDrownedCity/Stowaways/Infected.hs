module Arkham.Treachery.Cards.TheDrownedCity.Stowaways.Infected (infected) where

import Arkham.Ability
import Arkham.Matcher
import Arkham.Trait (Trait (Stowaway))
import Arkham.Treachery.CardDefs.TheDrownedCity.Stowaways qualified as Cards
