module Arkham.Treachery.Cards.TheDrownedCity.TheApiary.ParasiticTransformation (parasiticTransformation) where

import Arkham.Ability
import Arkham.Matcher
import Arkham.Treachery.CardDefs.TheDrownedCity.TheApiary qualified as Cards
