module Arkham.Treachery.Cards.TheDunwichLegacy.BadLuck.TwistOfFate (twistOfFate) where

import Arkham.ChaosToken
import Arkham.Helpers.ChaosToken (getModifiedChaosTokenFaces)
import Arkham.Treachery.CardDefs.TheDunwichLegacy.BadLuck qualified as Cards
