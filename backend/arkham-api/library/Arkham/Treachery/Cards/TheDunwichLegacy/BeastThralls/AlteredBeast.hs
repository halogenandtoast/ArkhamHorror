module Arkham.Treachery.Cards.TheDunwichLegacy.BeastThralls.AlteredBeast (alteredBeast) where

import Arkham.Ability
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Trait
import Arkham.Treachery.CardDefs.TheDunwichLegacy.BeastThralls qualified as Cards
