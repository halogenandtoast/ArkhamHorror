module Arkham.Treachery.Cards.TheDunwichLegacy.BishopsThralls.LightOfAforgomon (lightOfAforgomon) where

import Arkham.Helpers.Modifiers
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheDunwichLegacy.BishopsThralls qualified as Cards
