module Arkham.Treachery.Cards.TheDunwichLegacy.LostInTimeAndSpace.CollapsingReality (collapsingReality) where

import Arkham.Matcher
import Arkham.Trait
import Arkham.Treachery.CardDefs.TheDunwichLegacy.LostInTimeAndSpace qualified as Cards
