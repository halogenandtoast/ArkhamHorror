module Arkham.Treachery.Cards.TheDunwichLegacy.NaomisCrew.HuntedDown (huntedDown) where

import Arkham.Helpers.Location
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Trait
import Arkham.Treachery.CardDefs.TheDunwichLegacy.NaomisCrew qualified as Cards
