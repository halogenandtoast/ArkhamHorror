module Arkham.Treachery.Cards.TheDunwichLegacy.Sorcery.VisionsOfFuturesPast (visionsOfFuturesPast) where

import Arkham.Source
import Arkham.Treachery.CardDefs.TheDunwichLegacy.Sorcery qualified as Cards
