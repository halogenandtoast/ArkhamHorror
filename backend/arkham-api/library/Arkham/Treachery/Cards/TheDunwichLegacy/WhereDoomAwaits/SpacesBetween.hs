module Arkham.Treachery.Cards.TheDunwichLegacy.WhereDoomAwaits.SpacesBetween (spacesBetween) where
...
import Arkham.Trait
import Arkham.Treachery.CardDefs.TheDunwichLegacy.WhereDoomAwaits qualified as Cards
