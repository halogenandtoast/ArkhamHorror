module Arkham.Treachery.Cards.TheDunwichLegacy.Whippoorwills.EagerForDeath (eagerForDeath, EagerForDeath (..)) where

import Arkham.Investigator.Types (Field (..))
import Arkham.Treachery.CardDefs.TheDunwichLegacy.Whippoorwills qualified as Cards
