module Arkham.Treachery.Cards.TheFeastOfHemlockVale.AgentsOfTheColour.AlienWhispers (alienWhispers) where
...
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.AgentsOfTheColour qualified as Cards
