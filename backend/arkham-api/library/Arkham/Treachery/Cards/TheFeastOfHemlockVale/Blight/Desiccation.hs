module Arkham.Treachery.Cards.TheFeastOfHemlockVale.Blight.Desiccation (desiccation) where

import Arkham.Ability
import Arkham.Helpers.Modifiers (ModifierType (..), modifySelectMap)
import Arkham.Matcher
import Arkham.Message.Lifted.Placement
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.Blight qualified as Cards
