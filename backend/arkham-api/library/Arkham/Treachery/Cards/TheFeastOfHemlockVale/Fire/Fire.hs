module Arkham.Treachery.Cards.TheFeastOfHemlockVale.Fire.Fire (fire) where
...
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.Fire qualified as Cards
