module Arkham.Treachery.Cards.TheFeastOfHemlockVale.HorrorsInTheRock.Calcification (calcification) where
...
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.HorrorsInTheRock qualified as Cards
