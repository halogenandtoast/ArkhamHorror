module Arkham.Treachery.Cards.TheFeastOfHemlockVale.Mutations.UnnaturalGrowth (unnaturalGrowth) where

import Arkham.Helpers.Message.Discard.Lifted
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.Mutations qualified as Cards
