module Arkham.Treachery.Cards.TheFeastOfHemlockVale.Myconids.PsychotropicSpores (psychotropicSpores) where
...
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.Myconids qualified as Cards
