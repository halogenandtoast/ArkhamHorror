module Arkham.Treachery.Cards.TheFeastOfHemlockVale.TheFinalDay.OtherworldlyVisions (otherworldlyVisions) where
...
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.TheFinalDay qualified as Cards
