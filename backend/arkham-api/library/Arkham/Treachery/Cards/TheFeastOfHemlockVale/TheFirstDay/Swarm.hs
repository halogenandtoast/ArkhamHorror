module Arkham.Treachery.Cards.TheFeastOfHemlockVale.TheFirstDay.Swarm (swarm) where

import Arkham.I18n
import Arkham.Investigator.Projection ()
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.TheFirstDay qualified as Cards
