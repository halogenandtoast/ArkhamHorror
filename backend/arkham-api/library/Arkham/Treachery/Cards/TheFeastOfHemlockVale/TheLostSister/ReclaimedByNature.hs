module Arkham.Treachery.Cards.TheFeastOfHemlockVale.TheLostSister.ReclaimedByNature (reclaimedByNature) where

import Arkham.Campaigns.TheFeastOfHemlockVale.Helpers
import Arkham.I18n
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.TheLostSister qualified as Cards
