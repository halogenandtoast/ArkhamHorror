module Arkham.Treachery.Cards.TheFeastOfHemlockVale.TheSecondDay.Downpour (downpour) where
...
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.TheSecondDay qualified as Cards
