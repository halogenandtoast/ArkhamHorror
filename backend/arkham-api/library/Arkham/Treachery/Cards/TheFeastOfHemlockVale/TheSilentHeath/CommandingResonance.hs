module Arkham.Treachery.Cards.TheFeastOfHemlockVale.TheSilentHeath.CommandingResonance (commandingResonance) where
...
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.TheSilentHeath qualified as Cards
