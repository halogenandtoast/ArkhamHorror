module Arkham.Treachery.Cards.TheFeastOfHemlockVale.Transfiguration.StrangeMutations (strangeMutations) where
...
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.Transfiguration qualified as Cards
