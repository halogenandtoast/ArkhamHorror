module Arkham.Treachery.Cards.TheForgottenAge.AgentsOfYig.CurseOfYig (curseOfYig) where
...
import Arkham.Trait
import Arkham.Treachery.CardDefs.TheForgottenAge.AgentsOfYig qualified as Cards
