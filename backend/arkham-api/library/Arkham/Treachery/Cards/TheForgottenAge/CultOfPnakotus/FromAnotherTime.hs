module Arkham.Treachery.Cards.TheForgottenAge.CultOfPnakotus.FromAnotherTime (fromAnotherTime) where

import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Trait (Trait (Cultist))
import Arkham.Treachery.CardDefs.TheForgottenAge.CultOfPnakotus qualified as Cards
