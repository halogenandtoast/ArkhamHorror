module Arkham.Treachery.Cards.TheForgottenAge.DeadlyTraps.FinalMistake (finalMistake) where

import Arkham.Location.Types
import Arkham.Matcher
import Arkham.Modifier
import Arkham.Treachery.CardDefs.TheForgottenAge.DeadlyTraps qualified as Cards
