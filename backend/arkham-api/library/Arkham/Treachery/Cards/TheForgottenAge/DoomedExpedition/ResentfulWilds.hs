module Arkham.Treachery.Cards.TheForgottenAge.DoomedExpedition.ResentfulWilds (resentfulWilds) where

import Arkham.Ability
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Message.Lifted.Placement
import Arkham.Treachery.CardDefs.TheForgottenAge.DoomedExpedition qualified as Cards
