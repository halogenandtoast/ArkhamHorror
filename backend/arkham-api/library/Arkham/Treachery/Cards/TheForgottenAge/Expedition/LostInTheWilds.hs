module Arkham.Treachery.Cards.TheForgottenAge.Expedition.LostInTheWilds (lostInTheWilds) where

import Arkham.Ability
import Arkham.Helpers.Modifiers
import Arkham.Matcher
import Arkham.Treachery.CardDefs.TheForgottenAge.Expedition qualified as Cards
