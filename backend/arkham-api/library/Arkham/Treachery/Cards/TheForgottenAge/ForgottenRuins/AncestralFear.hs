module Arkham.Treachery.Cards.TheForgottenAge.ForgottenRuins.AncestralFear (ancestralFear) where

import Arkham.Campaigns.TheForgottenAge.Helpers
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheForgottenAge.ForgottenRuins qualified as Cards
