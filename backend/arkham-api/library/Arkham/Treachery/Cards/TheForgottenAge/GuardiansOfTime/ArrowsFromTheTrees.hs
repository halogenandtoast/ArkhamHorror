module Arkham.Treachery.Cards.TheForgottenAge.GuardiansOfTime.ArrowsFromTheTrees (arrowsFromTheTrees) where

import Arkham.Matcher
import Arkham.Trait
import Arkham.Treachery.CardDefs.TheForgottenAge.GuardiansOfTime qualified as Cards
