module Arkham.Treachery.Cards.TheForgottenAge.PnakoticBrotherhood.Shadowed (shadowed, Shadowed (..)) where

import Arkham.Enemy.Types
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Trait
import Arkham.Treachery.CardDefs.TheForgottenAge.PnakoticBrotherhood qualified as Cards
