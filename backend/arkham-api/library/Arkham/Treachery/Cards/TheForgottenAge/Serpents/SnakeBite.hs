module Arkham.Treachery.Cards.TheForgottenAge.Serpents.SnakeBite (snakeBite) where

import Arkham.Campaigns.TheForgottenAge.Helpers
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheForgottenAge.Serpents qualified as Cards
