module Arkham.Treachery.Cards.TheForgottenAge.TemporalFlux.ATearInTime (aTearInTime) where

import Arkham.I18n
import Arkham.Investigator.Types (Field (InvestigatorRemainingActions))
import Arkham.Message.Lifted.Choose
import Arkham.Projection
import Arkham.Treachery.CardDefs.TheForgottenAge.TemporalFlux qualified as Cards
