module Arkham.Treachery.Cards.TheForgottenAge.TemporalHunters.MergingTimelines (mergingTimelines) where

import Arkham.Card
import Arkham.Investigator.Projection ()
import Arkham.Matcher
import Arkham.Name
import Arkham.Treachery.CardDefs.TheForgottenAge.TemporalHunters qualified as Cards
