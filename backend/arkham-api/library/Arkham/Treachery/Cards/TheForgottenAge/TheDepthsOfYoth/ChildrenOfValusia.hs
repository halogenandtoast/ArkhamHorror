module Arkham.Treachery.Cards.TheForgottenAge.TheDepthsOfYoth.ChildrenOfValusia (childrenOfValusia) where
...
import Arkham.Treachery.CardDefs.TheForgottenAge.TheDepthsOfYoth qualified as Cards
