module Arkham.Treachery.Cards.TheForgottenAge.VenomousHate.WrathOfYig (wrathOfYig) where

import Arkham.Campaigns.TheForgottenAge.Helpers
import Arkham.Treachery.CardDefs.TheForgottenAge.VenomousHate qualified as Cards
