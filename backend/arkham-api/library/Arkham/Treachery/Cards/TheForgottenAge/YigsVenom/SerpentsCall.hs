module Arkham.Treachery.Cards.TheForgottenAge.YigsVenom.SerpentsCall (serpentsCall) where

import Arkham.Campaigns.TheForgottenAge.Helpers
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheForgottenAge.YigsVenom qualified as Cards
