module Arkham.Treachery.Cards.TheInnsmouthConspiracy.ALightInTheFog.WorthHisSalt (worthHisSalt, WorthHisSalt (..)) where
...
import Arkham.Treachery.CardDefs.TheInnsmouthConspiracy.ALightInTheFog qualified as Cards
