module Arkham.Treachery.Cards.TheInnsmouthConspiracy.AgentsOfHydra.PsychicPull (psychicPull) where

import Arkham.Card.Cost
import Arkham.Helpers.Message.Discard.Lifted
import Arkham.Investigator.Projection ()
import Arkham.Treachery.CardDefs.TheInnsmouthConspiracy.AgentsOfHydra qualified as Cards
