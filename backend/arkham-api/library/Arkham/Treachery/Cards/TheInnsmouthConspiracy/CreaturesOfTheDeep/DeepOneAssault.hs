module Arkham.Treachery.Cards.TheInnsmouthConspiracy.CreaturesOfTheDeep.DeepOneAssault (deepOneAssault) where

import Arkham.Card
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Trait (Trait (DeepOne))
import Arkham.Treachery.CardDefs.TheInnsmouthConspiracy.CreaturesOfTheDeep qualified as Cards
