module Arkham.Treachery.Cards.TheInnsmouthConspiracy.FogOverInnsmouth.FogOverInnsmouth (fogOverInnsmouth, FogOverInnsmouth (..)) where
...
import Arkham.Treachery.CardDefs.TheInnsmouthConspiracy.FogOverInnsmouth qualified as Cards
