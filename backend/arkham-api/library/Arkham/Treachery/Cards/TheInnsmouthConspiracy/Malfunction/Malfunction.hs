module Arkham.Treachery.Cards.TheInnsmouthConspiracy.Malfunction.Malfunction (malfunction) where
...
import Arkham.Treachery.CardDefs.TheInnsmouthConspiracy.Malfunction qualified as Cards
