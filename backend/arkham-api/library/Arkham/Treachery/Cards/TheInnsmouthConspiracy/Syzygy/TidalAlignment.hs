module Arkham.Treachery.Cards.TheInnsmouthConspiracy.Syzygy.TidalAlignment (tidalAlignment) where

import Arkham.Campaigns.TheInnsmouthConspiracy.Helpers
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheInnsmouthConspiracy.Syzygy qualified as Cards
