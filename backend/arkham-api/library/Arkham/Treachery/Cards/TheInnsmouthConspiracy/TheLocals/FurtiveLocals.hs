module Arkham.Treachery.Cards.TheInnsmouthConspiracy.TheLocals.FurtiveLocals (furtiveLocals, FurtiveLocals (..)) where
...
import Arkham.Treachery.CardDefs.TheInnsmouthConspiracy.TheLocals qualified as Cards
