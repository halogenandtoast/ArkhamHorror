module Arkham.Treachery.Cards.ThePathToCarcosa.BlackStarsRise.CrashingFloods (crashingFloods) where
...
import Arkham.Treachery.CardDefs.ThePathToCarcosa.BlackStarsRise qualified as Cards
