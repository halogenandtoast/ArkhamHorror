module Arkham.Treachery.Cards.ThePathToCarcosa.Byakhee.HuntedByByakhee (huntedByByakhee) where

import Arkham.Card
import Arkham.Deck qualified as Deck
import Arkham.Message.Lifted.Choose
import Arkham.Trait
import Arkham.Treachery.CardDefs.ThePathToCarcosa.Byakhee qualified as Cards
