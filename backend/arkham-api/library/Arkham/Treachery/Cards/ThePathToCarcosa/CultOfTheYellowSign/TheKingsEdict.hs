module Arkham.Treachery.Cards.ThePathToCarcosa.CultOfTheYellowSign.TheKingsEdict (theKingsEdict, theKingsEdictEffect) where
...
import Arkham.Trait
import Arkham.Treachery.CardDefs.ThePathToCarcosa.CultOfTheYellowSign qualified as Cards
