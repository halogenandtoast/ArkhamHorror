module Arkham.Treachery.Cards.ThePathToCarcosa.DecayAndFilth.OozeAndFilth (oozeAndFilth) where

import Arkham.Ability
import Arkham.Helpers.Modifiers (ModifierType (..), modifySelect)
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.ThePathToCarcosa.DecayAndFilth qualified as Cards
