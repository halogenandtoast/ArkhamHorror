module Arkham.Treachery.Cards.ThePathToCarcosa.DecayingReality.BleedingWalls (bleedingWalls, BleedingWalls (..)) where

import Arkham.Calculation
import Arkham.Location.Types (Field (..))
import Arkham.Treachery.CardDefs.ThePathToCarcosa.DecayingReality qualified as Cards
