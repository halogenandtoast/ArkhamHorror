module Arkham.Treachery.Cards.ThePathToCarcosa.Delusions.WhispersInYourHeadAnxiety (whispersInYourHeadAnxiety) where

import Arkham.Ability
import Arkham.Helpers.Modifiers
import Arkham.Placement
import Arkham.Treachery.CardDefs.ThePathToCarcosa.Delusions qualified as Cards
