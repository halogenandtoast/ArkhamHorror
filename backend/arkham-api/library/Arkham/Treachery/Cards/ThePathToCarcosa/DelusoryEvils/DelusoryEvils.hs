module Arkham.Treachery.Cards.ThePathToCarcosa.DelusoryEvils.DelusoryEvils (delusoryEvils) where

import Arkham.Ability
import Arkham.I18n
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.ThePathToCarcosa.DelusoryEvils qualified as Cards
