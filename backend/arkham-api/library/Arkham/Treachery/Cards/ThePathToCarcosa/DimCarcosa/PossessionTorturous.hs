module Arkham.Treachery.Cards.ThePathToCarcosa.DimCarcosa.PossessionTorturous (possessionTorturous, PossessionTorturous (..)) where

import Arkham.Ability
import Arkham.Investigator.Types (Field (..))
import Arkham.Placement
import Arkham.Projection
import Arkham.Treachery.CardDefs.ThePathToCarcosa.DimCarcosa qualified as Cards
