module Arkham.Treachery.Cards.ThePathToCarcosa.HastursEnvoys.TheSignOfHastur (theSignOfHastur) where

import Arkham.Ability
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Placement
import Arkham.Treachery.CardDefs.ThePathToCarcosa.HastursEnvoys qualified as Cards
