module Arkham.Treachery.Cards.ThePathToCarcosa.Hauntings.SpiritsTorment (spiritsTorment) where
...
import Arkham.Treachery.CardDefs.ThePathToCarcosa.Hauntings qualified as Cards
