module Arkham.Treachery.Cards.ThePathToCarcosa.MaddeningDelusions.VisionsInYourMindHorrors (visionsInYourMindHorrors) where

import Arkham.Ability
import Arkham.Matcher
import Arkham.Treachery.CardDefs.ThePathToCarcosa.MaddeningDelusions qualified as Cards
