module Arkham.Treachery.Cards.ThePathToCarcosa.NeuroticFear.PainfulReflection (painfulReflection) where

import Arkham.Ability
import Arkham.Helpers.ChaosToken
import Arkham.Helpers.Window (getPlayedEvent)
import Arkham.Matcher
import Arkham.Treachery.CardDefs.ThePathToCarcosa.NeuroticFear qualified as Cards
