module Arkham.Treachery.Cards.ThePathToCarcosa.ThePallidMask.TheShadowBehindYou (theShadowBehindYou) where
...
import Arkham.Treachery.CardDefs.ThePathToCarcosa.ThePallidMask qualified as Cards
