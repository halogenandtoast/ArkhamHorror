module Arkham.Treachery.Cards.ThePathToCarcosa.TheStranger.ThePaleMaskBeckons (thePaleMaskBeckons) where

import Arkham.Enemy.CardDefs.ThePathToCarcosa.CurtainCall qualified as Cards
import Arkham.Helpers.Card
import Arkham.Matcher
import Arkham.Treachery.CardDefs.ThePathToCarcosa.TheStranger qualified as Cards
