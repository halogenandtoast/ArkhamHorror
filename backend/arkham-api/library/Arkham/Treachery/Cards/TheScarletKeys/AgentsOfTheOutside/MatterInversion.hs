module Arkham.Treachery.Cards.TheScarletKeys.AgentsOfTheOutside.MatterInversion (matterInversion) where
...
import Arkham.Treachery.CardDefs.TheScarletKeys.AgentsOfTheOutside qualified as Cards
