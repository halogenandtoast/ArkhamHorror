module Arkham.Treachery.Cards.TheScarletKeys.AgentsOfYuggoth.TenebrousEclipse (tenebrousEclipse) where
...
import Arkham.Treachery.CardDefs.TheScarletKeys.AgentsOfYuggoth qualified as Cards
