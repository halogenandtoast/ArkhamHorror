module Arkham.Treachery.Cards.TheScarletKeys.BeyondTheBeyond.ParadimensionalTerror (paradimensionalTerror) where

import Arkham.Campaigns.TheScarletKeys.Helpers
import Arkham.Message.Lifted.Choose
import Arkham.Treachery.CardDefs.TheScarletKeys.BeyondTheBeyond qualified as Cards
