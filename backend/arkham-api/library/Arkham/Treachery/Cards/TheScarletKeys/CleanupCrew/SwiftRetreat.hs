module Arkham.Treachery.Cards.TheScarletKeys.CleanupCrew.SwiftRetreat (swiftRetreat) where
...
import Arkham.Treachery.CardDefs.TheScarletKeys.CleanupCrew qualified as Cards
