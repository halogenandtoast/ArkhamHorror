module Arkham.Treachery.Cards.TheScarletKeys.CrimsonConspiracy.ConspiracyInRed (conspiracyInRed) where

import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Placement
import Arkham.Treachery.CardDefs.TheScarletKeys.CrimsonConspiracy qualified as Cards
