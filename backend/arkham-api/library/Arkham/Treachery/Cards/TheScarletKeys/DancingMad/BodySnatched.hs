module Arkham.Treachery.Cards.TheScarletKeys.DancingMad.BodySnatched (bodySnatched) where
...
import Arkham.Treachery.CardDefs.TheScarletKeys.DancingMad qualified as Cards
