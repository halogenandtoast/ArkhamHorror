module Arkham.Treachery.Cards.TheScarletKeys.DarkVeiling.FiguresInTheDark (figuresInTheDark) where

import Arkham.Campaigns.TheScarletKeys.Helpers
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Placement
import Arkham.Treachery.CardDefs.TheScarletKeys.DarkVeiling qualified as Cards
