module Arkham.Treachery.Cards.TheScarletKeys.MysteriesAbound.InPlainSight (inPlainSight) where
...
import Arkham.Treachery.CardDefs.TheScarletKeys.MysteriesAbound qualified as Cards
