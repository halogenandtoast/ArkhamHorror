module Arkham.Treachery.Cards.TheScarletKeys.OnThinIce.CrackingIce (crackingIce) where

import Arkham.I18n
import Arkham.Matcher
import Arkham.Message.Lifted.Choose
import Arkham.Placement
import Arkham.Treachery.CardDefs.TheScarletKeys.OnThinIce qualified as Cards
