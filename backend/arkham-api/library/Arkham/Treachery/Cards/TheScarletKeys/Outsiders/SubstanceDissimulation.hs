module Arkham.Treachery.Cards.TheScarletKeys.Outsiders.SubstanceDissimulation (substanceDissimulation) where
...
import Arkham.Treachery.CardDefs.TheScarletKeys.Outsiders qualified as Cards
