module Arkham.Treachery.Cards.TheScarletKeys.ScarletSorcery.BoundInRed (boundInRed) where
...
import Arkham.Treachery.CardDefs.TheScarletKeys.ScarletSorcery qualified as Cards
