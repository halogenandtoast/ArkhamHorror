module Arkham.Treachery.Cards.TheScarletKeys.ShadowOfADoubt.KnivesInTheDark (knivesInTheDark) where

import Arkham.Ability
import Arkham.Matcher
import Arkham.Treachery.CardDefs.TheScarletKeys.ShadowOfADoubt qualified as Cards
