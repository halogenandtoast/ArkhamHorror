module Arkham.Treachery.Cards.TheScarletKeys.SpatialAnomaly.SplinteredSpace (splinteredSpace) where

import Arkham.Helpers.Location (withLocationOf)
import Arkham.Matcher
import Arkham.Trait (Trait (Hex))
import Arkham.Treachery.CardDefs.TheScarletKeys.SpatialAnomaly qualified as Cards
