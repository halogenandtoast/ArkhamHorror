module Arkham.Treachery.Cards.TheScarletKeys.SpreadingCorruption.DistortedReasoning (distortedReasoning) where

import Arkham.Ability
import Arkham.Helpers.Modifiers (ModifierType (CannotPerformAction), modified_)
import Arkham.Matcher
import Arkham.Placement
import Arkham.Treachery.CardDefs.TheScarletKeys.SpreadingCorruption qualified as Cards
