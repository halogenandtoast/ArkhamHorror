module Arkham.Treachery.Cards.TheScarletKeys.StrangeHappenings.PinchInReality (pinchInReality) where
...
import Arkham.Treachery.CardDefs.TheScarletKeys.StrangeHappenings qualified as Cards
