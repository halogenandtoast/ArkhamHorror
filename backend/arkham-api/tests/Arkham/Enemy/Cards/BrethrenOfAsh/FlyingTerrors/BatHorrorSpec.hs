module Arkham.Enemy.Cards.BrethrenOfAsh.FlyingTerrors.BatHorrorSpec (spec) where

import Arkham.Enemy.CardDefs.BrethrenOfAsh.FlyingTerrors qualified as Enemies
