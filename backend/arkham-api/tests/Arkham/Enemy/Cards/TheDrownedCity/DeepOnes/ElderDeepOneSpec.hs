module Arkham.Enemy.Cards.TheDrownedCity.DeepOnes.ElderDeepOneSpec (spec) where

import Arkham.Enemy.CardDefs.TheDrownedCity.DeepOnes qualified as Enemies
