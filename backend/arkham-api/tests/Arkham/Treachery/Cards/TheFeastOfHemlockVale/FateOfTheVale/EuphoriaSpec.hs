module Arkham.Treachery.Cards.TheFeastOfHemlockVale.FateOfTheVale.EuphoriaSpec (spec) where
...
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.FateOfTheVale qualified as Treacheries
