module Arkham.Treachery.Cards.TheFeastOfHemlockVale.Myconids.PsychotropicSporesSpec (spec) where

import Arkham.Asset.Cards qualified as Assets
import Arkham.Treachery.CardDefs.TheFeastOfHemlockVale.Myconids qualified as Treacheries
