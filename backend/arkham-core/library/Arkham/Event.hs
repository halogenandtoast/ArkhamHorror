...
instance FromJSON Event where
  parseJSON v = flip (withObject "Event") v $ \o -> do
    ...
    case cCode of
      ...
      "60123" -> Event . GetOverHere2 <$> parseJSON v
      "60124" -> Event . LessonLearned2 <$> parseJSON v
      "60125" -> Event . ManoAMano2 <$> parseJSON v
      "60129" -> Event . DynamiteBlast3 <$> parseJSON v
      ...
      "60528" -> Event . Lucky3 <$> parseJSON v
...
allEvents = mapFromList $ map
  ...
  , Event <$> counterpunch2
  , Event <$> getOverHere2
  , Event <$> lessonLearned2
  , Event <$> manoAMano2
  , Event <$> dynamiteBlast3
  , Event <$> taunt3
  , Event <$> oneTwoPunch5
  , Event <$> iveGotAPlan2
  , Event <$> willToSurvive
