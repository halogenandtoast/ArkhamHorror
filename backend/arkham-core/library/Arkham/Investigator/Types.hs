...
instance FromJSON InvestigatorAttrs where
  parseJSON = withObject "InvestigatorAttrs" $ \o -> do
    ...
    investigatorPlayerId <- o .: "investigatorPlayerId"
    investigatorName <- o .: "investigatorName"
    investigatorCardCode <- o .: "investigatorCardCode"
    investigatorArt <- o .: "investigatorArt"
    investigatorClass <- o .: "investigatorClass"
    investigatorHealth <- o .: "investigatorHealth"
    investigatorAssignedHealthDamage <- o .: "investigatorAssignedHealthDamage"
    investigatorSanity <- o .: "investigatorSanity"
    investigatorAssignedSanityDamage <- o .: "investigatorAssignedSanityDamage"
    investigatorWillpower <- o .: "investigatorWillpower"
    investigatorIntellect <- o .: "investigatorIntellect"
    investigatorCombat <- o .: "investigatorCombat"
    investigatorAgility <- o .: "investigatorAgility"
    investigatorTokens <- o .: "investigatorTokens"
    investigatorPlacement <- o .:? "investigatorPlacement" .!= Unplaced
    investigatorActionsTaken <- o .: "investigatorActionsTaken"
    investigatorActionsPerformed <- o .: "investigatorActionsPerformed"
    investigatorRemainingActions <- o .: "investigatorRemainingActions"
    investigatorEndedTurn <- o .: "investigatorEndedTurn"
    investigatorDeck <- o .: "investigatorDeck"
    investigatorDecks <- o .: "investigatorDecks"
    investigatorDiscard <- o .: "investigatorDiscard"
    investigatorHand <- o .: "investigatorHand"
    investigatorTraits <- o .: "investigatorTraits"
    investigatorDefeated <- o .: "investigatorDefeated"
    investigatorResigned <- o .: "investigatorResigned"
    investigatorKilled <- o .: "investigatorKilled"
    investigatorDrivenInsane <- o .: "investigatorDrivenInsane"
    investigatorSlots <- o .: "investigatorSlots"
    investigatorXp <- o .: "investigatorXp"
    investigatorPhysicalTrauma <- o .: "investigatorPhysicalTrauma"
    investigatorMentalTrauma <- o .: "investigatorMentalTrauma"
    investigatorStartsWith <- o .: "investigatorStartsWith"
    investigatorStartsWithInHand <- o .: "investigatorStartsWithInHand"
    investigatorCardsUnderneath <- o .: "investigatorCardsUnderneath"
    investigatorSearch <- o .: "investigatorSearch"
    investigatorMovement <- o .: "investigatorMovement"
    investigatorUsedAbilities <- o .: "investigatorUsedAbilities"
    investigatorUsedAdditionalActions <- o .: "investigatorUsedAdditionalActions"
    investigatorMulligansTaken <- o .: "investigatorMulligansTaken"
    investigatorBondedCards <- o .: "investigatorBondedCards"
    investigatorHorrorHealed <- o .: "investigatorHorrorHealed"
    investigatorSupplies <- o .: "investigatorSupplies"
    investigatorDrawnCards <- o .: "investigatorDrawnCards"
    investigatorIsYithian <- o .: "investigatorIsYithian"
    investigatorKeys <- o .: "investigatorKeys"
    investigatorLog <- o .: "investigatorLog"
    investigatorDiscarding <- o .: "investigatorDiscarding"
