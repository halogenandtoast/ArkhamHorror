...
instance HasSkillTest env => HasModifiersFor HistoricalSocietyHistoricalMuseum_132 where
...
instance LocationRunner env => RunMessage HistoricalSocietyHistoricalMuseum_132 where
