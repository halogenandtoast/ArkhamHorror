  ...
  RotateTarot (toTarotArcana -> arcana) -> do
    let
      rotate = \case
        ...
        c -> c
    pure $ a & tarotCardsL . ix GlobalTarot %~ map rotate
  _ -> pure a
