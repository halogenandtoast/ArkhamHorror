...
instance HasModifiersFor env TheHomeFront

instance HasActions env TheHomeFront where
  getActions iid window (TheHomeFront attrs) = getActions iid window attrs
