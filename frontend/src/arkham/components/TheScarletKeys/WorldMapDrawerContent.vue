...
<template>
  ...
  <div class="drawer-content">
    ...
    <div v-if="selectedLocation === 'Marrakesh'" class='dossier'>
      <header><h3>{{ $t('scarletKeys.dossierHeader') }}</h3></header>
      <section>
    ...
    <div v-else-if="selectedLocation === 'BuenosAires'" class='dossier'>
      ...
      <section>
        ...
        <p>Approach Procedure: Despite her apparent <span class='censor'>coterie</span> association, Girl in Carmine Coat does not appear to be hostile. She has been heard speaking fluent Spanish, Portuguese, French, and English. For these reasons, we believe subject can be interrogated and/or reasoned with. Recommend capture and questioning regarding <span class='censor'>coterie</span> motives.</p>
