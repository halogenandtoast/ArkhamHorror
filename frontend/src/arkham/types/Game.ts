...
export const gameDecoder = JsonDecoder.object<Game>(
  {
    ...
    acts: JsonDecoder.dictionary<Act>(actDecoder, 'Dict<string, Act>'),
    agendas: JsonDecoder.dictionary<Agenda>(agendaDecoder, 'Dict<string, Agenda>'),
    assets: JsonDecoder.dictionary<Asset>(assetDecoder, 'Dict<string, Asset>'),
    events: JsonDecoder.dictionary<Event>(eventDecoder, 'Dict<string, Event>'),
    enemies: JsonDecoder.dictionary<Enemy>(enemyDecoder, 'Dict<string, Enemy>'),
    stories: JsonDecoder.dictionary<Story>(storyDecoder, 'Dict<string, Story>'),
    gameState: gameStateDecoder,
