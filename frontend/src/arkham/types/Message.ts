...
export enum MessageType {
  ...
  SEARCH_TOP_OF_ENCOUNTER_DECK = 'SearchTopOfEncounterDeck',
  ADD_FOCUSED_TO_HAND = 'AddFocusedToHand',
  ADD_FOCUSED_TO_TOP_OF_DECK = 'AddFocusedToTopOfDeck',
  ADD_FOCUSED_TO_TOP_OF_ENCOUNTER_DECK = 'AddFocusedToTopOfEncounterDeck',
...
export const messageTypeDecoder = JsonDecoder.oneOf<MessageType>(
  [
    ...
    JsonDecoder.isExactly('SearchTopOfEncounterDeck').then(() => JsonDecoder.constant(MessageType.SEARCH_TOP_OF_ENCOUNTER_DECK)),
    ...
    JsonDecoder.isExactly('AddFocusedToTopOfEncounterDeck').then(() => JsonDecoder.constant(MessageType.ADD_FOCUSED_TO_TOP_OF_ENCOUNTER_DECK)),
