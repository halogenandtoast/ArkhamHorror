...
export const messageTypeDecoder = JsonDecoder.oneOf<MessageType>(
  [
    ...
    JsonDecoder.isExactly('SkillLabel').then(() => JsonDecoder.constant(MessageType.SKILL_LABEL)),
    JsonDecoder.isExactly('EvadeLabel').then(() => JsonDecoder.constant(MessageType.EVADE_LABEL)),
    JsonDecoder.isExactly('Ask').then(() => JsonDecoder.constant(MessageType.ASK)),
    JsonDecoder.isExactly('CheckAdditionalActionCosts').then(() => JsonDecoder.constant(MessageType.CHECK_ADDITIONAL_ACTION_COSTS)),
    JsonDecoder.isExactly('ChooseTokenGroups').then(() => JsonDecoder.constant(MessageType.CHOOSE_TOKEN_GROUPS)),
    ...
    JsonDecoder.isExactly('CardLabel').then(() => JsonDecoder.constant(MessageType.CARD_LABEL)),
    JsonDecoder.isExactly('RemoveDoom').then(() => JsonDecoder.constant(MessageType.REMOVE_DOOM)),
    JsonDecoder.isExactly('RemoveFromGame').then(() => JsonDecoder.constant(MessageType.REMOVE_FROM_GAME)),
    JsonDecoder.isExactly('RevealInHand').then(() => JsonDecoder.constant(MessageType.REVEAL_CARD)),
    JsonDecoder.isExactly('Flip').then(() => JsonDecoder.constant(MessageType.FLIP)),
    JsonDecoder.isExactly('LookAtRevealed').then(() => JsonDecoder.constant(MessageType.LOOK_AT_REVEALED)),
    ...
    JsonDecoder.isExactly('InitiatePlayCardAsChoose').then(() => JsonDecoder.constant(MessageType.PLAY_CARD_AS)),
    JsonDecoder.isExactly('ReturnToHand').then(() => JsonDecoder.constant(MessageType.RETURN_TO_HAND)),
    ...
    JsonDecoder.isExactly('HealHorror').then(() => JsonDecoder.constant(MessageType.HEAL_HORROR)),
    ...
    JsonDecoder.isExactly('Done').then(() => JsonDecoder.constant(MessageType.DONE)),
    ...
    JsonDecoder.isExactly('Search').then(() => JsonDecoder.constant(MessageType.SEARCH)),
    JsonDecoder.isExactly('SearchFound').then(() => JsonDecoder.constant(MessageType.SEARCH_FOUND)),
