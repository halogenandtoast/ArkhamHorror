...
export function scenarioToI18n(scenario: Scenario): string {
  switch (scenario.id) {
    ...
    case "c50011": return "returnTo.theNightOfTheZealot.theGathering"
    case "c50025": return "returnTo.theNightOfTheZealot.theMidnightMasks"
    case "c50032": return "returnTo.theNightOfTheZealot.theDevourerBelow"
