...
export function scenarioIdToI18n(scenarioId: string): string {
  switch (scenarioId.replace(/^c/, '')) {
    ...
    case "87001": return "standalone.machinationsThroughTime"
    ...
    case "90004": return "standalone.readOrDie"
    case "90011": return "standalone.allOrNothing"
    case "90020": return "standalone.badBlood"
    case "90032": return "standalone.byTheBook"
    case "90041": return "standalone.redTideRising"
