// The sign-in token lives in a cookie on the parent domain so other
// arkhamhorror.app subdomains (e.g. 3ed) share the login. localStorage is
// the fallback: tokens saved before the cookie existed load from there.
