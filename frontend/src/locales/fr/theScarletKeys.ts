...
import dogsOfWar from '@/locales/fr/theScarletKeys/scenarios/dogsOfWar.json'
import onThinIce from '@/locales/fr/theScarletKeys/scenarios/onThinIce.json'
import riddlesAndRain from '@/locales/fr/theScarletKeys/scenarios/riddlesAndRain.json'
import sanguineShadows from '@/locales/fr/theScarletKeys/scenarios/sanguineShadows.json'
import shadesOfSuffering from '@/locales/fr/theScarletKeys/scenarios/shadesOfSuffering.json'
